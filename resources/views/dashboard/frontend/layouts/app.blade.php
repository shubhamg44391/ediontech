...
<!-- Bootstrap link end -->   --}}
  ...
  <body>
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{route('dashboard')}}" class="app-brand-link">
              <span class="app-brand-logo demo">
                <img class="dark-mode" width="150px" src="{{ asset('admin-assets/assets/img/edion_logo/brand_logo.png') }}" alt="Site Logo">
              </span>
            </a>
         ...
         @include('dashboard.frontend.layouts.sidebar')
        </aside>
        <!-- / Menu -->
        ...
        <div class="layout-page">
         ...
         @include('dashboard.frontend.layouts.navigation')
          ...
          <div class="content-wrapper">
            ...
            <!-- Footer -->
            @include('dashboard.frontend.layouts.footer')
            <!-- / Footer -->
    ...
    <script src="{{ asset('admin-assets/assets/vendor/js/bootstrap.js')}}"></script>
      {{-- <!-- boot strap scripts start-->
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/js/bootstrap.bundle.min.js" integrity="sha384-FKyoEForCGlyvwx9Hj09JcYn3nv7wiPVlz7YYwJrWVcXK/BmnVDxM+D2scQbITxI" crossorigin="anonymous"></script>
    <!-- boot strap scripts end--> --}}
