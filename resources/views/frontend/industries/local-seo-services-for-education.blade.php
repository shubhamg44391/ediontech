...
@section('title', 'Local SEO services for education | Edion Web Technologies')
@section('description', 'Local SEO services for education businesses. Education search peaks around admission cycles and is dominated by course and programme queries. We build progra')
@section('keywords', 'local seo services for education, education local seo services, local seo services education, education software company, local seo services company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-education') }}">Education</a></li><li aria-current="page"><b class="kw">Local <b class="kw">SEO services</b></b></li></ol></nav>
