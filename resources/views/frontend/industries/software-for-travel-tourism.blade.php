...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Software Development for Travel and tourism | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Custom software, web and mobile development for travel and tourism businesses. Travel businesses live and die on availability accuracy and the speed of confirmation. A b')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'software for travel and tourism, travel and tourism software development, travel and tourism web development')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'services']) }}">Industries</a></li><li aria-current="page">Travel and tourism</li></ol></nav>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Services</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'website-development-for-travel-tourism']) }}">Website development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'website-design-for-travel-tourism']) }}">Website design</a></li><li><a href="{{ route('industry.detail', ['slug'=>'custom-software-development-for-travel-tourism']) }}">Custom software development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'mobile-app-development-for-travel-tourism']) }}">Mobile app development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ecommerce-development-for-travel-tourism']) }}">E-commerce development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'seo-services-for-travel-tourism']) }}">SEO services</a></li><li><a href="{{ route('industry.detail', ['slug'=>'local-seo-services-for-travel-tourism']) }}">Local SEO services</a></li><li><a href="{{ route('industry.detail', ['slug'=>'technical-seo-audit-for-travel-tourism']) }}">Technical SEO audit</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ppc-advertising-for-travel-tourism']) }}">PPC advertising</a></li></ul></div>
 <div><p class="lbl">Other industries</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'software-for-hospitality']) }}">Hospitality</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-logistics']) }}">Logistics and transport</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-healthcare']) }}">Healthcare</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-real-estate']) }}">Real estate</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-education']) }}">Education</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-ecommerce-retail']) }}">E-commerce and retail</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-automotive']) }}">Automotive</a></li></ul></div>
