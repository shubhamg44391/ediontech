...
@section('title', 'Local SEO services for healthcare | Edion Web Technologies')
@section('description', 'Local SEO services for healthcare businesses. Health content sits under stricter quality assessment than most sectors, so authorship, credentials and citatio')
@section('keywords', 'local seo services for healthcare, healthcare local seo services, local seo services healthcare, healthcare software company, local seo services company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-healthcare') }}">Healthcare</a></li><li aria-current="page"><b class="kw">Local <b class="kw">SEO services</b></b></li></ol></nav>
