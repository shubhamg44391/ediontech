...
@section('title', 'Custom software development for Logistics and transport | Edion Web Technologies')
@section('description', 'Custom software development built for logistics and transport businesses. Logistics operators care about vehicle utilisation and downtime above almost everything else, becaus')
@section('keywords', 'custom software development for logistics and transport, logistics and transport software development')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/services') }}">Services</a></li><li aria-current="page"><b class="kw">Custom software development</b> for Logistics and transport</li></ol></nav>
