...
@section('title', 'SEO services for Automotive | Edion Web Technologies')
@section('description', 'SEO services built for automotive businesses. Dealers and workshops need booking, inventory and service history in one place, and usually have leg')
@section('keywords', 'seo services for automotive, automotive software development')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/services') }}">Services</a></li><li aria-current="page"><b class="kw">SEO services</b> for Automotive</li></ol></nav>
