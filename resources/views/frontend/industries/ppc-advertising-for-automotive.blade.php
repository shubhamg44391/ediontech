...
@section('title', 'PPC advertising for automotive | Edion Web Technologies')
@section('description', 'PPC advertising for automotive businesses. Automotive paid media competes with manufacturer campaigns on the same terms. We focus budget on model-plus-locati')
@section('keywords', 'ppc advertising for automotive, automotive ppc advertising, ppc advertising automotive, automotive software company, ppc advertising company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-automotive') }}">Automotive</a></li><li aria-current="page"><b class="kw">PPC advertising</b></li></ol></nav>
  ...
  <h1 style="margin-top:var(--sp-4)">PPC advertising for automotive</h1>
  <p class="lead">Paid search managed against profit rather than click volume. This page covers what changes when the client is a automotive business,
...
<section class="band band--ink">
  <div class="shell">
    <div class="sec-head" data-reveal>
      <div><p class="eyebrow">Questions</p><h2>PPC advertising for automotive: common questions</h2></div>
    </div>
