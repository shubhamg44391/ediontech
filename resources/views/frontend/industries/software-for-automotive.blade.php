...
@section('title', 'Software Development for Automotive | Edion Web Technologies')
@section('description', 'Custom software, web and mobile development for automotive businesses. Dealers and workshops need booking, inventory and service history in one place, and usuall')
@section('keywords', 'software for automotive, automotive software development, automotive web development')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/services') }}">Industries</a></li><li aria-current="page">Automotive</li></ol></nav>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Services</p><ul><li><a href="{{ url('/website-development-for-automotive') }}">Website development</a></li><li><a href="{{ url('/website-design-for-automotive') }}">Website design</a></li><li><a href="{{ url('/custom-software-development-for-automotive') }}">Custom software development</a></li><li><a href="{{ url('/mobile-app-development-for-automotive') }}">Mobile app development</a></li><li><a href="{{ url('/ecommerce-development-for-automotive') }}">E-commerce development</a></li><li><a href="{{ url('/seo-services-for-automotive') }}">SEO services</a></li><li><a href="{{ url('/local-seo-services-for-automotive') }}">Local SEO services</a></li><li><a href="{{ url('/technical-seo-audit-for-automotive') }}">Technical SEO audit</a></li><li><a href="{{ url('/ppc-advertising-for-automotive') }}">PPC advertising</a></li></ul></div>
