...
@section('title', 'Mobile app development for hospitality | Edion Web Technologies')
@section('description', 'Mobile app development for hospitality businesses. The integration surface is what makes hospitality builds harder than they look: property management, chann')
@section('keywords', 'mobile app development for hospitality, hospitality mobile app development, mobile app development hospitality, hospitality software company, mobile app development company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-hospitality') }}">Hospitality</a></li><li aria-current="page"><b class="kw">Mobile app development</b></li></ol></nav>
