...
@section('title', 'PPC advertising for logistics and transport | Edion Web Technologies')
@section('description', 'PPC advertising for logistics and transport businesses. B2B logistics has long sales cycles and few but valuable conversions, so campaigns need to be judged')
@section('keywords', 'ppc advertising for logistics and transport, logistics and transport ppc advertising, ppc advertising logistics, logistics and transport software company, ppc advertising company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-logistics') }}">Logistics and transport</a></li><li aria-current="page"><b class="kw">PPC advertising</b></li></ol></nav>
