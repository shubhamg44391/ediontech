...
@section('title', 'Software Development for Healthcare | Edion Web Technologies')
@section('description', 'Custom software, web and mobile development for healthcare businesses. Healthcare providers handle sensitive personal data and operate under stricter consent and')
@section('keywords', 'software for healthcare, healthcare software development, healthcare web development')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/services') }}">Industries</a></li><li aria-current="page">Healthcare</li></ol></nav>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Services</p><ul><li><a href="{{ url('/website-development-for-healthcare') }}">Website development</a></li><li><a href="{{ url('/website-design-for-healthcare') }}">Website design</a></li><li><a href="{{ url('/custom-software-development-for-healthcare') }}">Custom software development</a></li><li><a href="{{ url('/mobile-app-development-for-healthcare') }}">Mobile app development</a></li><li><a href="{{ url('/ecommerce-development-for-healthcare') }}">E-commerce development</a></li><li><a href="{{ url('/seo-services-for-healthcare') }}">SEO services</a></li><li><a href="{{ url('/local-seo-services-for-healthcare') }}">Local SEO services</a></li><li><a href="{{ url('/technical-seo-audit-for-healthcare') }}">Technical SEO audit</a></li><li><a href="{{ url('/ppc-advertising-for-healthcare') }}">PPC advertising</a></li></ul></div>
