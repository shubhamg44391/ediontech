...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'PPC advertising for e-commerce and retail | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'PPC advertising for e-commerce and retail businesses. Shopping campaigns are won in the product feed, not the campaign settings. We fix titles, attributes an')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'ppc advertising for e-commerce and retail, e-commerce and retail ppc advertising, ppc advertising ecommerce retail, e-commerce and retail software company, ppc advertising company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'industries']) }}">Industries</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-ecommerce-retail']) }}">E-commerce and retail</a></li><li aria-current="page"><b class="kw">PPC advertising</b></li></ol></nav>
  ...
  <h1 style="margin-top:var(--sp-4)">PPC advertising for e-commerce and retail</h1>
  <p class="lead">Paid search managed against profit rather than click volume. This page covers what changes when the client is a e-commerce and retail business,
...
<section class="band band--ink">
  <div class="shell">
    <div class="sec-head" data-reveal>
      <div><p class="eyebrow">Questions</p><h2>PPC advertising for e-commerce and retail: common questions</h2></div>
    </div>
