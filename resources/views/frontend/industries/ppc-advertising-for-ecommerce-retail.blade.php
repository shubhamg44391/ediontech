...
@section('title', 'PPC advertising for e-commerce and retail | Edion Web Technologies')
@section('description', 'PPC advertising for e-commerce and retail businesses. Shopping campaigns are won in the product feed, not the campaign settings. We fix titles, attributes an')
@section('keywords', 'ppc advertising for e-commerce and retail, e-commerce and retail ppc advertising, ppc advertising ecommerce retail, e-commerce and retail software company, ppc advertising company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-ecommerce-retail') }}">E-commerce and retail</a></li><li aria-current="page"><b class="kw">PPC advertising</b></li></ol></nav>
