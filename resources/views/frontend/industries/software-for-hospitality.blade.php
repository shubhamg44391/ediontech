...
@section('title', 'Software Development for Hospitality | Edion Web Technologies')
@section('description', 'Custom software, web and mobile development for hospitality businesses. Hotels and resorts increasingly bundle vehicle hire with stays, which means your rental sy')
@section('keywords', 'software for hospitality, hospitality software development, hospitality web development')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/services') }}">Industries</a></li><li aria-current="page">Hospitality</li></ol></nav>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Services</p><ul><li><a href="{{ url('/website-development-for-hospitality') }}">Website development</a></li><li><a href="{{ url('/website-design-for-hospitality') }}">Website design</a></li><li><a href="{{ url('/custom-software-development-for-hospitality') }}">Custom software development</a></li><li><a href="{{ url('/mobile-app-development-for-hospitality') }}">Mobile app development</a></li><li><a href="{{ url('/ecommerce-development-for-hospitality') }}">E-commerce development</a></li><li><a href="{{ url('/seo-services-for-hospitality') }}">SEO services</a></li><li><a href="{{ url('/local-seo-services-for-hospitality') }}">Local SEO services</a></li><li><a href="{{ url('/technical-seo-audit-for-hospitality') }}">Technical SEO audit</a></li><li><a href="{{ url('/ppc-advertising-for-hospitality') }}">PPC advertising</a></li></ul></div>
