...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Software Development for Logistics and transport | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Custom software, web and mobile development for logistics and transport businesses. Logistics operators care about vehicle utilisation and downtime above almost everything el')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'software for logistics and transport, logistics and transport software development, logistics and transport web development')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'services']) }}">Industries</a></li><li aria-current="page">Logistics and transport</li></ol></nav>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Services</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'website-development-for-logistics']) }}">Website development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'website-design-for-logistics']) }}">Website design</a></li><li><a href="{{ route('industry.detail', ['slug'=>'custom-software-development-for-logistics']) }}">Custom software development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'mobile-app-development-for-logistics']) }}">Mobile app development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ecommerce-development-for-logistics']) }}">E-commerce development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'seo-services-for-logistics']) }}">SEO services</a></li><li><a href="{{ route('industry.detail', ['slug'=>'local-seo-services-for-logistics']) }}">Local SEO services</a></li><li><a href="{{ route('industry.detail', ['slug'=>'technical-seo-audit-for-logistics']) }}">Technical SEO audit</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ppc-advertising-for-logistics']) }}">PPC advertising</a></li></ul></div>
 <div><p class="lbl">Other industries</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'software-for-travel-tourism']) }}">Travel and tourism</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-hospitality']) }}">Hospitality</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-healthcare']) }}">Healthcare</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-real-estate']) }}">Real estate</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-education']) }}">Education</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-ecommerce-retail']) }}">E-commerce and retail</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-automotive']) }}">Automotive</a></li></ul></div>
