...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Software Development for Education | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Custom software, web and mobile development for education businesses. Institutions have seasonal admission peaks and a mix of public-facing and internal adminis')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'software for education, education software development, education web development')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'services']) }}">Industries</a></li><li aria-current="page">Education</li></ol></nav>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Services</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'website-development-for-education']) }}">Website development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'website-design-for-education']) }}">Website design</a></li><li><a href="{{ route('industry.detail', ['slug'=>'custom-software-development-for-education']) }}">Custom software development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'mobile-app-development-for-education']) }}">Mobile app development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ecommerce-development-for-education']) }}">E-commerce development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'seo-services-for-education']) }}">SEO services</a></li><li><a href="{{ route('industry.detail', ['slug'=>'local-seo-services-for-education']) }}">Local SEO services</a></li><li><a href="{{ route('industry.detail', ['slug'=>'technical-seo-audit-for-education']) }}">Technical SEO audit</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ppc-advertising-for-education']) }}">PPC advertising</a></li></ul></div>
 <div><p class="lbl">Other industries</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'software-for-travel-tourism']) }}">Travel and tourism</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-hospitality']) }}">Hospitality</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-logistics']) }}">Logistics and transport</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-healthcare']) }}">Healthcare</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-real-estate']) }}">Real estate</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-ecommerce-retail']) }}">E-commerce and retail</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-automotive']) }}">Automotive</a></li></ul></div>
