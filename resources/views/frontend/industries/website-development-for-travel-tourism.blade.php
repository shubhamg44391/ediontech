...
@section('title', 'Website development for Travel and tourism | Edion Web Technologies')
@section('description', 'Website development built for travel and tourism businesses. Travel businesses live and die on availability accuracy and the speed of confirmation. A booking tha')
@section('keywords', 'website development for travel and tourism, travel and tourism software development')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/services') }}">Services</a></li><li aria-current="page"><b class="kw">Website development</b> for Travel and tourism</li></ol></nav>
