...
@section('title', 'PPC advertising for travel and tourism | Edion Web Technologies')
@section('description', 'PPC advertising for travel and tourism businesses. Travel paid media has a long consideration window, so last-click attribution will consistently mislead you')
@section('keywords', 'ppc advertising for travel and tourism, travel and tourism ppc advertising, ppc advertising travel tourism, travel and tourism software company, ppc advertising company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-travel-tourism') }}">Travel and tourism</a></li><li aria-current="page"><b class="kw">PPC advertising</b></li></ol></nav>
  ...
  <h1 style="margin-top:var(--sp-4)">PPC advertising for travel and tourism</h1>
  <p class="lead">Paid search managed against profit rather than click volume. This page covers what changes when the client is a travel and tourism business,
...
<section class="band band--ink">
  <div class="shell">
    <div class="sec-head" data-reveal>
      <div><p class="eyebrow">Questions</p><h2>PPC advertising for travel and tourism: common questions</h2></div>
    </div>
