...
@section('title', 'Car rental software development for Hospitality | Edion Web Technologies')
@section('description', 'Car rental software development built for hospitality businesses. Hotels and resorts increasingly bundle vehicle hire with stays, which means your rental system needs')
@section('keywords', 'car rental software development for hospitality, hospitality software development')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/services') }}">Services</a></li><li aria-current="page"><b class="kw"><b class="kw">Car rental software</b> development</b> for Hospitality</li></ol></nav>
