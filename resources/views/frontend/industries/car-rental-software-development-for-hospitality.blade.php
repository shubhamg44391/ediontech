...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Car rental software development for Hospitality | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Car rental software development built for hospitality businesses. Hotels and resorts increasingly bundle vehicle hire with stays, which means your rental system needs')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'car rental software development for hospitality, hospitality software development')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'industries']) }}">Industries</a></li><li aria-current="page"><b class="kw"><b class="kw">Car rental software</b> development</b> for Hospitality</li></ol></nav>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Other services</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'fleet-management-software-for-hospitality']) }}">Fleet management software</a></li><li><a href="{{ route('industry.detail', ['slug'=>'custom-software-development-for-hospitality']) }}">Custom software development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'website-development-for-hospitality']) }}">Website development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'seo-services-for-hospitality']) }}">SEO services</a></li></ul></div>
 <div><p class="lbl">Other industries</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-software-development-for-travel-tourism']) }}">Travel and tourism</a></li><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-software-development-for-logistics']) }}">Logistics and transport</a></li><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-software-development-for-healthcare']) }}">Healthcare</a></li><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-software-development-for-real-estate']) }}">Real estate</a></li><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-software-development-for-education']) }}">Education</a></li></ul></div>
