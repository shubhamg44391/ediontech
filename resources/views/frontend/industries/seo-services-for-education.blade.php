...
@section('title', 'SEO services for Education | Edion Web Technologies')
@section('description', 'SEO services built for education businesses. Institutions have seasonal admission peaks and a mix of public-facing and internal administrative sy')
@section('keywords', 'seo services for education, education software development')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/services') }}">Services</a></li><li aria-current="page"><b class="kw">SEO services</b> for Education</li></ol></nav>
