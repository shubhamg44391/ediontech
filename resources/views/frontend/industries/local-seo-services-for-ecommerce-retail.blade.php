...
@section('title', 'Local SEO services for e-commerce and retail | Edion Web Technologies')
@section('description', 'Local SEO services for e-commerce and retail businesses. Faceted navigation is the structural problem: filter permutations can generate a near-infinite crawl')
@section('keywords', 'local seo services for e-commerce and retail, e-commerce and retail local seo services, local seo services ecommerce retail, e-commerce and retail software company, local seo services company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-ecommerce-retail') }}">E-commerce and retail</a></li><li aria-current="page"><b class="kw">Local <b class="kw">SEO services</b></b></li></ol></nav>
