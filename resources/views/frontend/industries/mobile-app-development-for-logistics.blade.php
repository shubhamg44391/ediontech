...
@section('title', 'Mobile app development for logistics and transport | Edion Web Technologies')
@section('description', 'Mobile app development for logistics and transport businesses. Logistics systems live or die on data accuracy at the edge, where a driver on a phone in poor')
@section('keywords', 'mobile app development for logistics and transport, logistics and transport mobile app development, mobile app development logistics, logistics and transport software company, mobile app development company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-logistics') }}">Logistics and transport</a></li><li aria-current="page"><b class="kw">Mobile app development</b></li></ol></nav>
