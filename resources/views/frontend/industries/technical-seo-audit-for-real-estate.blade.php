...
@section('title', 'Technical SEO audit for real estate | Edion Web Technologies')
@section('description', 'Technical SEO audit for real estate businesses. Property SEO is won on location pages and structured listing data. We build a location hierarchy that scales')
@section('keywords', 'technical seo audit for real estate, real estate technical seo audit, technical seo audit real estate, real estate software company, technical seo audit company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-real-estate') }}">Real estate</a></li><li aria-current="page"><b class="kw">Technical SEO audit</b></li></ol></nav>
