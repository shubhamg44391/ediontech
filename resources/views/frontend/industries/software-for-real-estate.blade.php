...
@section('title', 'Software Development for Real estate | Edion Web Technologies')
@section('description', 'Custom software, web and mobile development for real estate businesses. Property businesses are lead-driven, and the cost of a lost enquiry is high enough to just')
@section('keywords', 'software for real estate, real estate software development, real estate web development')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/services') }}">Industries</a></li><li aria-current="page">Real estate</li></ol></nav>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Services</p><ul><li><a href="{{ url('/website-development-for-real-estate') }}">Website development</a></li><li><a href="{{ url('/website-design-for-real-estate') }}">Website design</a></li><li><a href="{{ url('/custom-software-development-for-real-estate') }}">Custom software development</a></li><li><a href="{{ url('/mobile-app-development-for-real-estate') }}">Mobile app development</a></li><li><a href="{{ url('/ecommerce-development-for-real-estate') }}">E-commerce development</a></li><li><a href="{{ url('/seo-services-for-real-estate') }}">SEO services</a></li><li><a href="{{ url('/local-seo-services-for-real-estate') }}">Local SEO services</a></li><li><a href="{{ url('/technical-seo-audit-for-real-estate') }}">Technical SEO audit</a></li><li><a href="{{ url('/ppc-advertising-for-real-estate') }}">PPC advertising</a></li></ul></div>
