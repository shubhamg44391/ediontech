...
@section('title', 'Website development for Real estate | Edion Web Technologies')
@section('description', 'Website development built for real estate businesses. Property businesses are lead-driven, and the cost of a lost enquiry is high enough to justify seriou')
@section('keywords', 'website development for real estate, real estate software development')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/services') }}">Services</a></li><li aria-current="page"><b class="kw">Website development</b> for Real estate</li></ol></nav>
