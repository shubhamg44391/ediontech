...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Technical SEO audit for education | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Technical SEO audit for education businesses. Education search peaks around admission cycles and is dominated by course and programme queries. We build progr')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'technical seo audit for education, education technical seo audit, technical seo audit education, education software company, technical seo audit company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'industries']) }}">Industries</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-education']) }}">Education</a></li><li aria-current="page"><b class="kw">Technical SEO audit</b></li></ol></nav>
  ...
  <h1 style="margin-top:var(--sp-4)">Technical SEO audit for education</h1>
  <p class="lead">A prioritised fix list with effort estimates, not a 90-page PDF. This page covers what changes when the client is a education business,
  ...
  <div class="article">
    ...
    <aside class="aside">
      ...
      <div class="card" style="padding:var(--sp-5)">
        ...
        <a class="btn btn--line" href="{{ route('industry.detail', ['slug'=>'software-for-education']) }}" style="justify-content:center">View sector<svg class="btn__arrow" viewBox="0 0 16 16" fill="none" aria-hidden="true"><path d="M2 8h12M9 3l5 5-5 5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></a>
      </div>
    </aside>
  </div>
</section>
...
<section class="band band--ink">
  <div class="shell">
    <div class="sec-head" data-reveal>
      <div><p class="eyebrow">Questions</p><h2>Technical SEO audit for education: common questions</h2></div>
    </div>
