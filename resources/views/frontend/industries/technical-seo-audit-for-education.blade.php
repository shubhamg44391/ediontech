...
@section('title', 'Technical SEO audit for education | Edion Web Technologies')
@section('description', 'Technical SEO audit for education businesses. Education search peaks around admission cycles and is dominated by course and programme queries. We build progr')
@section('keywords', 'technical seo audit for education, education technical seo audit, technical seo audit education, education software company, technical seo audit company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-education') }}">Education</a></li><li aria-current="page"><b class="kw">Technical SEO audit</b></li></ol></nav>
