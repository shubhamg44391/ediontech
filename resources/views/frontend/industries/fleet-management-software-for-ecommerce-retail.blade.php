...
@section('title', 'Fleet management software for E-commerce and retail | Edion Web Technologies')
@section('description', 'Fleet management software built for e-commerce and retail businesses. Retail competes on conversion rate and stock accuracy. Both are engineering problems as much as merc')
@section('keywords', 'fleet management software for e-commerce and retail, e-commerce and retail software development')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/services') }}">Services</a></li><li aria-current="page"><b class="kw">Fleet management software</b> for E-commerce and retail</li></ol></nav>
