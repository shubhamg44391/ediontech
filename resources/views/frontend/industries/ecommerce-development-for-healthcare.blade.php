...
@section('title', 'E-commerce development for healthcare | Edion Web Technologies')
@section('description', 'E-commerce development for healthcare businesses. Consent, retention and deletion have to be buildable, not just written in a policy. If a patient asks you t')
@section('keywords', 'e-commerce development for healthcare, healthcare e-commerce development, e-commerce development healthcare, healthcare software company, e-commerce development company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-healthcare') }}">Healthcare</a></li><li aria-current="page"><b class="kw">E-commerce development</b></li></ol></nav>
