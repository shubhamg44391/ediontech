...
@section('title', 'Local SEO services for automotive | Edion Web Technologies')
@section('description', 'Local SEO services for automotive businesses. Automotive search is make, model and location specific, with high intent and heavy local competition. Inventory')
@section('keywords', 'local seo services for automotive, automotive local seo services, local seo services automotive, automotive software company, local seo services company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-automotive') }}">Automotive</a></li><li aria-current="page"><b class="kw">Local <b class="kw">SEO services</b></b></li></ol></nav>
