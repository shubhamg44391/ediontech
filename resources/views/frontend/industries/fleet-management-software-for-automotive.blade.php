...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Fleet management software for Automotive | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Fleet management software built for automotive businesses. Dealers and workshops need booking, inventory and service history in one place, and usually have leg')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'fleet management software for automotive, automotive software development')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'industries']) }}">Industries</a></li><li aria-current="page"><b class="kw">Fleet management software</b> for Automotive</li></ol></nav>
 ...
 <h1 style="margin-top:var(--sp-4)">Fleet management software for automotive</h1>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Other services</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-software-development-for-automotive']) }}">Car rental software development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'custom-software-development-for-automotive']) }}">Custom software development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'website-development-for-automotive']) }}">Website development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'seo-services-for-automotive']) }}">SEO services</a></li></ul></div>
