...
@section('title', 'Car rental software development for Healthcare | Edion Web Technologies')
@section('description', 'Car rental software development built for healthcare businesses. Healthcare providers handle sensitive personal data and operate under stricter consent and retention')
@section('keywords', 'car rental software development for healthcare, healthcare software development')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/services') }}">Services</a></li><li aria-current="page"><b class="kw"><b class="kw">Car rental software</b> development</b> for Healthcare</li></ol></nav>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Other services</p><ul><li><a href="{{ url('/fleet-management-software-for-healthcare') }}">Fleet management software</a></li><li><a href="{{ url('/custom-software-development-for-healthcare') }}">Custom software development</a></li><li><a href="{{ url('/website-development-for-healthcare') }}">Website development</a></li><li><a href="{{ url('/seo-services-for-healthcare') }}">SEO services</a></li></ul></div>
