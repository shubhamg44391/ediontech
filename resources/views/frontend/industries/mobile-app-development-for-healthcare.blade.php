...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Mobile app development for healthcare | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Mobile app development for healthcare businesses. Consent, retention and deletion have to be buildable, not just written in a policy. If a patient asks you t')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'mobile app development for healthcare, healthcare mobile app development, mobile app development healthcare, healthcare software company, mobile app development company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'industries']) }}">Industries</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-healthcare']) }}">Healthcare</a></li><li aria-current="page"><b class="kw">Mobile app development</b></li></ol></nav>
  ...
  <h1 style="margin-top:var(--sp-4)">Mobile app development for healthcare</h1>
  <p class="lead">Native or cross-platform apps shipped to both stores and maintained after. This page covers what changes when the client is a healthcare business,
...
<section class="band band--ink">
  <div class="shell">
    <div class="sec-head" data-reveal>
      <div><p class="eyebrow">Questions</p><h2>Mobile app development for healthcare: common questions</h2></div>
    </div>
