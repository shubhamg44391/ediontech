...
@section('title', 'Mobile app development for healthcare | Edion Web Technologies')
@section('description', 'Mobile app development for healthcare businesses. Consent, retention and deletion have to be buildable, not just written in a policy. If a patient asks you t')
@section('keywords', 'mobile app development for healthcare, healthcare mobile app development, mobile app development healthcare, healthcare software company, mobile app development company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-healthcare') }}">Healthcare</a></li><li aria-current="page"><b class="kw">Mobile app development</b></li></ol></nav>
