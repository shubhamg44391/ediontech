...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'E-commerce development for real estate | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'E-commerce development for real estate businesses. Property platforms are read-heavy and search-heavy, so listing search performance is the whole product. We')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'e-commerce development for real estate, real estate e-commerce development, e-commerce development real estate, real estate software company, e-commerce development company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'industries']) }}">Industries</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-real-estate']) }}">Real estate</a></li><li aria-current="page"><b class="kw">E-commerce development</b></li></ol></nav>
