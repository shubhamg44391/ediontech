...
@section('title', 'E-commerce development for education | Edion Web Technologies')
@section('description', 'E-commerce development for education businesses. Admissions peaks mean the system is idle for months then handles a year of traffic in three weeks. We design')
@section('keywords', 'e-commerce development for education, education e-commerce development, e-commerce development education, education software company, e-commerce development company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-education') }}">Education</a></li><li aria-current="page"><b class="kw">E-commerce development</b></li></ol></nav>
