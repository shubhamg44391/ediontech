...
@section('title', 'Technical SEO audit for e-commerce and retail | Edion Web Technologies')
@section('description', 'Technical SEO audit for e-commerce and retail businesses. Faceted navigation is the structural problem: filter permutations can generate a near-infinite craw')
@section('keywords', 'technical seo audit for e-commerce and retail, e-commerce and retail technical seo audit, technical seo audit ecommerce retail, e-commerce and retail software company, technical seo audit company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-ecommerce-retail') }}">E-commerce and retail</a></li><li aria-current="page"><b class="kw">Technical SEO audit</b></li></ol></nav>
