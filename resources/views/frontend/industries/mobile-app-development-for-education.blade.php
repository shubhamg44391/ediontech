...
@section('title', 'Mobile app development for education | Edion Web Technologies')
@section('description', 'Mobile app development for education businesses. Admissions peaks mean the system is idle for months then handles a year of traffic in three weeks. We design')
@section('keywords', 'mobile app development for education, education mobile app development, mobile app development education, education software company, mobile app development company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-education') }}">Education</a></li><li aria-current="page"><b class="kw">Mobile app development</b></li></ol></nav>
