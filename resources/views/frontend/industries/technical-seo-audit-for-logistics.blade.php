...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Technical SEO audit for logistics and transport | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Technical SEO audit for logistics and transport businesses. Logistics buyers search commercially with route, mode and commodity modifiers. Service and lane p')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'technical seo audit for logistics and transport, logistics and transport technical seo audit, technical seo audit logistics, logistics and transport software company, technical seo audit company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'industries']) }}">Industries</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-logistics']) }}">Logistics and transport</a></li><li aria-current="page"><b class="kw">Technical SEO audit</b></li></ol></nav>
  <span class="ind-badge" style="display:inline-flex">
    <img src="{{ asset('assets/frontend/img/industry/logistics.svg') }}" alt="" width="34" height="34" loading="eager">
    <span>Logistics and transport</span></span>
  <h1 style="margin-top:var(--sp-4)">Technical SEO audit for logistics and transport</h1>
  <p class="lead">A prioritised fix list with effort estimates, not a 90-page PDF. This page covers what changes when the client is a logistics and transport business,
...
<section class="band band--tight shell">
  <div class="lp-facts" data-reveal>
    <div class="lp-fact"><b>Logistics</b><span>Sector experience</span></div>
...
<section class="band shell">
  <div class="article">
    <div class="article__body"><h2>Why logistics and transport needs a different approach</h2><p>Logistics operators care about <b class="kw2">utilisation</b> and <b class="kw2">downtime</b> above almost everything else, because an idle asset is pure cost and a late delivery is a lost contract.</p><h2>Technical SEO audit in this sector, specifically</h2><p>Logistics buyers search commercially with route, mode and commodity modifiers. Service and lane pages with genuinely specific detail outperform general freight content by a wide margin.</p><h2>Where we start</h2><p>For logistics and transport projects the first release centres on utilisation reporting, maintenance scheduling and <b class="kw2">telematics</b> ingestion. Those come first because they change how the business runs rather than how it looks. Visual refinement and secondary modules follow once the core is in real use, which is also when you learn which of them you actually need.</p><h2>How the engagement runs</h2><p>Weekly written updates, a staging URL open every day, and one accountable point of contact rather than a handoff chain. You review working software at each increment, so there is no reveal at the end where unpleasant surprises live.</p></div>
    <aside class="aside">
      ...
      <div class="card" style="padding:var(--sp-5)">
        <p class="card__idx">Logistics and transport</p>
        <h3 style="font-size:var(--fs-h4)">All services for this sector</h3>
        <p>See every service we deliver to logistics and transport businesses.</p>
        <a class="btn btn--line" href="{{ route('industry.detail', ['slug'=>'software-for-logistics']) }}" style="justify-content:center">View sector<svg class="btn__arrow" viewBox="0 0 16 16" fill="none" aria-hidden="true"><path d="M2 8h12M9 3l5 5-5 5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></a>
      </div>
    </aside>
  </div>
</section>
