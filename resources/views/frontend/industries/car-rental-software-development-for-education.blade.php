...
@section('title', 'Car rental software development for Education | Edion Web Technologies')
@section('description', 'Car rental software development built for education businesses. Institutions have seasonal admission peaks and a mix of public-facing and internal administrative sy')
@section('keywords', 'car rental software development for education, education software development')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/services') }}">Services</a></li><li aria-current="page"><b class="kw"><b class="kw">Car rental software</b> development</b> for Education</li></ol></nav>
