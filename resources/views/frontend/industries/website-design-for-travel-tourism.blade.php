...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Website design for travel and tourism | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Website design for travel and tourism businesses. Travel buyers compare four tabs at once, so clarity beats decoration. We design the availability and price')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'website design for travel and tourism, travel and tourism website design, website design travel tourism, travel and tourism software company, website design company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'industries']) }}">Industries</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-travel-tourism']) }}">Travel and tourism</a></li><li aria-current="page">Website design</li></ol></nav>
