...
@section('title', 'Website design for travel and tourism | Edion Web Technologies')
@section('description', 'Website design for travel and tourism businesses. Travel buyers compare four tabs at once, so clarity beats decoration. We design the availability and price')
@section('keywords', 'website design for travel and tourism, travel and tourism website design, website design travel tourism, travel and tourism software company, website design company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-travel-tourism') }}">Travel and tourism</a></li><li aria-current="page">Website design</li></ol></nav>
  ...
  <h1 style="margin-top:var(--sp-4)">Website design for travel and tourism</h1>
  <p class="lead">Design that starts with the flow, reviewed as clickable prototypes. This page covers what changes when the client is a travel and tourism business,
...
<section class="band band--ink">
  <div class="shell">
    <div class="sec-head" data-reveal>
      <div><p class="eyebrow">Questions</p><h2>Website design for travel and tourism: common questions</h2></div>
    </div>
