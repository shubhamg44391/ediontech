...
@section('title', 'E-commerce development for travel and tourism | Edion Web Technologies')
@section('description', 'E-commerce development for travel and tourism businesses. Peak-season load is the engineering constraint that defines a travel build. We design for the busie')
@section('keywords', 'e-commerce development for travel and tourism, travel and tourism e-commerce development, e-commerce development travel tourism, travel and tourism software company, e-commerce development company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-travel-tourism') }}">Travel and tourism</a></li><li aria-current="page"><b class="kw">E-commerce development</b></li></ol></nav>
  ...
  <h1 style="margin-top:var(--sp-4)">E-commerce development for travel and tourism</h1>
  <p class="lead">Storefronts built for conversion rather than launch day. This page covers what changes when the client is a travel and tourism business,
...
<section class="band band--ink">
  <div class="shell">
    <div class="sec-head" data-reveal>
      <div><p class="eyebrow">Questions</p><h2>E-commerce development for travel and tourism: common questions</h2></div>
    </div>
