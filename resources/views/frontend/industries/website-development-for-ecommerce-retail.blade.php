...
@section('title', 'Website development for E-commerce and retail | Edion Web Technologies')
@section('description', 'Website development built for e-commerce and retail businesses. Retail competes on conversion rate and stock accuracy. Both are engineering problems as much as merc')
@section('keywords', 'website development for e-commerce and retail, e-commerce and retail software development')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/services') }}">Services</a></li><li aria-current="page"><b class="kw">Website development</b> for E-commerce and retail</li></ol></nav>
