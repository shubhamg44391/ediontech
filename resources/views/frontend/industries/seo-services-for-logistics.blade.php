...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'SEO services for Logistics and transport | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'SEO services built for logistics and transport businesses. Logistics operators care about vehicle utilisation and downtime above almost everything else, becaus')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'seo services for logistics and transport, logistics and transport software development')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'industries']) }}">Industries</a></li><li aria-current="page"><b class="kw">SEO services</b> for Logistics and transport</li></ol></nav>
 ...
 <h1 style="margin-top:var(--sp-4)">SEO services for logistics and transport</h1>
 <p class="lead">Technical, on-page, off-page and local SEO, with published pricing and monthly reporting that explains the bad months instead of burying them. This page covers what changes when the client is a logistics and transport business.</p>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Other services</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-software-development-for-logistics']) }}">Car rental software development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'fleet-management-software-for-logistics']) }}">Fleet management software</a></li><li><a href="{{ route('industry.detail', ['slug'=>'custom-software-development-for-logistics']) }}">Custom software development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'website-development-for-logistics']) }}">Website development</a></li></ul></div>
