...
@section('title', 'Local SEO services for hospitality | Edion Web Technologies')
@section('description', 'Local SEO services for hospitality businesses. Hospitality SEO is a local pack fight plus a direct-booking fight against OTAs. Google Business Profile, revie')
@section('keywords', 'local seo services for hospitality, hospitality local seo services, local seo services hospitality, hospitality software company, local seo services company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-hospitality') }}">Hospitality</a></li><li aria-current="page"><b class="kw">Local <b class="kw">SEO services</b></b></li></ol></nav>
