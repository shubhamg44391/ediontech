...
@section('title', 'Website design for healthcare | Edion Web Technologies')
@section('description', 'Website design for healthcare businesses. Healthcare interfaces serve anxious people and time-pressed clinicians, often the same screen. We design for plain')
@section('keywords', 'website design for healthcare, healthcare website design, website design healthcare, healthcare software company, website design company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-healthcare') }}">Healthcare</a></li><li aria-current="page">Website design</li></ol></nav>
