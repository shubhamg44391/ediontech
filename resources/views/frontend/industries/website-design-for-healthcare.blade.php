...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Website design for healthcare | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Website design for healthcare businesses. Healthcare interfaces serve anxious people and time-pressed clinicians, often the same screen. We design for plain')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'website design for healthcare, healthcare website design, website design healthcare, healthcare software company, website design company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'industries']) }}">Industries</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-healthcare']) }}">Healthcare</a></li><li aria-current="page">Website design</li></ol></nav>
  ...
  <h1 style="margin-top:var(--sp-4)">Website design for healthcare</h1>
  <p class="lead">Design that starts with the flow, reviewed as clickable prototypes. This page covers what changes when the client is a healthcare business,
...
<section class="band band--ink">
  <div class="shell">
    <div class="sec-head" data-reveal>
      <div><p class="eyebrow">Questions</p><h2>Website design for healthcare: common questions</h2></div>
    </div>
