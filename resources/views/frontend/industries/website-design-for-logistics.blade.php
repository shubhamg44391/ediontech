...
@section('title', 'Website design for logistics and transport | Edion Web Technologies')
@section('description', 'Website design for logistics and transport businesses. Operational interfaces used forty times a shift are judged on click count, not aesthetics. We measure')
@section('keywords', 'website design for logistics and transport, logistics and transport website design, website design logistics, logistics and transport software company, website design company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-logistics') }}">Logistics and transport</a></li><li aria-current="page">Website design</li></ol></nav>
