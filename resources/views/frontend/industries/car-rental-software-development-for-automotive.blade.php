...
@section('title', 'Car rental software development for Automotive | Edion Web Technologies')
@section('description', 'Car rental software development built for automotive businesses. Dealers and workshops need booking, inventory and service history in one place, and usually have leg')
@section('keywords', 'car rental software development for automotive, automotive software development')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/services') }}">Services</a></li><li aria-current="page"><b class="kw"><b class="kw">Car rental software</b> development</b> for Automotive</li></ol></nav>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Other services</p><ul><li><a href="{{ url('/fleet-management-software-for-automotive') }}">Fleet management software</a></li><li><a href="{{ url('/custom-software-development-for-automotive') }}">Custom software development</a></li><li><a href="{{ url('/website-development-for-automotive') }}">Website development</a></li><li><a href="{{ url('/seo-services-for-automotive') }}">SEO services</a></li></ul></div>
