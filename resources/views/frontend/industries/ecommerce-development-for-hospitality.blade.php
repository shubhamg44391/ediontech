...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'E-commerce development for hospitality | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'E-commerce development for hospitality businesses. The integration surface is what makes hospitality builds harder than they look: property management, chann')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'e-commerce development for hospitality, hospitality e-commerce development, e-commerce development hospitality, hospitality software company, e-commerce development company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'industries']) }}">Industries</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-hospitality']) }}">Hospitality</a></li><li aria-current="page"><b class="kw">E-commerce development</b></li></ol></nav>
  ...
  <h1 style="margin-top:var(--sp-4)">E-commerce development for hospitality</h1>
  <p class="lead">Storefronts built for conversion rather than launch day. This page covers what changes when the client is a hospitality business,
...
<section class="band band--ink">
  <div class="shell">
    <div class="sec-head" data-reveal>
      <div><p class="eyebrow">Questions</p><h2>E-commerce development for hospitality: common questions</h2></div>
    </div>
