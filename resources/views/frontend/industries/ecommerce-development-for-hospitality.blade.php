...
@section('title', 'E-commerce development for hospitality | Edion Web Technologies')
@section('description', 'E-commerce development for hospitality businesses. The integration surface is what makes hospitality builds harder than they look: property management, chann')
@section('keywords', 'e-commerce development for hospitality, hospitality e-commerce development, e-commerce development hospitality, hospitality software company, e-commerce development company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-hospitality') }}">Hospitality</a></li><li aria-current="page"><b class="kw">E-commerce development</b></li></ol></nav>
