...
@section('title', 'PPC advertising for car rental and mobility | Edion Web Technologies')
@section('description', 'PPC advertising for car rental and mobility businesses. Every booking through an aggregator carries commission you never recover, so paid media for rental is')
@section('keywords', 'ppc advertising for car rental and mobility, car rental and mobility ppc advertising, ppc advertising car rental mobility, car rental and mobility software company, ppc advertising company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-car-rental-mobility') }}">Car rental and mobility</a></li><li aria-current="page"><b class="kw">PPC advertising</b></li></ol></nav>
