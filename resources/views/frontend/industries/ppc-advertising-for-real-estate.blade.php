...
@section('title', 'PPC advertising for real estate | Edion Web Technologies')
@section('description', 'PPC advertising for real estate businesses. Property leads decay fast, so speed of response matters more than volume. We tie campaigns to a lead routing and')
@section('keywords', 'ppc advertising for real estate, real estate ppc advertising, ppc advertising real estate, real estate software company, ppc advertising company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-real-estate') }}">Real estate</a></li><li aria-current="page"><b class="kw">PPC advertising</b></li></ol></nav>
