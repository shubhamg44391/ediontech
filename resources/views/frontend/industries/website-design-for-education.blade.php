...
@section('title', 'Website design for education | Edion Web Technologies')
@section('description', 'Website design for education businesses. Education sites serve prospective students, current students, parents and staff with completely different intents. W')
@section('keywords', 'website design for education, education website design, website design education, education software company, website design company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-education') }}">Education</a></li><li aria-current="page">Website design</li></ol></nav>
