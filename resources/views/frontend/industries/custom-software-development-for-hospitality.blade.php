...
@section('title', 'Custom software development for Hospitality | Edion Web Technologies')
@section('description', 'Custom software development built for hospitality businesses. Hotels and resorts increasingly bundle vehicle hire with stays, which means your rental system needs')
@section('keywords', 'custom software development for hospitality, hospitality software development')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/services') }}">Services</a></li><li aria-current="page"><b class="kw">Custom software development</b> for Hospitality</li></ol></nav>
