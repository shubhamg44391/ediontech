...
@section('title', 'Mobile app development for real estate | Edion Web Technologies')
@section('description', 'Mobile app development for real estate businesses. Property platforms are read-heavy and search-heavy, so listing search performance is the whole product. We')
@section('keywords', 'mobile app development for real estate, real estate mobile app development, mobile app development real estate, real estate software company, mobile app development company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-real-estate') }}">Real estate</a></li><li aria-current="page"><b class="kw">Mobile app development</b></li></ol></nav>
