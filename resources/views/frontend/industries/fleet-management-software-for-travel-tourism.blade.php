...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Fleet management software for Travel and tourism | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Fleet management software built for travel and tourism businesses. Travel businesses live and die on availability accuracy and the speed of confirmation. A booking tha')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'fleet management software for travel and tourism, travel and tourism software development')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'industries']) }}">Industries</a></li><li aria-current="page"><b class="kw">Fleet management software</b> for Travel and tourism</li></ol></nav>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Other services</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-software-development-for-travel-tourism']) }}">Car rental software development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'custom-software-development-for-travel-tourism']) }}">Custom software development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'website-development-for-travel-tourism']) }}">Website development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'seo-services-for-travel-tourism']) }}">SEO services</a></li></ul></div>
 <div><p class="lbl">Other industries</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'fleet-management-software-for-hospitality']) }}">Hospitality</a></li><li><a href="{{ route('industry.detail', ['slug'=>'fleet-management-software-for-logistics']) }}">Logistics and transport</a></li><li><a href="{{ route('industry.detail', ['slug'=>'fleet-management-software-for-healthcare']) }}">Healthcare</a></li><li><a href="{{ route('industry.detail', ['slug'=>'fleet-management-software-for-real-estate']) }}">Real estate</a></li><li><a href="{{ route('industry.detail', ['slug'=>'fleet-management-software-for-education']) }}">Education</a></li></ul></div>
