...
@section('title', 'Website design for hospitality | Edion Web Technologies')
@section('description', 'Website design for hospitality businesses. Guest-facing design has to work for a tired traveller on hotel wifi at midnight. We test on poor connections and m')
@section('keywords', 'website design for hospitality, hospitality website design, website design hospitality, hospitality software company, website design company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-hospitality') }}">Hospitality</a></li><li aria-current="page">Website design</li></ol></nav>
