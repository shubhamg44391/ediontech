...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Website design for hospitality | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Website design for hospitality businesses. Guest-facing design has to work for a tired traveller on hotel wifi at midnight. We test on poor connections and m')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'website design for hospitality, hospitality website design, website design hospitality, hospitality software company, website design company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'industries']) }}">Industries</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-hospitality']) }}">Hospitality</a></li><li aria-current="page">Website design</li></ol></nav>
  ...
  <h1 style="margin-top:var(--sp-4)">Website design for hospitality</h1>
  <p class="lead">Design that starts with the flow, reviewed as clickable prototypes. This page covers what changes when the client is a hospitality business,
...
<section class="band band--ink">
  <div class="shell">
    <div class="sec-head" data-reveal>
      <div><p class="eyebrow">Questions</p><h2>Website design for hospitality: common questions</h2></div>
    </div>
