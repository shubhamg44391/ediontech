...
@section('title', 'E-commerce development for automotive | Edion Web Technologies')
@section('description', 'E-commerce development for automotive businesses. Automotive builds almost always mean integration with a dealer management system you cannot replace. We des')
@section('keywords', 'e-commerce development for automotive, automotive e-commerce development, e-commerce development automotive, automotive software company, e-commerce development company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-automotive') }}">Automotive</a></li><li aria-current="page"><b class="kw">E-commerce development</b></li></ol></nav>
