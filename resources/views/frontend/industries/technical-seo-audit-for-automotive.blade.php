...
@section('title', 'Technical SEO audit for automotive | Edion Web Technologies')
@section('description', 'Technical SEO audit for automotive businesses. Automotive search is make, model and location specific, with high intent and heavy local competition. Inventor')
@section('keywords', 'technical seo audit for automotive, automotive technical seo audit, technical seo audit automotive, automotive software company, technical seo audit company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-automotive') }}">Automotive</a></li><li aria-current="page"><b class="kw">Technical SEO audit</b></li></ol></nav>
