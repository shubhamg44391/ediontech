...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Technical SEO audit for car rental and mobility | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Technical SEO audit for car rental and mobility businesses. Rental search splits sharply between brand, location and vehicle-category intent, and aggregators')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'technical seo audit for car rental and mobility, car rental and mobility technical seo audit, technical seo audit car rental mobility, car rental and mobility software company, technical seo audit company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'industries']) }}">Industries</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-car-rental-mobility']) }}">Car rental and mobility</a></li><li aria-current="page"><b class="kw">Technical SEO audit</b></li></ol></nav>
  ...
  <h1 style="margin-top:var(--sp-4)">Technical SEO audit for car rental and mobility</h1>
  <p class="lead">A prioritised fix list with effort estimates, not a 90-page PDF. This page covers what changes when the client is a car rental and mobility business,
...
<section class="band band--ink">
  <div class="shell">
    <div class="sec-head" data-reveal>
      <div><p class="eyebrow">Questions</p><h2>Technical SEO audit for car rental and mobility: common questions</h2></div>
    </div>
