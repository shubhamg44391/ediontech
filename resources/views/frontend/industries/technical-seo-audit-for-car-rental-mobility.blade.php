...
@section('title', 'Technical SEO audit for car rental and mobility | Edion Web Technologies')
@section('description', 'Technical SEO audit for car rental and mobility businesses. Rental search splits sharply between brand, location and vehicle-category intent, and aggregators')
@section('keywords', 'technical seo audit for car rental and mobility, car rental and mobility technical seo audit, technical seo audit car rental mobility, car rental and mobility software company, technical seo audit company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-car-rental-mobility') }}">Car rental and mobility</a></li><li aria-current="page"><b class="kw">Technical SEO audit</b></li></ol></nav>
