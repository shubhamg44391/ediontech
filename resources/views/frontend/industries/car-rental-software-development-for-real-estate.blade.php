...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Car rental software development for Real estate | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Car rental software development built for real estate businesses. Property businesses are lead-driven, and the cost of a lost enquiry is high enough to justify seriou')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'car rental software development for real estate, real estate software development')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'industries']) }}">Industries</a></li><li aria-current="page"><b class="kw"><b class="kw">Car rental software</b> development</b> for Real estate</li></ol></nav>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Other services</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'fleet-management-software-for-real-estate']) }}">Fleet management software</a></li><li><a href="{{ route('industry.detail', ['slug'=>'custom-software-development-for-real-estate']) }}">Custom software development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'website-development-for-real-estate']) }}">Website development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'seo-services-for-real-estate']) }}">SEO services</a></li></ul></div>
 <div><p class="lbl">Other industries</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-software-development-for-travel-tourism']) }}">Travel and tourism</a></li><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-software-development-for-hospitality']) }}">Hospitality</a></li><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-software-development-for-logistics']) }}">Logistics and transport</a></li><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-software-development-for-healthcare']) }}">Healthcare</a></li><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-software-development-for-education']) }}">Education</a></li></ul></div>
