...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Local SEO services for real estate | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Local SEO services for real estate businesses. Property SEO is won on location pages and structured listing data. We build a location hierarchy that scales w')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'local seo services for real estate, real estate local seo services, local seo services real estate, real estate software company, local seo services company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'industries']) }}">Industries</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-real-estate']) }}">Real estate</a></li><li aria-current="page"><b class="kw">Local <b class="kw">SEO services</b></b></li></ol></nav>
  ...
  <h1 style="margin-top:var(--sp-4)">Local SEO services for real estate</h1>
  <p class="lead"><b class="kw2">Google Business Profile</b>, citations and reviews for businesses that need the phone to ring. This page covers what changes when the client is a real estate business,
...
<section class="band band--ink">
  <div class="shell">
    <div class="sec-head" data-reveal>
      <div><p class="eyebrow">Questions</p><h2>Local SEO services for real estate: common questions</h2></div>
    </div>
