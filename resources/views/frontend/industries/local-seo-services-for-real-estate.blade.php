...
@section('title', 'Local SEO services for real estate | Edion Web Technologies')
@section('description', 'Local SEO services for real estate businesses. Property SEO is won on location pages and structured listing data. We build a location hierarchy that scales w')
@section('keywords', 'local seo services for real estate, real estate local seo services, local seo services real estate, real estate software company, local seo services company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-real-estate') }}">Real estate</a></li><li aria-current="page"><b class="kw">Local <b class="kw">SEO services</b></b></li></ol></nav>
