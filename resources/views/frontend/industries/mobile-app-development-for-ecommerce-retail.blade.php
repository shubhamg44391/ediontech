...
@section('title', 'Mobile app development for e-commerce and retail | Edion Web Technologies')
@section('description', 'Mobile app development for e-commerce and retail businesses. Checkout is where the money leaks and stock accuracy is where the trust goes. We instrument the')
@section('keywords', 'mobile app development for e-commerce and retail, e-commerce and retail mobile app development, mobile app development ecommerce retail, e-commerce and retail software company, mobile app development company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-ecommerce-retail') }}">E-commerce and retail</a></li><li aria-current="page"><b class="kw">Mobile app development</b></li></ol></nav>
