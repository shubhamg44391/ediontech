...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'PPC advertising for healthcare | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'PPC advertising for healthcare businesses. Healthcare advertising carries platform restrictions on targeting and creative that catch most agencies out. We wo')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'ppc advertising for healthcare, healthcare ppc advertising, ppc advertising healthcare, healthcare software company, ppc advertising company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'industries']) }}">Industries</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-for-healthcare']) }}">Healthcare</a></li><li aria-current="page"><b class="kw">PPC advertising</b></li></ol></nav>
  ...
  <h1 style="margin-top:var(--sp-4)">PPC advertising for healthcare</h1>
  <p class="lead">Paid search managed against profit rather than click volume. This page covers what changes when the client is a healthcare business,
...
<section class="band band--ink">
  <div class="shell">
    <div class="sec-head" data-reveal>
      <div><p class="eyebrow">Questions</p><h2>PPC advertising for healthcare: common questions</h2></div>
    </div>
