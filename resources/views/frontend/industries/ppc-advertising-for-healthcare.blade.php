...
@section('title', 'PPC advertising for healthcare | Edion Web Technologies')
@section('description', 'PPC advertising for healthcare businesses. Healthcare advertising carries platform restrictions on targeting and creative that catch most agencies out. We wo')
@section('keywords', 'ppc advertising for healthcare, healthcare ppc advertising, ppc advertising healthcare, healthcare software company, ppc advertising company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-healthcare') }}">Healthcare</a></li><li aria-current="page"><b class="kw">PPC advertising</b></li></ol></nav>
