...
@section('title', 'Local SEO services for travel and tourism | Edion Web Technologies')
@section('description', 'Local SEO services for travel and tourism businesses. Travel search is dominated by aggregators and heavily seasonal, so the winnable ground is long-tail and')
@section('keywords', 'local seo services for travel and tourism, travel and tourism local seo services, local seo services travel tourism, travel and tourism software company, local seo services company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-travel-tourism') }}">Travel and tourism</a></li><li aria-current="page"><b class="kw">Local <b class="kw">SEO services</b></b></li></ol></nav>
  ...
  <h1 style="margin-top:var(--sp-4)">Local SEO services for travel and tourism</h1>
  <p class="lead"><b class="kw2">Google Business Profile</b>, citations and reviews for businesses that need the phone to ring. This page covers what changes when the client is a travel and tourism business,
  ...
  <div class="article">
    ...
    <aside class="aside">
      ...
      <div class="card" style="padding:var(--sp-5)">
        ...
        <a class="btn btn--line" href="{{ url('/software-for-travel-tourism') }}" style="justify-content:center">View sector<svg class="btn__arrow" viewBox="0 0 16 16" fill="none" aria-hidden="true"><path d="M2 8h12M9 3l5 5-5 5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></a>
      </div>
    </aside>
  </div>
</section>
...
<section class="band band--ink">
  <div class="shell">
    <div class="sec-head" data-reveal>
      <div><p class="eyebrow">Questions</p><h2>Local SEO services for travel and tourism: common questions</h2></div>
    </div>
