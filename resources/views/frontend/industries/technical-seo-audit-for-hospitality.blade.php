...
@section('title', 'Technical SEO audit for hospitality | Edion Web Technologies')
@section('description', 'Technical SEO audit for hospitality businesses. Hospitality SEO is a local pack fight plus a direct-booking fight against OTAs. Google Business Profile, revi')
@section('keywords', 'technical seo audit for hospitality, hospitality technical seo audit, technical seo audit hospitality, hospitality software company, technical seo audit company')
...
<section class="phero shell">
  <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/industries') }}">Industries</a></li><li><a href="{{ url('/software-for-hospitality') }}">Hospitality</a></li><li aria-current="page"><b class="kw">Technical SEO audit</b></li></ol></nav>
  ...
  <div class="article">
    ...
    <aside class="aside">
      ...
      <div class="card" style="padding:var(--sp-5)">
        ...
        <a class="btn btn--line" href="{{ url('/software-for-hospitality') }}" style="justify-content:center">View sector<svg class="btn__arrow" viewBox="0 0 16 16" fill="none" aria-hidden="true"><path d="M2 8h12M9 3l5 5-5 5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></a>
      </div>
    </aside>
  </div>
</section>
