...
@section('title', 'Fleet management software for Healthcare | Edion Web Technologies')
@section('description', 'Fleet management software built for healthcare businesses. Healthcare providers handle sensitive personal data and operate under stricter consent and retention')
@section('keywords', 'fleet management software for healthcare, healthcare software development')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/services') }}">Services</a></li><li aria-current="page"><b class="kw">Fleet management software</b> for Healthcare</li></ol></nav>
