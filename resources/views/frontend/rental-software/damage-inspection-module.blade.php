...
@section('title', 'Damage and inspection capture | Edion Web Technologies')
@section('description', 'Timestamped condition capture at collection and return, with fuel and odometer readings, a digital agreement and signature. This module is your evidence when')
@section('keywords', 'damage and inspection capture, damage inspection module, Edion Web Technologies')
