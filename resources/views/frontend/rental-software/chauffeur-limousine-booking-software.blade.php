...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Chauffeur and limousine booking software | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'If you dispatch drivers as well as rent vehicles, that is genuinely a different product: driver rostering, live dispatch, route-based trip pricing and driver')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'chauffeur and limousine booking software, chauffeur limousine booking software, Edion Web Technologies')

@section('main-container')
<main id="main"><a id="top"></a>

<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li aria-current="page"><b class="kw2">Chauffeur and limousine</b> booking software</li></ol></nav>
 <p class="eyebrow">Chauffeur</p>
 <h1 style="margin-top:var(--sp-4)">Dispatch software for chauffeur and limousine operations</h1>
 <p class="lead">If you dispatch drivers as well as rent vehicles, that is genuinely a different product: driver rostering, live dispatch, route-based trip pricing and driver settlements. It shares your <b class="kw2">fleet register</b> and nothing else.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>Live dispatch</b><span>Real-time assignment</span></div><div class="lp-fact"><b>Route pricing</b><span>Editable rule sets</span></div><div class="lp-fact"><b>Settlements</b><span>Automated driver payouts</span></div></div>
</section>
