...
@section('title', 'Telematics and GPS integration | Edion Web Technologies')
@section('description', 'Live location, mileage, fuel and engine telemetry, geofence alerts and driver behaviour data, ingested into your own platform rather than trapped in a vendor')
@section('keywords', 'telematics and gps integration, telematics integration, Edion Web Technologies')
