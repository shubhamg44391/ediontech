...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Telematics and GPS integration | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Live location, mileage, fuel and engine telemetry, geofence alerts and driver behaviour data, ingested into your own platform rather than trapped in a vendor')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'telematics and gps integration, telematics integration, Edion Web Technologies')

@section('main-container')
<main id="main"><a id="top"></a>

<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li aria-current="page"><b class="kw2">Telematics</b> and GPS integration</li></ol></nav>
 <p class="eyebrow">Modules</p>
 <h1 style="margin-top:var(--sp-4)">Telematics ingestion that survives changing your device vendor</h1>
 <p class="lead">Live location, mileage, fuel and engine telemetry, <b class="kw2">geofence</b> alerts and driver behaviour data, ingested into your own platform rather than trapped in a vendor dashboard.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>Vendor-neutral</b><span>Normalised ingestion</span></div><div class="lp-fact"><b>20+ vehicles</b><span>Viable fleet size in 2026</span></div><div class="lp-fact"><b>2-4 wks</b><span>Typical integration</span></div></div>
</section>
...
<section class="band shell">
 <div class="article">
 <div class="article__body"><h2>Own the data layer</h2><p>Device vendors change and contracts end. We build an ingestion layer that normalises telemetry so switching hardware is a configuration job, not a rebuild.</p><h2>What operators actually use</h2><p>In practice, three things earn their keep: knowing where a vehicle is during a dispute, mileage for service scheduling, and geofence alerts for unauthorised cross-border use.</p></div>
 <aside class="aside">
