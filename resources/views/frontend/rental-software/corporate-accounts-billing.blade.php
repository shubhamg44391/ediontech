...
@section('title', 'Corporate accounts and billing | Edion Web Technologies')
@section('description', 'Negotiated rate cards per account, credit terms, cost-centre tagging, consolidated invoicing and multi-currency, handled in the same reservation flow as walk')
@section('keywords', 'corporate accounts and billing, corporate accounts billing, Edion Web Technologies')
