...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Corporate accounts and billing | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Negotiated rate cards per account, credit terms, cost-centre tagging, consolidated invoicing and multi-currency, handled in the same reservation flow as walk')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'corporate accounts and billing, corporate accounts billing, Edion Web Technologies')

@section('main-container')
<main id="main"><a id="top"></a>

<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li aria-current="page">Corporate accounts and billing</li></ol></nav>
 <p class="eyebrow">Modules</p>
 <h1 style="margin-top:var(--sp-4)">Corporate hire without the month-end reconciliation</h1>
 <p class="lead">Negotiated rate cards per account, credit terms, cost-centre tagging, consolidated invoicing and <b class="kw2">multi-currency</b>, handled in the same reservation flow as walk-in business.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>Credit terms</b><span>Per-account billing cycles</span></div><div class="lp-fact"><b>Multi-currency</b><span>Cross-border operations</span></div><div class="lp-fact"><b>Accounting sync</b><span>No re-keying</span></div></div>
</section>
...
<section class="band shell">
 <div class="article">
 <div class="article__body"><h2>One flow, three customer types</h2><p>Walk-ins, corporate accounts and long-term leases should not need three separate screens. We model the differences in data, not in duplicated interfaces.</p><h2>Accounting sync</h2><p>Consolidated invoices pushed to your accounting system, with cost-centre detail intact, so finance is not re-keying anything.</p></div>
 <aside class="aside">
