...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li aria-current="page"><b class="kw2">Dynamic pricing</b> engine for rentals</li></ol></nav>
 <p class="eyebrow">Modules</p>
 <h1 style="margin-top:var(--sp-4)">Pricing rules you can change without raising a ticket</h1>
 <p class="lead">Base rates by category and duration, seasonal multipliers, weekend and long-term tiers, corporate rate cards, promotional codes and location surcharges. All editable by your team.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>Editable</b><span>No developer needed for rate changes</span></div><div class="lp-fact"><b>Rule-based</b><span>Season, duration, category, location</span></div><div class="lp-fact"><b>4-6 wks</b><span>Typical module</span></div></div>
</section>
...
<section class="band shell">
 <div class="article">
 <div class="article__body"><h2>Why hard-coded pricing costs you money</h2><p>Every seasonal change becomes a developer ticket, which means it happens late, which means you sell at the wrong rate for a week each season. The engineering to make pricing editable pays back in the first year.</p><h2>Rate cards for corporate accounts</h2><p>Negotiated rates per account, with credit terms and consolidated monthly invoicing, sitting alongside walk-in pricing in the same reservation flow.</p></div>
 <aside class="aside">
