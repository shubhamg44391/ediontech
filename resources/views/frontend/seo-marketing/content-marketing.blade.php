...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li aria-current="page"><b class="kw">Content marketing</b></li></ol></nav>
 <p class="eyebrow">Marketing</p>
 <h1 style="margin-top:var(--sp-4)">Content written by people who understand the subject</h1>
 <p class="lead">Editorial, landing pages and technical content that ranks and holds attention once it does.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>Intent-mapped</b><span>Before anything is written</span></div><div class="lp-fact"><b>Subject-led</b><span>Written with an expert</span></div><div class="lp-fact"><b>Refreshed</b><span>Existing pages updated too</span></div></div>
</section>
...
<section class="band shell">
 <div class="article">
 <div class="article__body"><h2>Search intent, then subject expertise</h2><p>We map what people actually search, then write with someone who knows the topic. Content produced without either is why most company blogs sit unread.</p><h2>Fewer, better pieces</h2><p>Thin content at volume is now a liability rather than a strategy. We would rather publish four substantial pieces a month than twenty forgettable ones.</p></div>
 <aside class="aside">
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Marketing</p><ul><li><a href="{{ url('/ppc-advertising') }}">PPC advertising</a></li><li><a href="{{ url('/social-media-marketing') }}">Social media marketing</a></li><li><a href="{{ url('/email-marketing') }}">Email marketing</a></li></ul></div>
