...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'E-commerce SEO | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Category architecture, faceted navigation control, product schema, internal linking at scale and content on the pages that actually convert.')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'e-commerce seo, ecommerce seo, Edion Web Technologies')

@section('main-container')
<main id="main"><a id="top"></a>

<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li aria-current="page">E-commerce SEO</li></ol></nav>
 <p class="eyebrow">SEO</p>
 <h1 style="margin-top:var(--sp-4)">E-commerce SEO built around the catalogue, not the blog</h1>
 <p class="lead">Category architecture, faceted navigation control, product schema, internal linking at scale and content on the pages that actually convert.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>Crawl budget</b><span>Facets brought under control</span></div><div class="lp-fact"><b>Product schema</b><span>Price, stock, reviews</span></div><div class="lp-fact"><b>Category-first</b><span>Where intent actually is</span></div></div>
</section>
...
<section class="band shell">
 <div class="article">
 <div class="article__body"><h2>Faceted navigation is the usual disaster</h2><p>Filter combinations generating millions of crawlable URLs will exhaust your <b class="kw2">crawl budget</b> before Google reaches your products. Controlling this is often the single highest-impact fix.</p><h2>Category pages earn more than blog posts</h2><p>Commercial intent lives on category and product pages. We invest content effort there first.</p></div>
 <aside class="aside">
...
<section class="band band--ink">
 ...
 <div><p class="lbl">SEO</p><ul><li><a href="{{ url('/seo-services') }}">SEO services</a></li><li><a href="{{ url('/local-seo-services') }}">Local SEO services</a></li><li><a href="{{ url('/technical-seo-audit') }}">Technical SEO audit</a></li><li><a href="{{ url('/link-building-services') }}">Link building services</a></li></ul></div>
