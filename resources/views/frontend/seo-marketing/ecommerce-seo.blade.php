...
@section('title', 'E-commerce SEO | Edion Web Technologies')
@section('description', 'Category architecture, faceted navigation control, product schema, internal linking at scale and content on the pages that actually convert.')
@section('keywords', 'e-commerce seo, ecommerce seo, Edion Web Technologies')
