...
@section('title', 'Technical SEO audit | Edion Web Technologies')
@section('description', 'Crawlability, indexation, canonicals, Core Web Vitals, structured data, redirects and internal linking. Delivered as a ranked list of fixes with effort estim')
@section('keywords', 'technical seo audit, technical seo audit, Edion Web Technologies')
