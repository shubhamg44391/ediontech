...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li aria-current="page">AI assistant visibility</li></ol></nav>
 <p class="eyebrow">AI search</p>
 <h1 style="margin-top:var(--sp-4)">Showing up in ChatGPT, Gemini, Perplexity and AI Overviews</h1>
 <p class="lead">Auditing how assistants currently describe your business, correcting what they get wrong, and building the citable sources they draw on.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>Audited</b><span>What assistants say today</span></div><div class="lp-fact"><b>Corrected</b><span>Third-party profile accuracy</span></div><div class="lp-fact"><b>Sourced</b><span>Citable pages on your domain</span></div></div>
</section>
...
<section class="band shell">
 <div class="article">
 <div class="article__body"><h2>First, find out what they say now</h2><p>We audit how each major assistant currently answers questions about your category and your brand. The gap between that and reality is the work.</p><h2>Citable sources compound</h2><p>Assistants lean on sources they can attribute. Substantial, factual pages on your own domain plus accurate third-party profiles do more than any keyword change.</p></div>
 <aside class="aside">
...
<section class="band band--ink">
 ...
 <div><p class="lbl">AI search</p><ul><li><a href="{{ url('/ai-search-optimisation') }}">AI search optimisation</a></li><li><a href="{{ url('/answer-engine-optimisation') }}">Answer engine optimisation</a></li></ul></div>
