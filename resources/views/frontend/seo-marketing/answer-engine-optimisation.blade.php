...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li aria-current="page"><b class="kw2">Answer engine optimisation</b></li></ol></nav>
 <p class="eyebrow">AI search</p>
 <h1 style="margin-top:var(--sp-4)">Structuring content so the answer is unmistakably yours</h1>
 <p class="lead">Question-led architecture, FAQ and How-To <span class="kw kw--tech"><b class="kw2">structured data</b></span>, and factual precision so answer engines can extract your content with confidence.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>Question-led</b><span>Architecture, not afterthought</span></div><div class="lp-fact"><b>Marked up</b><span>FAQPage, HowTo, Product</span></div><div class="lp-fact"><b>Precise</b><span>Extractable claims</span></div></div>
</section>
...
<section class="band shell">
 <div class="article">
 <div class="article__body"><h2>Answer the question in the first sentence</h2><p>Extraction favours content that commits to an answer immediately, then explains. Building up to a conclusion works for essays and fails here.</p><h2><span class="kw kw--tech">Structured data</span> is the machine-readable layer</h2><p>FAQPage, HowTo, Product and Organization markup tell an engine what your content is rather than making it guess.</p></div>
 <aside class="aside">
...
<section class="band band--ink">
 ...
 <div><p class="lbl">AI search</p><ul><li><a href="{{ url('/ai-search-optimisation') }}">AI search optimisation</a></li><li><a href="{{ url('/ai-assistant-visibility') }}">AI assistant visibility</a></li></ul></div>
