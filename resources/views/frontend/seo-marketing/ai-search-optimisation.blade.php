...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'AI search optimisation | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'People increasingly ask an assistant instead of scrolling results. That changes what gets cited: clear factual structure, verifiable claims and content an as')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'ai search optimisation, ai search optimisation, Edion Web Technologies')

@section('main-container')
<main id="main"><a id="top"></a>

<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li aria-current="page"><b class="kw3">AI search optimisation</b></li></ol></nav>
 <p class="eyebrow">AI search</p>
 <h1 style="margin-top:var(--sp-4)">Being found when the answer comes from an assistant</h1>
 <p class="lead">People increasingly ask an assistant instead of scrolling results. That changes what gets cited: clear factual structure, verifiable claims and content an assistant can quote confidently.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>Structured</b><span>Schema and clear answers</span></div><div class="lp-fact"><b>Specific</b><span>Figures, not adjectives</span></div><div class="lp-fact"><b>Honest metrics</b><span>Young tooling, stated plainly</span></div></div>
</section>

<section class="band band--tight shell">
 <figure class="figure figure--bleed" data-reveal>
 <img src="{{ asset('assets/frontend/img/art/coverage.svg') }}" alt="" width="800" height="560" loading="lazy" decoding="async">
 </figure>
</section>

<section class="band shell">
 <div class="article">
 <div class="article__body"><h2>What assistants seem to favour</h2><p>Directly answered questions, specific figures, clear attribution and <span class="kw kw--tech"><b class="kw2">structured data</b></span>. Marketing language that avoids committing to anything gets skipped.</p><h2>Measurement is still immature</h2><p>Anyone selling guaranteed AI citation volume is overselling. We track referral traffic from assistant surfaces and monitor citation appearance, and we are honest that the tooling here is young.</p></div>
 <aside class="aside">
...
<section class="band band--ink">
 <div class="shell">
 <div class="sec-head" data-reveal>
 <div><p class="eyebrow">Related</p><h2>Other ai search work</h2></div>
 </div>
 <div class="linkmatrix" data-reveal>
 <div><p class="lbl">AI search</p><ul><li><a href="{{ url('/answer-engine-optimisation') }}">Answer engine optimisation</a></li><li><a href="{{ url('/ai-assistant-visibility') }}">AI assistant visibility</a></li></ul></div>
