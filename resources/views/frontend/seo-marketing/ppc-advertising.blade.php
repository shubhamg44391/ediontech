...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'PPC advertising | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Google Ads, Shopping, Display, YouTube and Performance Max, with conversion tracking that reflects actual revenue rather than form fills.')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'ppc advertising, ppc advertising, Edion Web Technologies')

@section('main-container')
<main id="main"><a id="top"></a>

<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li aria-current="page"><b class="kw">PPC advertising</b></li></ol></nav>
 <p class="eyebrow">Marketing</p>
 <h1 style="margin-top:var(--sp-4)">Paid search managed against profit, not clicks</h1>
 <p class="lead"><span class="kw kw--pri"><b class="kw2">Google Ads</b></span>, Shopping, Display, YouTube and Performance Max, with conversion tracking that reflects actual revenue rather than form fills.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>Tracking-first</b><span>Fixed before spend</span></div><div class="lp-fact"><b>Weekly review</b><span>Search terms and negatives</span></div><div class="lp-fact"><b>Profit-measured</b><span>Not click volume</span></div></div>
</section>
...
<section class="band shell">
 <div class="article">
 <div class="article__body"><h2>Tracking before spending</h2><p>If conversion tracking is wrong, every optimisation decision after it is wrong too. We fix measurement before we touch bids.</p><h2>Search terms, weekly</h2><p>The search terms report is where budget quietly leaks. It gets reviewed weekly, and the negatives list grows every week.</p></div>
 <aside class="aside">
...
<section class="band band--ink">
 <div class="shell">
 <div class="sec-head" data-reveal>
 <div><p class="eyebrow">Related</p><h2>Other marketing work</h2></div>
 </div>
 <div class="linkmatrix" data-reveal>
 <div><p class="lbl">Marketing</p><ul><li><a href="{{ url('/social-media-marketing') }}">Social media marketing</a></li><li><a href="{{ url('/content-marketing') }}">Content marketing</a></li><li><a href="{{ url('/email-marketing') }}">Email marketing</a></li></ul></div>
 <div><p class="lbl">By market</p><ul><li><a href="{{ url('/ppc-advertising-dubai') }}">PPC advertising in Dubai</a></li><li><a href="{{ url('/ppc-advertising-abu-dhabi') }}">PPC advertising in Abu Dhabi</a></li><li><a href="{{ url('/ppc-advertising-sharjah') }}">PPC advertising in Sharjah</a></li><li><a href="{{ url('/ppc-advertising-amman') }}">PPC advertising in Amman</a></li><li><a href="{{ url('/ppc-advertising-manama') }}">PPC advertising in Manama</a></li><li><a href="{{ url('/ppc-advertising-riyadh') }}">PPC advertising in Riyadh</a></li></ul></div>
