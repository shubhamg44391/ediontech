...
@section('title', 'Email marketing | Edion Web Technologies')
@section('description', 'Lifecycle flows, segmentation and deliverability work for businesses with a list worth looking after.')
@section('keywords', 'email marketing, email marketing, Edion Web Technologies')
