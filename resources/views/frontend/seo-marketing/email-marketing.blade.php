...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Email marketing | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Lifecycle flows, segmentation and deliverability work for businesses with a list worth looking after.')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'email marketing, email marketing, Edion Web Technologies')

@section('main-container')
<main id="main"><a id="top"></a>

<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li aria-current="page">Email marketing</li></ol></nav>
 <p class="eyebrow">Marketing</p>
 <h1 style="margin-top:var(--sp-4)">Email that people open because it is useful</h1>
 <p class="lead">Lifecycle flows, segmentation and deliverability work for businesses with a list worth looking after.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>Authenticated</b><span>SPF, DKIM, DMARC</span></div><div class="lp-fact"><b>Flow-led</b><span>Continuous over one-off</span></div><div class="lp-fact"><b>Segmented</b><span>Relevance over reach</span></div></div>
</section>
...
<section class="band shell">
 <div class="article">
 <div class="article__body"><h2>Deliverability first</h2><p>Authentication records, list hygiene and sending reputation. The best campaign in the world does nothing from a spam folder.</p><h2>Flows before campaigns</h2><p>Welcome, abandonment and re-engagement sequences run continuously and usually outperform one-off sends by a wide margin.</p></div>
 <aside class="aside">
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Marketing</p><ul><li><a href="{{ url('/ppc-advertising') }}">PPC advertising</a></li><li><a href="{{ url('/social-media-marketing') }}">Social media marketing</a></li><li><a href="{{ url('/content-marketing') }}">Content marketing</a></li></ul></div>
