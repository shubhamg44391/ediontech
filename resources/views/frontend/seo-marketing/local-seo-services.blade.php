...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Local SEO services | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Google Business Profile optimisation, citation consistency, review management and location-based content for businesses competing in a specific place.')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'local seo services, local seo services, Edion Web Technologies')

@section('main-container')
<main id="main"><a id="top"></a>

<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li aria-current="page"><b class="kw">Local <b class="kw">SEO services</b></b></li></ol></nav>
 <p class="eyebrow">SEO</p>
 <h1 style="margin-top:var(--sp-4)">Local SEO for businesses that need the phone to ring</h1>
 <p class="lead"><span class="kw kw--pri"><b class="kw2">Google Business Profile</b></span> optimisation, citation consistency, review management and location-based content for businesses competing in a specific place.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>NAP audit</b><span>Across every listing</span></div><div class="lp-fact"><b>GBP managed</b><span>Posts, Q&A, categories</span></div><div class="lp-fact"><b>Review flow</b><span>Steady, not bursty</span></div></div>
</section>
...
<section class="band shell">
 <div class="article">
 <div class="article__body"><h2>NAP consistency is the boring win</h2><p>Name, address and phone identical across your site, your Business Profile and every directory. Inconsistency actively suppresses local rankings, and fixing it costs nothing but attention.</p><h2>Reviews are a ranking factor and a conversion factor</h2><p>We set up the request flow so reviews arrive steadily rather than in suspicious bursts, and we help you respond to the bad ones properly.</p></div>
 <aside class="aside">
