...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Social media marketing | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Organic and paid across Meta, LinkedIn, X and TikTok, with the reporting tied to enquiries rather than impressions.')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'social media marketing, social media marketing, Edion Web Technologies')

@section('main-container')
<main id="main"><a id="top"></a>

<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li aria-current="page"><b class="kw">Social media marketing</b></li></ol></nav>
 <p class="eyebrow">Marketing</p>
 <h1 style="margin-top:var(--sp-4)">Social that supports the business, not the vanity metrics</h1>
 <p class="lead">Organic and paid across Meta, LinkedIn, X and TikTok, with the reporting tied to enquiries rather than impressions.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>2 channels</b><span>Done properly beats six</span></div><div class="lp-fact"><b>Enquiry-tied</b><span>Not impression counts</span></div><div class="lp-fact"><b>Tested first</b><span>Organic informs paid</span></div></div>
</section>
...
<section class="band shell">
 <div class="article">
 <div class="article__body"><h2>Fewer platforms, done properly</h2><p>Most businesses are better served by two channels executed well than six maintained badly. We will tell you which two.</p><h2>Paid and organic together</h2><p>Organic tells you what resonates before you pay to amplify it. Running them separately wastes both budgets.</p></div>
 <aside class="aside">
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Marketing</p><ul><li><a href="{{ url('/ppc-advertising') }}">PPC advertising</a></li><li><a href="{{ url('/content-marketing') }}">Content marketing</a></li><li><a href="{{ url('/email-marketing') }}">Email marketing</a></li></ul></div>
