...
@section('title', 'Website development in Toronto, Canada | Edion Web Technologies')
@section('description', 'Website development for businesses in Toronto, Canada. Marketing sites through to complex web applications, built to stay maintainable after we hand them over.')
@section('keywords', 'website development toronto, website development canada, website development toronto, website development company toronto, best website development toronto')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Website development</b> in Toronto</li></ol></nav>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">North America</p><ul><li><a href="{{ url('/website-development-new-york') }}">New York</a></li></ul></div>
