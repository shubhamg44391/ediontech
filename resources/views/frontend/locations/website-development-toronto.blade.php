...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Website development in Toronto, Canada | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Website development for businesses in Toronto, Canada. Marketing sites through to complex web applications, built to stay maintainable after we hand them over.')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'website development toronto, website development canada, website development toronto, website development company toronto, best website development toronto')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'locations']) }}">Locations</a></li><li aria-current="page"><b class="kw">Website development</b> in Toronto</li></ol></nav>
 <p class="eyebrow">Build &middot; Canada</p>
 <h1 style="margin-top:var(--sp-4)">Website development in Toronto</h1>
 <p class="lead">Marketing sites through to complex web applications, built to stay maintainable after we hand them over. Clean markup, sensible dependencies, and code your next developer can read. We work with businesses in <span class="kw kw--loc">Toronto</span> and across Canada.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>4-6 wks</b><span>Typical marketing site</span></div><div class="lp-fact"><b>Core Web Vitals</b><span>Budgeted, not hoped for</span></div><div class="lp-fact"><b>You own it</b><span>Repository and design files</span></div><div class="lp-fact"><b>CAD</b><span>Quoting currency</span></div><div class="lp-fact"><b>ET</b><span>Hours overlap</span></div></div>
</section>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">North America</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'website-development-new-york']) }}">New York</a></li></ul></div>
 <div><p class="lbl">Other services in Toronto</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-software-development-toronto']) }}">Car rental software development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'fleet-management-software-toronto']) }}">Fleet management software</a></li><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-booking-engine-toronto']) }}">Car rental booking engine</a></li><li><a href="{{ route('industry.detail', ['slug'=>'vehicle-rental-app-development-toronto']) }}">Vehicle rental app development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'chauffeur-limousine-booking-software-toronto']) }}">Chauffeur and limousine booking software</a></li><li><a href="{{ route('industry.detail', ['slug'=>'custom-software-development-toronto']) }}">Custom software development</a></li></ul></div>
