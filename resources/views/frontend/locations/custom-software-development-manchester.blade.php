...
@section('title', 'Custom software development in Manchester, United Kingdom | Edion Web Technologies')
@section('description', 'Custom software development for businesses in Manchester, United Kingdom. Bookings, inventory, dispatch, billing and internal tools. The systems that are specific enough to your o')
@section('keywords', 'custom software development manchester, custom software development united kingdom, custom software development manchester, custom software development company manchester, best custom software development manchester')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Custom software development</b> in Manchester</li></ol></nav>
