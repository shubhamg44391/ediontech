...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Software & Web Development in Abu Dhabi, United Arab Emirates | Edion')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Software, web, mobile and SEO services for businesses in Abu Dhabi, United Arab Emirates. Car rental and fleet platforms a speciality.')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'software development abu dhabi, web development abu dhabi, seo services abu dhabi, app development abu dhabi')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'locations']) }}">Locations</a></li><li aria-current="page">Abu Dhabi</li></ol></nav>
...
<section class="band shell">
 ...
 <div><p class="lbl">All services in Abu Dhabi</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-software-development-abu-dhabi']) }}">Car rental software development in Abu Dhabi</a></li><li><a href="{{ route('industry.detail', ['slug'=>'fleet-management-software-abu-dhabi']) }}">Fleet management software in Abu Dhabi</a></li><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-booking-engine-abu-dhabi']) }}">Car rental booking engine in Abu Dhabi</a></li><li><a href="{{ route('industry.detail', ['slug'=>'vehicle-rental-app-development-abu-dhabi']) }}">Vehicle rental app development in Abu Dhabi</a></li><li><a href="{{ route('industry.detail', ['slug'=>'chauffeur-limousine-booking-software-abu-dhabi']) }}">Chauffeur and limousine booking software in Abu Dhabi</a></li><li><a href="{{ route('industry.detail', ['slug'=>'website-development-abu-dhabi']) }}">Website development in Abu Dhabi</a></li><li><a href="{{ route('industry.detail', ['slug'=>'custom-software-development-abu-dhabi']) }}">Custom software development in Abu Dhabi</a></li><li><a href="{{ route('industry.detail', ['slug'=>'mobile-app-development-abu-dhabi']) }}">Mobile app development in Abu Dhabi</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ecommerce-development-abu-dhabi']) }}">E-commerce development in Abu Dhabi</a></li><li><a href="{{ route('industry.detail', ['slug'=>'seo-services-abu-dhabi']) }}">SEO services in Abu Dhabi</a></li><li><a href="{{ route('industry.detail', ['slug'=>'local-seo-services-abu-dhabi']) }}">Local SEO services in Abu Dhabi</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ppc-advertising-abu-dhabi']) }}">PPC advertising in Abu Dhabi</a></li></ul></div>
 <div><p class="lbl">Other Gulf markets</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'software-development-dubai']) }}">Dubai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-development-sharjah']) }}">Sharjah</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-development-manama']) }}">Manama</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-development-riyadh']) }}">Riyadh</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-development-jeddah']) }}">Jeddah</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-development-doha']) }}">Doha</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-development-kuwait-city']) }}">Kuwait City</a></li></ul></div>
