...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Website development in Lucknow, India | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Website development for businesses in Lucknow, India. Marketing sites through to complex web applications, built to stay maintainable after we hand them over.')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'website development lucknow, website development india, website development lucknow, website development company lucknow, best website development lucknow')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'locations']) }}">Locations</a></li><li aria-current="page"><b class="kw">Website development</b> in Lucknow</li></ol></nav>
 <p class="eyebrow">Build &middot; India</p>
 <h1 style="margin-top:var(--sp-4)">Website development in Lucknow</h1>
 <p class="lead">Marketing sites through to complex web applications, built to stay maintainable after we hand them over. Clean markup, sensible dependencies, and code your next developer can read. We work with businesses in <span class="kw kw--loc">Lucknow</span> and across <span class="kw kw--loc">India</span>.</p>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">India</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'website-development-delhi']) }}">Delhi</a></li><li><a href="{{ route('industry.detail', ['slug'=>'website-development-mumbai']) }}">Mumbai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'website-development-bangalore']) }}">Bangalore</a></li></ul></div>
 <div><p class="lbl">Other services in Lucknow</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-software-development-lucknow']) }}">Car rental software development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'fleet-management-software-lucknow']) }}">Fleet management software</a></li><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-booking-engine-lucknow']) }}">Car rental booking engine</a></li><li><a href="{{ route('industry.detail', ['slug'=>'vehicle-rental-app-development-lucknow']) }}">Vehicle rental app development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'chauffeur-limousine-booking-software-lucknow']) }}">Chauffeur and limousine booking software</a></li><li><a href="{{ route('industry.detail', ['slug'=>'custom-software-development-lucknow']) }}">Custom software development</a></li></ul></div>
