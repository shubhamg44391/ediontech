...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'PPC advertising in Doha, Qatar | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'PPC advertising for businesses in Doha, Qatar. Google Ads, Shopping, Display, YouTube and Performance Max, with conversion tracking that reflects actual')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'ppc advertising doha, ppc advertising qatar, ppc advertising doha, ppc advertising company doha, best ppc advertising doha')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'locations']) }}">Locations</a></li><li aria-current="page"><b class="kw">PPC advertising</b> in Doha</li></ol></nav>
 <p class="eyebrow">Marketing &middot; Qatar</p>
 <h1 style="margin-top:var(--sp-4)">PPC advertising in Doha</h1>
 <p class="lead"><span class="kw kw--pri"><b class="kw2">Google Ads</b></span>, Shopping, Display, YouTube and Performance Max, with conversion tracking that reflects actual revenue rather than form fills. We work with businesses in <span class="kw kw--loc">Doha</span> and across <span class="kw kw--loc">Qatar</span>.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>Tracking-first</b><span>Fixed before spend</span></div><div class="lp-fact"><b>Weekly review</b><span>Search terms and negatives</span></div><div class="lp-fact"><b>Profit-measured</b><span>Not click volume</span></div><div class="lp-fact"><b>QAR</b><span>Quoting currency</span></div><div class="lp-fact"><b>AST</b><span>Hours overlap</span></div></div>
</section>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Gulf</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'ppc-advertising-dubai']) }}">Dubai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ppc-advertising-abu-dhabi']) }}">Abu Dhabi</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ppc-advertising-sharjah']) }}">Sharjah</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ppc-advertising-manama']) }}">Manama</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ppc-advertising-riyadh']) }}">Riyadh</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ppc-advertising-jeddah']) }}">Jeddah</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ppc-advertising-kuwait-city']) }}">Kuwait City</a></li></ul></div>
