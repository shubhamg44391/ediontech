...
@section('title', 'PPC advertising in Doha, Qatar | Edion Web Technologies')
@section('description', 'PPC advertising for businesses in Doha, Qatar. Google Ads, Shopping, Display, YouTube and Performance Max, with conversion tracking that reflects actual')
@section('keywords', 'ppc advertising doha, ppc advertising qatar, ppc advertising doha, ppc advertising company doha, best ppc advertising doha')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">PPC advertising</b> in Doha</li></ol></nav>
