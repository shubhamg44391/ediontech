...
@section('title', 'E-commerce development in Doha, Qatar | Edion Web Technologies')
@section('description', 'E-commerce development for businesses in Doha, Qatar. Catalogues, checkout, order management and the integrations that keep stock accurate. Built on platforms')
@section('keywords', 'e-commerce development doha, e-commerce development qatar, ecommerce development doha, e-commerce development company doha, best e-commerce development doha')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">E-commerce development</b> in Doha</li></ol></nav>
