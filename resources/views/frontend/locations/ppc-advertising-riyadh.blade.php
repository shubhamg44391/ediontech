...
@section('title', 'PPC advertising in Riyadh, Saudi Arabia | Edion Web Technologies')
@section('description', 'PPC advertising for businesses in Riyadh, Saudi Arabia. Google Ads, Shopping, Display, YouTube and Performance Max, with conversion tracking that reflects actual')
@section('keywords', 'ppc advertising riyadh, ppc advertising saudi arabia, ppc advertising riyadh, ppc advertising company riyadh, best ppc advertising riyadh')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">PPC advertising</b> in Riyadh</li></ol></nav>
