...
@section('title', 'Local SEO services in Dubai, United Arab Emirates | Edion Web Technologies')
@section('description', 'Local SEO services for businesses in Dubai, United Arab Emirates. Google Business Profile optimisation, citation consistency, review management and location-based content')
@section('keywords', 'local seo services dubai, local seo services united arab emirates, local seo services dubai, local seo services company dubai, best local seo services dubai')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Local <b class="kw">SEO services</b></b> in Dubai</li></ol></nav>
