...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Mobile app development in London, United Kingdom | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Mobile app development for businesses in London, United Kingdom. Native iOS and Android, or Flutter where cross-platform genuinely fits. We choose based on what your team')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'mobile app development london, mobile app development united kingdom, mobile app development london, mobile app development company london, best mobile app development london')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'locations']) }}">Locations</a></li><li aria-current="page"><b class="kw">Mobile app development</b> in London</li></ol></nav>
 <p class="eyebrow">Build &middot; United Kingdom</p>
 <h1 style="margin-top:var(--sp-4)">Mobile app development in London</h1>
 <p class="lead">Native iOS and Android, or <span class="kw kw--tech">Flutter</span> where cross-platform genuinely fits. We choose based on what your team can hire for and maintain, not on what is fashionable this year. We work with businesses in <span class="kw kw--loc">London</span> and across <span class="kw kw--loc">United Kingdom</span>.</p>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Europe</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'mobile-app-development-manchester']) }}">Manchester</a></li></ul></div>
