...
@section('title', 'Website development in Manchester, United Kingdom | Edion Web Technologies')
@section('description', 'Website development for businesses in Manchester, United Kingdom. Marketing sites through to complex web applications, built to stay maintainable after we hand them over.')
@section('keywords', 'website development manchester, website development united kingdom, website development manchester, website development company manchester, best website development manchester')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Website development</b> in Manchester</li></ol></nav>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Europe</p><ul><li><a href="{{ url('/website-development-london') }}">London</a></li></ul></div>
