...
@section('title', 'PPC advertising in Manchester, United Kingdom | Edion Web Technologies')
@section('description', 'PPC advertising for businesses in Manchester, United Kingdom. Google Ads, Shopping, Display, YouTube and Performance Max, with conversion tracking that reflects actual')
@section('keywords', 'ppc advertising manchester, ppc advertising united kingdom, ppc advertising manchester, ppc advertising company manchester, best ppc advertising manchester')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">PPC advertising</b> in Manchester</li></ol></nav>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Europe</p><ul><li><a href="{{ url('/ppc-advertising-london') }}">London</a></li></ul></div>
