...
@section('title', 'Mobile app development in Jeddah, Saudi Arabia | Edion Web Technologies')
@section('description', 'Mobile app development for businesses in Jeddah, Saudi Arabia. Native iOS and Android, or Flutter where cross-platform genuinely fits. We choose based on what your team')
@section('keywords', 'mobile app development jeddah, mobile app development saudi arabia, mobile app development jeddah, mobile app development company jeddah, best mobile app development jeddah')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Mobile app development</b> in Jeddah</li></ol></nav>
 <p class="eyebrow">Build &middot; Saudi Arabia</p>
 <h1 style="margin-top:var(--sp-4)">Mobile app development in Jeddah</h1>
 <p class="lead">Native iOS and Android, or <span class="kw kw--tech">Flutter</span> where cross-platform genuinely fits. We choose based on what your team can hire for and maintain, not on what is fashionable this year. We work with businesses in <span class="kw kw--loc">Jeddah</span> and across <span class="kw kw--loc">Saudi Arabia</span>.</p>
