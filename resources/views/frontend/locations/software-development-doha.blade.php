...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>QAR</b><span>Quoting currency available</span></div><div class="lp-fact"><b>AST</b><span>Working-hours overlap</span></div><div class="lp-fact"><b>Arabic</b><span>Interface language supported</span></div></div>
</section>
...
<section class="band shell">
 <div class="article">
 <div class="article__body"><h2>The <span class="kw kw--loc">Doha</span> market</h2><p><span class="kw kw--loc">Qatar</span>'s market is corporate-heavy with significant event-driven demand spikes, favouring systems that handle bulk corporate allocations cleanly.</p><h2>What changes when you build for Qatar</h2><p>Block allocation and corporate rate cards tend to outrank consumer booking polish.</p><h2>How we work with clients here</h2><p>Weekly written updates, a staging URL open at all times, and hours that overlap AST (UTC+<span class="kw kw--num">3</span>). You <b class="kw3">own the code</b> and design files on final payment, and we document the handover for whoever maintains it next.</p></div>
 <aside class="aside">
