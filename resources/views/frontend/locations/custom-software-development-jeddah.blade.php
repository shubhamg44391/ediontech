...
@section('title', 'Custom software development in Jeddah, Saudi Arabia | Edion Web Technologies')
@section('description', 'Custom software development for businesses in Jeddah, Saudi Arabia. Bookings, inventory, dispatch, billing and internal tools. The systems that are specific enough to your o')
@section('keywords', 'custom software development jeddah, custom software development saudi arabia, custom software development jeddah, custom software development company jeddah, best custom software development jeddah')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Custom software development</b> in Jeddah</li></ol></nav>
