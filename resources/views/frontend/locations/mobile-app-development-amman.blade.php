...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Mobile app development in Amman, Jordan | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Mobile app development for businesses in Amman, Jordan. Native iOS and Android, or Flutter where cross-platform genuinely fits. We choose based on what your team')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'mobile app development amman, mobile app development jordan, mobile app development amman, mobile app development company amman, best mobile app development amman')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'locations']) }}">Locations</a></li><li aria-current="page"><b class="kw">Mobile app development</b> in Amman</li></ol></nav>
 <p class="eyebrow">Build &middot; Jordan</p>
 <h1 style="margin-top:var(--sp-4)">Mobile app development in Amman</h1>
 <p class="lead">Native iOS and Android, or <span class="kw kw--tech">Flutter</span> where cross-platform genuinely fits. We choose based on what your team can hire for and maintain, not on what is fashionable this year. We work with businesses in <span class="kw kw--loc">Amman</span> and across <span class="kw kw--loc">Jordan</span>.</p>
