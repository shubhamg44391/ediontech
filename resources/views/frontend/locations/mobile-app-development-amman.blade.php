...
@section('title', 'Mobile app development in Amman, Jordan | Edion Web Technologies')
@section('description', 'Mobile app development for businesses in Amman, Jordan. Native iOS and Android, or Flutter where cross-platform genuinely fits. We choose based on what your team')
@section('keywords', 'mobile app development amman, mobile app development jordan, mobile app development amman, mobile app development company amman, best mobile app development amman')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Mobile app development</b> in Amman</li></ol></nav>
