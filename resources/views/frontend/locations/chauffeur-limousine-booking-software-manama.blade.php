...
@section('title', 'Chauffeur and limousine booking software in Manama, Bahrain | Edion Web Technologies')
@section('description', 'Chauffeur and limousine booking software for businesses in Manama, Bahrain. If you dispatch drivers as well as rent vehicles, that is genuinely a different product: driver rostering')
@section('keywords', 'chauffeur and limousine booking software manama, chauffeur and limousine booking software bahrain, chauffeur limousine booking software manama, chauffeur and limousine booking software company manama, best chauffeur and limousine booking software manama')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw2">Chauffeur and limousine</b> booking software in Manama</li></ol></nav>
