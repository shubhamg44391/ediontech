...
@section('title', 'Custom software development in Riyadh, Saudi Arabia | Edion Web Technologies')
@section('description', 'Custom software development for businesses in Riyadh, Saudi Arabia. Bookings, inventory, dispatch, billing and internal tools. The systems that are specific enough to your o')
@section('keywords', 'custom software development riyadh, custom software development saudi arabia, custom software development riyadh, custom software development company riyadh, best custom software development riyadh')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Custom software development</b> in Riyadh</li></ol></nav>
