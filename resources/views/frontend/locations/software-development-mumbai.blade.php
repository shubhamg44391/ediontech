...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Software & Web Development in Mumbai, India | Edion')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Software, web, mobile and SEO services for businesses in Mumbai, India. Car rental and fleet platforms a speciality.')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'software development mumbai, web development mumbai, seo services mumbai, app development mumbai')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'locations']) }}">Locations</a></li><li aria-current="page">Mumbai</li></ol></nav>
 <div class="cityhero">
 <div>
...
<section class="band shell">
 ...
 <div><p class="lbl">All services in Mumbai</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-software-development-mumbai']) }}">Car rental software development in Mumbai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'fleet-management-software-mumbai']) }}">Fleet management software in Mumbai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-booking-engine-mumbai']) }}">Car rental booking engine in Mumbai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'vehicle-rental-app-development-mumbai']) }}">Vehicle rental app development in Mumbai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'chauffeur-limousine-booking-software-mumbai']) }}">Chauffeur and limousine booking software in Mumbai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'website-development-mumbai']) }}">Website development in Mumbai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'custom-software-development-mumbai']) }}">Custom software development in Mumbai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'mobile-app-development-mumbai']) }}">Mobile app development in Mumbai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ecommerce-development-mumbai']) }}">E-commerce development in Mumbai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'seo-services-mumbai']) }}">SEO services in Mumbai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'local-seo-services-mumbai']) }}">Local SEO services in Mumbai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ppc-advertising-mumbai']) }}">PPC advertising in Mumbai</a></li></ul></div>
 <div><p class="lbl">Other India markets</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'software-development-lucknow']) }}">Lucknow</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-development-delhi']) }}">Delhi</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-development-bangalore']) }}">Bangalore</a></li></ul></div>
