...
@section('title', 'Custom software development in Bangalore, India | Edion Web Technologies')
@section('description', 'Custom software development for businesses in Bangalore, India. Bookings, inventory, dispatch, billing and internal tools. The systems that are specific enough to your o')
@section('keywords', 'custom software development bangalore, custom software development india, custom software development bangalore, custom software development company bangalore, best custom software development bangalore')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Custom software development</b> in Bangalore</li></ol></nav>
