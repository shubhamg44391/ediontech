...
@section('title', 'Chauffeur and limousine booking software in Doha, Qatar | Edion Web Technologies')
@section('description', 'Chauffeur and limousine booking software for businesses in Doha, Qatar. If you dispatch drivers as well as rent vehicles, that is genuinely a different product: driver rostering')
@section('keywords', 'chauffeur and limousine booking software doha, chauffeur and limousine booking software qatar, chauffeur limousine booking software doha, chauffeur and limousine booking software company doha, best chauffeur and limousine booking software doha')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw2">Chauffeur and limousine</b> booking software in Doha</li></ol></nav>
