...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Chauffeur and limousine booking software in Doha, Qatar | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Chauffeur and limousine booking software for businesses in Doha, Qatar. If you dispatch drivers as well as rent vehicles, that is genuinely a different product: driver rostering')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'chauffeur and limousine booking software doha, chauffeur and limousine booking software qatar, chauffeur limousine booking software doha, chauffeur and limousine booking software company doha, best chauffeur and limousine booking software doha')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'locations']) }}">Locations</a></li><li aria-current="page"><b class="kw2">Chauffeur and limousine</b> booking software in Doha</li></ol></nav>
 <p class="eyebrow">Chauffeur &middot; Qatar</p>
 <h1 style="margin-top:var(--sp-4)">Chauffeur and limousine booking software in Doha</h1>
 <p class="lead">If you dispatch drivers as well as rent vehicles, that is genuinely a different product: driver rostering, live dispatch, route-based trip pricing and driver settlements. It shares your <b class="kw2">fleet register</b> and nothing else. We work with businesses in <span class="kw kw--loc">Doha</span> and across <span class="kw kw--loc">Qatar</span>.</p>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Gulf</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'chauffeur-limousine-booking-software-dubai']) }}">Dubai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'chauffeur-limousine-booking-software-abu-dhabi']) }}">Abu Dhabi</a></li><li><a href="{{ route('industry.detail', ['slug'=>'chauffeur-limousine-booking-software-sharjah']) }}">Sharjah</a></li><li><a href="{{ route('industry.detail', ['slug'=>'chauffeur-limousine-booking-software-manama']) }}">Manama</a></li><li><a href="{{ route('industry.detail', ['slug'=>'chauffeur-limousine-booking-software-riyadh']) }}">Riyadh</a></li><li><a href="{{ route('industry.detail', ['slug'=>'chauffeur-limousine-booking-software-jeddah']) }}">Jeddah</a></li><li><a href="{{ route('industry.detail', ['slug'=>'chauffeur-limousine-booking-software-kuwait-city']) }}">Kuwait City</a></li></ul></div>
 <div><p class="lbl">Other services in Doha</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-software-development-doha']) }}">Car rental software development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'fleet-management-software-doha']) }}">Fleet management software</a></li><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-booking-engine-doha']) }}">Car rental booking engine</a></li><li><a href="{{ route('industry.detail', ['slug'=>'vehicle-rental-app-development-doha']) }}">Vehicle rental app development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'website-development-doha']) }}">Website development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'custom-software-development-doha']) }}">Custom software development</a></li></ul></div>
