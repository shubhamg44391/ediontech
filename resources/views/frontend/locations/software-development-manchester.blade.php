...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Software & Web Development in Manchester, United Kingdom | Edion')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Software, web, mobile and SEO services for businesses in Manchester, United Kingdom. Car rental and fleet platforms a speciality.')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'software development manchester, web development manchester, seo services manchester, app development manchester')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'locations']) }}">Locations</a></li><li aria-current="page">Manchester</li></ol></nav>
...
<section class="band shell">
 ...
 <div><p class="lbl">All services in Manchester</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-software-development-manchester']) }}">Car rental software development in Manchester</a></li><li><a href="{{ route('industry.detail', ['slug'=>'fleet-management-software-manchester']) }}">Fleet management software in Manchester</a></li><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-booking-engine-manchester']) }}">Car rental booking engine in Manchester</a></li><li><a href="{{ route('industry.detail', ['slug'=>'vehicle-rental-app-development-manchester']) }}">Vehicle rental app development in Manchester</a></li><li><a href="{{ route('industry.detail', ['slug'=>'chauffeur-limousine-booking-software-manchester']) }}">Chauffeur and limousine booking software in Manchester</a></li><li><a href="{{ route('industry.detail', ['slug'=>'website-development-manchester']) }}">Website development in Manchester</a></li><li><a href="{{ route('industry.detail', ['slug'=>'custom-software-development-manchester']) }}">Custom software development in Manchester</a></li><li><a href="{{ route('industry.detail', ['slug'=>'mobile-app-development-manchester']) }}">Mobile app development in Manchester</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ecommerce-development-manchester']) }}">E-commerce development in Manchester</a></li><li><a href="{{ route('industry.detail', ['slug'=>'seo-services-manchester']) }}">SEO services in Manchester</a></li><li><a href="{{ route('industry.detail', ['slug'=>'local-seo-services-manchester']) }}">Local SEO services in Manchester</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ppc-advertising-manchester']) }}">PPC advertising in Manchester</a></li></ul></div>
 <div><p class="lbl">Other Europe markets</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'software-development-london']) }}">London</a></li></ul></div>
