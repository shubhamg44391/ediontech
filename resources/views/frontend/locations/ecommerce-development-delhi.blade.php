...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'E-commerce development in Delhi, India | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'E-commerce development for businesses in Delhi, India. Catalogues, checkout, order management and the integrations that keep stock accurate. Built on platforms')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'e-commerce development delhi, e-commerce development india, ecommerce development delhi, e-commerce development company delhi, best e-commerce development delhi')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'locations']) }}">Locations</a></li><li aria-current="page"><b class="kw">E-commerce development</b> in Delhi</li></ol></nav>
 <p class="eyebrow">Build &middot; India</p>
 <h1 style="margin-top:var(--sp-4)">E-commerce development in Delhi</h1>
 <p class="lead">Catalogues, checkout, order management and the integrations that keep stock accurate. Built on platforms you can staff, or custom where your model needs it. We work with businesses in Delhi and across <span class="kw kw--loc">India</span>.</p>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">India</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'ecommerce-development-lucknow']) }}">Lucknow</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ecommerce-development-mumbai']) }}">Mumbai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ecommerce-development-bangalore']) }}">Bangalore</a></li></ul></div>
