...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Local SEO services in Manchester, United Kingdom | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Local SEO services for businesses in Manchester, United Kingdom. Google Business Profile optimisation, citation consistency, review management and location-based content')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'local seo services manchester, local seo services united kingdom, local seo services manchester, local seo services company manchester, best local seo services manchester')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'locations']) }}">Locations</a></li><li aria-current="page"><b class="kw">Local <b class="kw">SEO services</b></b> in Manchester</li></ol></nav>
 <p class="eyebrow">SEO &middot; United Kingdom</p>
 <h1 style="margin-top:var(--sp-4)">Local SEO services in Manchester</h1>
 <p class="lead"><span class="kw kw--pri"><b class="kw2">Google Business Profile</b></span> optimisation, citation consistency, review management and location-based content for businesses competing in a specific place. We work with businesses in <span class="kw kw--loc">Manchester</span> and across <span class="kw kw--loc">United Kingdom</span>.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>NAP audit</b><span>Across every listing</span></div><div class="lp-fact"><b>GBP managed</b><span>Posts, Q&A, categories</span></div><div class="lp-fact"><b>Review flow</b><span>Steady, not bursty</span></div><div class="lp-fact"><b>GBP</b><span>Quoting currency</span></div><div class="lp-fact"><b>GMT/BST</b><span>Hours overlap</span></div></div>
</section>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Europe</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'local-seo-services-london']) }}">London</a></li></ul></div>
