...
@section('title', 'Custom software development in Kuwait City, Kuwait | Edion Web Technologies')
@section('description', 'Custom software development for businesses in Kuwait City, Kuwait. Bookings, inventory, dispatch, billing and internal tools. The systems that are specific enough to your o')
@section('keywords', 'custom software development kuwait city, custom software development kuwait, custom software development kuwait city, custom software development company kuwait city, best custom software development kuwait city')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Custom software development</b> in Kuwait City</li></ol></nav>
