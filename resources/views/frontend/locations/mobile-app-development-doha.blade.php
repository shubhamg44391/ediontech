...
@section('title', 'Mobile app development in Doha, Qatar | Edion Web Technologies')
@section('description', 'Mobile app development for businesses in Doha, Qatar. Native iOS and Android, or Flutter where cross-platform genuinely fits. We choose based on what your team')
@section('keywords', 'mobile app development doha, mobile app development qatar, mobile app development doha, mobile app development company doha, best mobile app development doha')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Mobile app development</b> in Doha</li></ol></nav>
