...
@section('title', 'Website development in Dubai, United Arab Emirates | Edion Web Technologies')
@section('description', 'Website development for businesses in Dubai, United Arab Emirates. Marketing sites through to complex web applications, built to stay maintainable after we hand them over.')
@section('keywords', 'website development dubai, website development united arab emirates, website development dubai, website development company dubai, best website development dubai')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Website development</b> in Dubai</li></ol></nav>
