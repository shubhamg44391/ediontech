...
@section('title', 'Custom software development in New York, United States | Edion Web Technologies')
@section('description', 'Custom software development for businesses in New York, United States. Bookings, inventory, dispatch, billing and internal tools. The systems that are specific enough to your o')
@section('keywords', 'custom software development new york, custom software development united states, custom software development new york, custom software development company new york, best custom software development new york')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Custom software development</b> in New York</li></ol></nav>
