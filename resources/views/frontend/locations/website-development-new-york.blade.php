...
@section('title', 'Website development in New York, United States | Edion Web Technologies')
@section('description', 'Website development for businesses in New York, United States. Marketing sites through to complex web applications, built to stay maintainable after we hand them over.')
@section('keywords', 'website development new york, website development united states, website development new york, website development company new york, best website development new york')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Website development</b> in New York</li></ol></nav>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">North America</p><ul><li><a href="{{ url('/website-development-toronto') }}">Toronto</a></li></ul></div>
