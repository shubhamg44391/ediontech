...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Website development in New York, United States | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Website development for businesses in New York, United States. Marketing sites through to complex web applications, built to stay maintainable after we hand them over.')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'website development new york, website development united states, website development new york, website development company new york, best website development new york')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'locations']) }}">Locations</a></li><li aria-current="page"><b class="kw">Website development</b> in New York</li></ol></nav>
 <p class="eyebrow">Build &middot; United States</p>
 <h1 style="margin-top:var(--sp-4)">Website development in New York</h1>
 <p class="lead">Marketing sites through to complex web applications, built to stay maintainable after we hand them over. Clean markup, sensible dependencies, and code your next developer can read. We work with businesses in <span class="kw kw--loc">New York</span> and across United States.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>4-6 wks</b><span>Typical marketing site</span></div><div class="lp-fact"><b>Core Web Vitals</b><span>Budgeted, not hoped for</span></div><div class="lp-fact"><b>You own it</b><span>Repository and design files</span></div><div class="lp-fact"><b>USD</b><span>Quoting currency</span></div><div class="lp-fact"><b>ET</b><span>Hours overlap</span></div></div>
</section>
