...
@section('title', 'Software & Web Development in Delhi, India | Edion')
@section('description', 'Software, web, mobile and SEO services for businesses in Delhi, India. Car rental and fleet platforms a speciality.')
@section('keywords', 'software development delhi, web development delhi, seo services delhi, app development delhi')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page">Delhi</li></ol></nav>
 <div class="cityhero">
 <div>
...
<section class="band shell">
 ...
 <div><p class="lbl">All services in Delhi</p><ul><li><a href="{{ url('/car-rental-software-development-delhi') }}">Car rental software development in Delhi</a></li><li><a href="{{ url('/fleet-management-software-delhi') }}">Fleet management software in Delhi</a></li><li><a href="{{ url('/car-rental-booking-engine-delhi') }}">Car rental booking engine in Delhi</a></li><li><a href="{{ url('/vehicle-rental-app-development-delhi') }}">Vehicle rental app development in Delhi</a></li><li><a href="{{ url('/chauffeur-limousine-booking-software-delhi') }}">Chauffeur and limousine booking software in Delhi</a></li><li><a href="{{ url('/website-development-delhi') }}">Website development in Delhi</a></li><li><a href="{{ url('/custom-software-development-delhi') }}">Custom software development in Delhi</a></li><li><a href="{{ url('/mobile-app-development-delhi') }}">Mobile app development in Delhi</a></li><li><a href="{{ url('/ecommerce-development-delhi') }}">E-commerce development in Delhi</a></li><li><a href="{{ url('/seo-services-delhi') }}">SEO services in Delhi</a></li><li><a href="{{ url('/local-seo-services-delhi') }}">Local SEO services in Delhi</a></li><li><a href="{{ url('/ppc-advertising-delhi') }}">PPC advertising in Delhi</a></li></ul></div>
 <div><p class="lbl">Other India markets</p><ul><li><a href="{{ url('/software-development-lucknow') }}">Lucknow</a></li><li><a href="{{ url('/software-development-mumbai') }}">Mumbai</a></li><li><a href="{{ url('/software-development-bangalore') }}">Bangalore</a></li></ul></div>
