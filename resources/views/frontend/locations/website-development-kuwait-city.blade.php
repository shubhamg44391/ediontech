...
@section('title', 'Website development in Kuwait City, Kuwait | Edion Web Technologies')
@section('description', 'Website development for businesses in Kuwait City, Kuwait. Marketing sites through to complex web applications, built to stay maintainable after we hand them over.')
@section('keywords', 'website development kuwait city, website development kuwait, website development kuwait city, website development company kuwait city, best website development kuwait city')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Website development</b> in Kuwait City</li></ol></nav>
