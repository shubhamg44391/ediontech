...
@section('title', 'Local SEO services in Delhi, India | Edion Web Technologies')
@section('description', 'Local SEO services for businesses in Delhi, India. Google Business Profile optimisation, citation consistency, review management and location-based content')
@section('keywords', 'local seo services delhi, local seo services india, local seo services delhi, local seo services company delhi, best local seo services delhi')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Local <b class="kw">SEO services</b></b> in Delhi</li></ol></nav>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">India</p><ul><li><a href="{{ url('/local-seo-services-lucknow') }}">Lucknow</a></li><li><a href="{{ url('/local-seo-services-mumbai') }}">Mumbai</a></li><li><a href="{{ url('/local-seo-services-bangalore') }}">Bangalore</a></li></ul></div>
