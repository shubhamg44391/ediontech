...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Local SEO services in Delhi, India | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Local SEO services for businesses in Delhi, India. Google Business Profile optimisation, citation consistency, review management and location-based content')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'local seo services delhi, local seo services india, local seo services delhi, local seo services company delhi, best local seo services delhi')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'locations']) }}">Locations</a></li><li aria-current="page"><b class="kw">Local <b class="kw">SEO services</b></b> in Delhi</li></ol></nav>
 <p class="eyebrow">SEO &middot; India</p>
 <h1 style="margin-top:var(--sp-4)">Local SEO services in Delhi</h1>
 <p class="lead"><span class="kw kw--pri"><b class="kw2">Google Business Profile</b></span> optimisation, citation consistency, review management and location-based content for businesses competing in a specific place. We work with businesses in Delhi and across <span class="kw kw--loc">India</span>.</p>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">India</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'local-seo-services-lucknow']) }}">Lucknow</a></li><li><a href="{{ route('industry.detail', ['slug'=>'local-seo-services-mumbai']) }}">Mumbai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'local-seo-services-bangalore']) }}">Bangalore</a></li></ul></div>
