...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'E-commerce development in Abu Dhabi, United Arab Emirates | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'E-commerce development for businesses in Abu Dhabi, United Arab Emirates. Catalogues, checkout, order management and the integrations that keep stock accurate. Built on platforms')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'e-commerce development abu dhabi, e-commerce development united arab emirates, ecommerce development abu dhabi, e-commerce development company abu dhabi, best e-commerce development abu dhabi')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'locations']) }}">Locations</a></li><li aria-current="page"><b class="kw">E-commerce development</b> in Abu Dhabi</li></ol></nav>
 <p class="eyebrow">Build &middot; United Arab Emirates</p>
 <h1 style="margin-top:var(--sp-4)">E-commerce development in Abu Dhabi</h1>
 <p class="lead">Catalogues, checkout, order management and the integrations that keep stock accurate. Built on platforms you can staff, or custom where your model needs it. We work with businesses in <span class="kw kw--loc">Abu Dhabi</span> and across <span class="kw kw--loc">United Arab Emirates</span>.</p>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Gulf</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'ecommerce-development-dubai']) }}">Dubai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ecommerce-development-sharjah']) }}">Sharjah</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ecommerce-development-manama']) }}">Manama</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ecommerce-development-riyadh']) }}">Riyadh</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ecommerce-development-jeddah']) }}">Jeddah</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ecommerce-development-doha']) }}">Doha</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ecommerce-development-kuwait-city']) }}">Kuwait City</a></li></ul></div>
