...
@section('title', 'Software & Web Development in Lucknow, India | Edion')
@section('description', 'Software, web, mobile and SEO services for businesses in Lucknow, India. Car rental and fleet platforms a speciality.')
@section('keywords', 'software development lucknow, web development lucknow, seo services lucknow, app development lucknow')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page">Lucknow</li></ol></nav>
 <div class="cityhero">
 <div>
...
<section class="band shell">
 ...
 <div><p class="lbl">All services in Lucknow</p><ul><li><a href="{{ url('/car-rental-software-development-lucknow') }}">Car rental software development in Lucknow</a></li><li><a href="{{ url('/fleet-management-software-lucknow') }}">Fleet management software in Lucknow</a></li><li><a href="{{ url('/car-rental-booking-engine-lucknow') }}">Car rental booking engine in Lucknow</a></li><li><a href="{{ url('/vehicle-rental-app-development-lucknow') }}">Vehicle rental app development in Lucknow</a></li><li><a href="{{ url('/chauffeur-limousine-booking-software-lucknow') }}">Chauffeur and limousine booking software in Lucknow</a></li><li><a href="{{ url('/website-development-lucknow') }}">Website development in Lucknow</a></li><li><a href="{{ url('/custom-software-development-lucknow') }}">Custom software development in Lucknow</a></li><li><a href="{{ url('/mobile-app-development-lucknow') }}">Mobile app development in Lucknow</a></li><li><a href="{{ url('/ecommerce-development-lucknow') }}">E-commerce development in Lucknow</a></li><li><a href="{{ url('/seo-services-lucknow') }}">SEO services in Lucknow</a></li><li><a href="{{ url('/local-seo-services-lucknow') }}">Local SEO services in Lucknow</a></li><li><a href="{{ url('/ppc-advertising-lucknow') }}">PPC advertising in Lucknow</a></li></ul></div>
 <div><p class="lbl">Other India markets</p><ul><li><a href="{{ url('/software-development-delhi') }}">Delhi</a></li><li><a href="{{ url('/software-development-mumbai') }}">Mumbai</a></li><li><a href="{{ url('/software-development-bangalore') }}">Bangalore</a></li></ul></div>
