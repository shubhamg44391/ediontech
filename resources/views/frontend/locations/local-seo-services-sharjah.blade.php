...
@section('title', 'Local SEO services in Sharjah, United Arab Emirates | Edion Web Technologies')
@section('description', 'Local SEO services for businesses in Sharjah, United Arab Emirates. Google Business Profile optimisation, citation consistency, review management and location-based content')
@section('keywords', 'local seo services sharjah, local seo services united arab emirates, local seo services sharjah, local seo services company sharjah, best local seo services sharjah')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Local <b class="kw">SEO services</b></b> in Sharjah</li></ol></nav>
