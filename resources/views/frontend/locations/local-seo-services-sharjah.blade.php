...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Local SEO services in Sharjah, United Arab Emirates | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Local SEO services for businesses in Sharjah, United Arab Emirates. Google Business Profile optimisation, citation consistency, review management and location-based content')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'local seo services sharjah, local seo services united arab emirates, local seo services sharjah, local seo services company sharjah, best local seo services sharjah')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'locations']) }}">Locations</a></li><li aria-current="page"><b class="kw">Local <b class="kw">SEO services</b></b> in Sharjah</li></ol></nav>
 <p class="eyebrow">SEO &middot; United Arab Emirates</p>
 <h1 style="margin-top:var(--sp-4)">Local SEO services in Sharjah</h1>
 <p class="lead"><span class="kw kw--pri"><b class="kw2">Google Business Profile</b></span> optimisation, citation consistency, review management and location-based content for businesses competing in a specific place. We work with businesses in <span class="kw kw--loc">Sharjah</span> and across <span class="kw kw--loc">United Arab Emirates</span>.</p>
...
<section class="band band--ink">
 ...
 <div><p class="eyebrow">Questions</p><h2>Local SEO services in Sharjah: common questions</h2></div>
 </div>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Gulf</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'local-seo-services-dubai']) }}">Dubai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'local-seo-services-abu-dhabi']) }}">Abu Dhabi</a></li><li><a href="{{ route('industry.detail', ['slug'=>'local-seo-services-manama']) }}">Manama</a></li><li><a href="{{ route('industry.detail', ['slug'=>'local-seo-services-riyadh']) }}">Riyadh</a></li><li><a href="{{ route('industry.detail', ['slug'=>'local-seo-services-jeddah']) }}">Jeddah</a></li><li><a href="{{ route('industry.detail', ['slug'=>'local-seo-services-doha']) }}">Doha</a></li><li><a href="{{ route('industry.detail', ['slug'=>'local-seo-services-kuwait-city']) }}">Kuwait City</a></li></ul></div>
