...
@section('title', 'Custom software development in Mumbai, India | Edion Web Technologies')
@section('description', 'Custom software development for businesses in Mumbai, India. Bookings, inventory, dispatch, billing and internal tools. The systems that are specific enough to your o')
@section('keywords', 'custom software development mumbai, custom software development india, custom software development mumbai, custom software development company mumbai, best custom software development mumbai')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Custom software development</b> in Mumbai</li></ol></nav>
