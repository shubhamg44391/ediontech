...
@section('title', 'Software & Web Development in Toronto, Canada | Edion')
@section('description', 'Software, web, mobile and SEO services for businesses in Toronto, Canada. Car rental and fleet platforms a speciality.')
@section('keywords', 'software development toronto, web development toronto, seo services toronto, app development toronto')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page">Toronto</li></ol></nav>
...
<section class="band shell">
 ...
 <div><p class="lbl">All services in Toronto</p><ul><li><a href="{{ url('/car-rental-software-development-toronto') }}">Car rental software development in Toronto</a></li><li><a href="{{ url('/fleet-management-software-toronto') }}">Fleet management software in Toronto</a></li><li><a href="{{ url('/car-rental-booking-engine-toronto') }}">Car rental booking engine in Toronto</a></li><li><a href="{{ url('/vehicle-rental-app-development-toronto') }}">Vehicle rental app development in Toronto</a></li><li><a href="{{ url('/chauffeur-limousine-booking-software-toronto') }}">Chauffeur and limousine booking software in Toronto</a></li><li><a href="{{ url('/website-development-toronto') }}">Website development in Toronto</a></li><li><a href="{{ url('/custom-software-development-toronto') }}">Custom software development in Toronto</a></li><li><a href="{{ url('/mobile-app-development-toronto') }}">Mobile app development in Toronto</a></li><li><a href="{{ url('/ecommerce-development-toronto') }}">E-commerce development in Toronto</a></li><li><a href="{{ url('/seo-services-toronto') }}">SEO services in Toronto</a></li><li><a href="{{ url('/local-seo-services-toronto') }}">Local SEO services in Toronto</a></li><li><a href="{{ url('/ppc-advertising-toronto') }}">PPC advertising in Toronto</a></li></ul></div>
 <div><p class="lbl">Other North America markets</p><ul><li><a href="{{ url('/software-development-new-york') }}">New York</a></li></ul></div>
