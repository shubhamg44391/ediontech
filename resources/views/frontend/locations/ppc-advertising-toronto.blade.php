...
@section('title', 'PPC advertising in Toronto, Canada | Edion Web Technologies')
@section('description', 'PPC advertising for businesses in Toronto, Canada. Google Ads, Shopping, Display, YouTube and Performance Max, with conversion tracking that reflects actual')
@section('keywords', 'ppc advertising toronto, ppc advertising canada, ppc advertising toronto, ppc advertising company toronto, best ppc advertising toronto')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">PPC advertising</b> in Toronto</li></ol></nav>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">North America</p><ul><li><a href="{{ url('/ppc-advertising-new-york') }}">New York</a></li></ul></div>
