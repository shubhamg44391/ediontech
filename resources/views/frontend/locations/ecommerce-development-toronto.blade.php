...
@section('title', 'E-commerce development in Toronto, Canada | Edion Web Technologies')
@section('description', 'E-commerce development for businesses in Toronto, Canada. Catalogues, checkout, order management and the integrations that keep stock accurate. Built on platforms')
@section('keywords', 'e-commerce development toronto, e-commerce development canada, ecommerce development toronto, e-commerce development company toronto, best e-commerce development toronto')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">E-commerce development</b> in Toronto</li></ol></nav>
 <p class="eyebrow">Build &middot; Canada</p>
 <h1 style="margin-top:var(--sp-4)">E-commerce development in Toronto</h1>
 <p class="lead">Catalogues, checkout, order management and the integrations that keep stock accurate. Built on platforms you can staff, or custom where your model needs it. We work with businesses in <span class="kw kw--loc">Toronto</span> and across Canada.</p>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">North America</p><ul><li><a href="{{ url('/ecommerce-development-new-york') }}">New York</a></li></ul></div>
