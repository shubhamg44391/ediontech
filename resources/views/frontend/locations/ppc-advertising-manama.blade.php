...
@section('title', 'PPC advertising in Manama, Bahrain | Edion Web Technologies')
@section('description', 'PPC advertising for businesses in Manama, Bahrain. Google Ads, Shopping, Display, YouTube and Performance Max, with conversion tracking that reflects actual')
@section('keywords', 'ppc advertising manama, ppc advertising bahrain, ppc advertising manama, ppc advertising company manama, best ppc advertising manama')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">PPC advertising</b> in Manama</li></ol></nav>
