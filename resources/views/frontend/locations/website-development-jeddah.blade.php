...
@section('title', 'Website development in Jeddah, Saudi Arabia | Edion Web Technologies')
@section('description', 'Website development for businesses in Jeddah, Saudi Arabia. Marketing sites through to complex web applications, built to stay maintainable after we hand them over.')
@section('keywords', 'website development jeddah, website development saudi arabia, website development jeddah, website development company jeddah, best website development jeddah')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Website development</b> in Jeddah</li></ol></nav>
