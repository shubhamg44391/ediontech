...
@section('title', 'E-commerce development in Riyadh, Saudi Arabia | Edion Web Technologies')
@section('description', 'E-commerce development for businesses in Riyadh, Saudi Arabia. Catalogues, checkout, order management and the integrations that keep stock accurate. Built on platforms')
@section('keywords', 'e-commerce development riyadh, e-commerce development saudi arabia, ecommerce development riyadh, e-commerce development company riyadh, best e-commerce development riyadh')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">E-commerce development</b> in Riyadh</li></ol></nav>
