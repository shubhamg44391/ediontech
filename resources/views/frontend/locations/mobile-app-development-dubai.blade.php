...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Mobile app development in Dubai, United Arab Emirates | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Mobile app development for businesses in Dubai, United Arab Emirates. Native iOS and Android, or Flutter where cross-platform genuinely fits. We choose based on what your team')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'mobile app development dubai, mobile app development united arab emirates, mobile app development dubai, mobile app development company dubai, best mobile app development dubai')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'locations']) }}">Locations</a></li><li aria-current="page"><b class="kw">Mobile app development</b> in Dubai</li></ol></nav>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Gulf</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'mobile-app-development-abu-dhabi']) }}">Abu Dhabi</a></li><li><a href="{{ route('industry.detail', ['slug'=>'mobile-app-development-sharjah']) }}">Sharjah</a></li><li><a href="{{ route('industry.detail', ['slug'=>'mobile-app-development-manama']) }}">Manama</a></li><li><a href="{{ route('industry.detail', ['slug'=>'mobile-app-development-riyadh']) }}">Riyadh</a></li><li><a href="{{ route('industry.detail', ['slug'=>'mobile-app-development-jeddah']) }}">Jeddah</a></li><li><a href="{{ route('industry.detail', ['slug'=>'mobile-app-development-doha']) }}">Doha</a></li><li><a href="{{ route('industry.detail', ['slug'=>'mobile-app-development-kuwait-city']) }}">Kuwait City</a></li></ul></div>
