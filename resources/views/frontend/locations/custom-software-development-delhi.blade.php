...
@section('title', 'Custom software development in Delhi, India | Edion Web Technologies')
@section('description', 'Custom software development for businesses in Delhi, India. Bookings, inventory, dispatch, billing and internal tools. The systems that are specific enough to your o')
@section('keywords', 'custom software development delhi, custom software development india, custom software development delhi, custom software development company delhi, best custom software development delhi')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Custom software development</b> in Delhi</li></ol></nav>
