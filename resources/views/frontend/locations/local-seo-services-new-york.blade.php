...
@section('title', 'Local SEO services in New York, United States | Edion Web Technologies')
@section('description', 'Local SEO services for businesses in New York, United States. Google Business Profile optimisation, citation consistency, review management and location-based content')
@section('keywords', 'local seo services new york, local seo services united states, local seo services new york, local seo services company new york, best local seo services new york')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Local <b class="kw">SEO services</b></b> in New York</li></ol></nav>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">North America</p><ul><li><a href="{{ url('/local-seo-services-toronto') }}">Toronto</a></li></ul></div>
