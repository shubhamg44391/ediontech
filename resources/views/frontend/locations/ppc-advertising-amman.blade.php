...
@section('title', 'PPC advertising in Amman, Jordan | Edion Web Technologies')
@section('description', 'PPC advertising for businesses in Amman, Jordan. Google Ads, Shopping, Display, YouTube and Performance Max, with conversion tracking that reflects actual')
@section('keywords', 'ppc advertising amman, ppc advertising jordan, ppc advertising amman, ppc advertising company amman, best ppc advertising amman')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">PPC advertising</b> in Amman</li></ol></nav>
