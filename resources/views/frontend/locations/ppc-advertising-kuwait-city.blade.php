...
@section('title', 'PPC advertising in Kuwait City, Kuwait | Edion Web Technologies')
@section('description', 'PPC advertising for businesses in Kuwait City, Kuwait. Google Ads, Shopping, Display, YouTube and Performance Max, with conversion tracking that reflects actual')
@section('keywords', 'ppc advertising kuwait city, ppc advertising kuwait, ppc advertising kuwait city, ppc advertising company kuwait city, best ppc advertising kuwait city')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">PPC advertising</b> in Kuwait City</li></ol></nav>
