...
@section('title', 'Local SEO services in Doha, Qatar | Edion Web Technologies')
@section('description', 'Local SEO services for businesses in Doha, Qatar. Google Business Profile optimisation, citation consistency, review management and location-based content')
@section('keywords', 'local seo services doha, local seo services qatar, local seo services doha, local seo services company doha, best local seo services doha')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Local <b class="kw">SEO services</b></b> in Doha</li></ol></nav>
