...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Local SEO services in Kuwait City, Kuwait | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Local SEO services for businesses in Kuwait City, Kuwait. Google Business Profile optimisation, citation consistency, review management and location-based content')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'local seo services kuwait city, local seo services kuwait, local seo services kuwait city, local seo services company kuwait city, best local seo services kuwait city')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'locations']) }}">Locations</a></li><li aria-current="page"><b class="kw">Local <b class="kw">SEO services</b></b> in Kuwait City</li></ol></nav>
 <p class="eyebrow">SEO &middot; Kuwait</p>
 <h1 style="margin-top:var(--sp-4)">Local SEO services in Kuwait City</h1>
 <p class="lead"><span class="kw kw--pri"><b class="kw2">Google Business Profile</b></span> optimisation, citation consistency, review management and location-based content for businesses competing in a specific place. We work with businesses in <span class="kw kw--loc">Kuwait City</span> and across <span class="kw kw--loc">Kuwait</span>.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>NAP audit</b><span>Across every listing</span></div><div class="lp-fact"><b>GBP managed</b><span>Posts, Q&A, categories</span></div><div class="lp-fact"><b>Review flow</b><span>Steady, not bursty</span></div><div class="lp-fact"><b>KWD</b><span>Quoting currency</span></div><div class="lp-fact"><b>AST</b><span>Hours overlap</span></div></div>
</section>
