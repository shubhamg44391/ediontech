...
@section('title', 'Local SEO services in Kuwait City, Kuwait | Edion Web Technologies')
@section('description', 'Local SEO services for businesses in Kuwait City, Kuwait. Google Business Profile optimisation, citation consistency, review management and location-based content')
@section('keywords', 'local seo services kuwait city, local seo services kuwait, local seo services kuwait city, local seo services company kuwait city, best local seo services kuwait city')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Local <b class="kw">SEO services</b></b> in Kuwait City</li></ol></nav>
