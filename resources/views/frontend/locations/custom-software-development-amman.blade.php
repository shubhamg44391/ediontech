...
@section('title', 'Custom software development in Amman, Jordan | Edion Web Technologies')
@section('description', 'Custom software development for businesses in Amman, Jordan. Bookings, inventory, dispatch, billing and internal tools. The systems that are specific enough to your o')
@section('keywords', 'custom software development amman, custom software development jordan, custom software development amman, custom software development company amman, best custom software development amman')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Custom software development</b> in Amman</li></ol></nav>
