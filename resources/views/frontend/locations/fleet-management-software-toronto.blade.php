...
@section('title', 'Fleet management software in Toronto, Canada | Edion Web Technologies')
@section('description', 'Fleet management software for businesses in Toronto, Canada. Custom fleet management software that reports utilisation, downtime and cost per asset accurately. Built')
@section('keywords', 'fleet management software toronto, fleet management software canada, fleet management software toronto, fleet management software company toronto, best fleet management software toronto')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Fleet management software</b> in Toronto</li></ol></nav>
 <p class="eyebrow">Fleet systems &middot; Canada</p>
 <h1 style="margin-top:var(--sp-4)">Fleet management software in Toronto</h1>
 <p class="lead">Custom <span class="kw kw--pri">fleet management software</span> that reports <b class="kw2">utilisation</b>, <b class="kw2">downtime</b> and <b class="kw2">cost per asset</b> accurately. Built for rental operators, logistics fleets and corporate fleets that have outgrown spreadsheets but do not want a per-vehicle licence fee forever. We work with businesses in <span class="kw kw--loc">Toronto</span> and across Canada.</p>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">North America</p><ul><li><a href="{{ url('/fleet-management-software-new-york') }}">New York</a></li></ul></div>
