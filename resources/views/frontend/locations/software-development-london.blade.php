...
@section('title', 'Software & Web Development in London, United Kingdom | Edion')
@section('description', 'Software, web, mobile and SEO services for businesses in London, United Kingdom. Car rental and fleet platforms a speciality.')
@section('keywords', 'software development london, web development london, seo services london, app development london')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page">London</li></ol></nav>
 <div class="cityhero">
 <div>
...
<section class="band shell">
 ...
 <div><p class="lbl">All services in London</p><ul><li><a href="{{ url('/car-rental-software-development-london') }}">Car rental software development in London</a></li><li><a href="{{ url('/fleet-management-software-london') }}">Fleet management software in London</a></li><li><a href="{{ url('/car-rental-booking-engine-london') }}">Car rental booking engine in London</a></li><li><a href="{{ url('/vehicle-rental-app-development-london') }}">Vehicle rental app development in London</a></li><li><a href="{{ url('/chauffeur-limousine-booking-software-london') }}">Chauffeur and limousine booking software in London</a></li><li><a href="{{ url('/website-development-london') }}">Website development in London</a></li><li><a href="{{ url('/custom-software-development-london') }}">Custom software development in London</a></li><li><a href="{{ url('/mobile-app-development-london') }}">Mobile app development in London</a></li><li><a href="{{ url('/ecommerce-development-london') }}">E-commerce development in London</a></li><li><a href="{{ url('/seo-services-london') }}">SEO services in London</a></li><li><a href="{{ url('/local-seo-services-london') }}">Local SEO services in London</a></li><li><a href="{{ url('/ppc-advertising-london') }}">PPC advertising in London</a></li></ul></div>
 <div><p class="lbl">Other Europe markets</p><ul><li><a href="{{ url('/software-development-manchester') }}">Manchester</a></li></ul></div>
