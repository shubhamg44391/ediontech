...
@section('title', 'Custom software development in Sharjah, United Arab Emirates | Edion Web Technologies')
@section('description', 'Custom software development for businesses in Sharjah, United Arab Emirates. Bookings, inventory, dispatch, billing and internal tools. The systems that are specific enough to your o')
@section('keywords', 'custom software development sharjah, custom software development united arab emirates, custom software development sharjah, custom software development company sharjah, best custom software development sharjah')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Custom software development</b> in Sharjah</li></ol></nav>
