...
@section('title', 'Custom software development in Toronto, Canada | Edion Web Technologies')
@section('description', 'Custom software development for businesses in Toronto, Canada. Bookings, inventory, dispatch, billing and internal tools. The systems that are specific enough to your o')
@section('keywords', 'custom software development toronto, custom software development canada, custom software development toronto, custom software development company toronto, best custom software development toronto')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Custom software development</b> in Toronto</li></ol></nav>
