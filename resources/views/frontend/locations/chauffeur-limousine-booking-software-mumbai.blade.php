...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Chauffeur and limousine booking software in Mumbai, India | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Chauffeur and limousine booking software for businesses in Mumbai, India. If you dispatch drivers as well as rent vehicles, that is genuinely a different product: driver rostering')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'chauffeur and limousine booking software mumbai, chauffeur and limousine booking software india, chauffeur limousine booking software mumbai, chauffeur and limousine booking software company mumbai, best chauffeur and limousine booking software mumbai')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'locations']) }}">Locations</a></li><li aria-current="page"><b class="kw2">Chauffeur and limousine</b> booking software in Mumbai</li></ol></nav>
 <p class="eyebrow">Chauffeur &middot; India</p>
 <h1 style="margin-top:var(--sp-4)">Chauffeur and limousine booking software in Mumbai</h1>
 <p class="lead">If you dispatch drivers as well as rent vehicles, that is genuinely a different product: driver rostering, live dispatch, route-based trip pricing and driver settlements. It shares your <b class="kw2">fleet register</b> and nothing else. We work with businesses in <span class="kw kw--loc">Mumbai</span> and across <span class="kw kw--loc">India</span>.</p>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">India</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'chauffeur-limousine-booking-software-lucknow']) }}">Lucknow</a></li><li><a href="{{ route('industry.detail', ['slug'=>'chauffeur-limousine-booking-software-delhi']) }}">Delhi</a></li><li><a href="{{ route('industry.detail', ['slug'=>'chauffeur-limousine-booking-software-bangalore']) }}">Bangalore</a></li></ul></div>
 <div><p class="lbl">Other services in Mumbai</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-software-development-mumbai']) }}">Car rental software development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'fleet-management-software-mumbai']) }}">Fleet management software</a></li><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-booking-engine-mumbai']) }}">Car rental booking engine</a></li><li><a href="{{ route('industry.detail', ['slug'=>'vehicle-rental-app-development-mumbai']) }}">Vehicle rental app development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'website-development-mumbai']) }}">Website development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'custom-software-development-mumbai']) }}">Custom software development</a></li></ul></div>
