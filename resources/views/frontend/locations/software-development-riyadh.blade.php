...
@section('title', 'Software & Web Development in Riyadh, Saudi Arabia | Edion')
@section('description', 'Software, web, mobile and SEO services for businesses in Riyadh, Saudi Arabia. Car rental and fleet platforms a speciality.')
@section('keywords', 'software development riyadh, web development riyadh, seo services riyadh, app development riyadh')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page">Riyadh</li></ol></nav>
 <div class="cityhero">
 <div>
