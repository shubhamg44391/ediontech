...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'E-commerce development in Mumbai, India | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'E-commerce development for businesses in Mumbai, India. Catalogues, checkout, order management and the integrations that keep stock accurate. Built on platforms')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'e-commerce development mumbai, e-commerce development india, ecommerce development mumbai, e-commerce development company mumbai, best e-commerce development mumbai')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'locations']) }}">Locations</a></li><li aria-current="page"><b class="kw">E-commerce development</b> in Mumbai</li></ol></nav>
 <p class="eyebrow">Build &middot; India</p>
 <h1 style="margin-top:var(--sp-4)">E-commerce development in Mumbai</h1>
 <p class="lead">Catalogues, checkout, order management and the integrations that keep stock accurate. Built on platforms you can staff, or custom where your model needs it. We work with businesses in <span class="kw kw--loc">Mumbai</span> and across <span class="kw kw--loc">India</span>.</p>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">India</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'ecommerce-development-lucknow']) }}">Lucknow</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ecommerce-development-delhi']) }}">Delhi</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ecommerce-development-bangalore']) }}">Bangalore</a></li></ul></div>
