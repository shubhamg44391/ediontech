...
@section('title', 'Custom software development in Doha, Qatar | Edion Web Technologies')
@section('description', 'Custom software development for businesses in Doha, Qatar. Bookings, inventory, dispatch, billing and internal tools. The systems that are specific enough to your o')
@section('keywords', 'custom software development doha, custom software development qatar, custom software development doha, custom software development company doha, best custom software development doha')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Custom software development</b> in Doha</li></ol></nav>
