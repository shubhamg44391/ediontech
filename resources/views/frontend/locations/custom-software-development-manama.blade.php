...
@section('title', 'Custom software development in Manama, Bahrain | Edion Web Technologies')
@section('description', 'Custom software development for businesses in Manama, Bahrain. Bookings, inventory, dispatch, billing and internal tools. The systems that are specific enough to your o')
@section('keywords', 'custom software development manama, custom software development bahrain, custom software development manama, custom software development company manama, best custom software development manama')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Custom software development</b> in Manama</li></ol></nav>
