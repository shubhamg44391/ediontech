...
@section('title', 'Chauffeur and limousine booking software in Toronto, Canada | Edion Web Technologies')
@section('description', 'Chauffeur and limousine booking software for businesses in Toronto, Canada. If you dispatch drivers as well as rent vehicles, that is genuinely a different product: driver rostering')
@section('keywords', 'chauffeur and limousine booking software toronto, chauffeur and limousine booking software canada, chauffeur limousine booking software toronto, chauffeur and limousine booking software company toronto, best chauffeur and limousine booking software toronto')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw2">Chauffeur and limousine</b> booking software in Toronto</li></ol></nav>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">North America</p><ul><li><a href="{{ url('/chauffeur-limousine-booking-software-new-york') }}">New York</a></li></ul></div>
