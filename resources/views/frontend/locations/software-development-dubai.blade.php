...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Software & Web Development in Dubai, United Arab Emirates | Edion')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Software, web, mobile and SEO services for businesses in Dubai, United Arab Emirates. Car rental and fleet platforms a speciality.')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'software development dubai, web development dubai, seo services dubai, app development dubai')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'locations']) }}">Locations</a></li><li aria-current="page">Dubai</li></ol></nav>
 <div class="cityhero">
 <div>
...
<section class="band shell">
 ...
 <div><p class="lbl">All services in Dubai</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-software-development-dubai']) }}">Car rental software development in Dubai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'fleet-management-software-dubai']) }}">Fleet management software in Dubai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-booking-engine-dubai']) }}">Car rental booking engine in Dubai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'vehicle-rental-app-development-dubai']) }}">Vehicle rental app development in Dubai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'chauffeur-limousine-booking-software-dubai']) }}">Chauffeur and limousine booking software in Dubai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'website-development-dubai']) }}">Website development in Dubai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'custom-software-development-dubai']) }}">Custom software development in Dubai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'mobile-app-development-dubai']) }}">Mobile app development in Dubai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ecommerce-development-dubai']) }}">E-commerce development in Dubai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'seo-services-dubai']) }}">SEO services in Dubai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'local-seo-services-dubai']) }}">Local SEO services in Dubai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'ppc-advertising-dubai']) }}">PPC advertising in Dubai</a></li></ul></div>
 <div><p class="lbl">Other Gulf markets</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'software-development-abu-dhabi']) }}">Abu Dhabi</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-development-sharjah']) }}">Sharjah</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-development-manama']) }}">Manama</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-development-riyadh']) }}">Riyadh</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-development-jeddah']) }}">Jeddah</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-development-doha']) }}">Doha</a></li><li><a href="{{ route('industry.detail', ['slug'=>'software-development-kuwait-city']) }}">Kuwait City</a></li></ul></div>
