...
@section('title', 'PPC advertising in New York, United States | Edion Web Technologies')
@section('description', 'PPC advertising for businesses in New York, United States. Google Ads, Shopping, Display, YouTube and Performance Max, with conversion tracking that reflects actual')
@section('keywords', 'ppc advertising new york, ppc advertising united states, ppc advertising new york, ppc advertising company new york, best ppc advertising new york')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">PPC advertising</b> in New York</li></ol></nav>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">North America</p><ul><li><a href="{{ url('/ppc-advertising-toronto') }}">Toronto</a></li></ul></div>
