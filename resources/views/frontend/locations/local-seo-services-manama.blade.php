...
@section('title', 'Local SEO services in Manama, Bahrain | Edion Web Technologies')
@section('description', 'Local SEO services for businesses in Manama, Bahrain. Google Business Profile optimisation, citation consistency, review management and location-based content')
@section('keywords', 'local seo services manama, local seo services bahrain, local seo services manama, local seo services company manama, best local seo services manama')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Local <b class="kw">SEO services</b></b> in Manama</li></ol></nav>
