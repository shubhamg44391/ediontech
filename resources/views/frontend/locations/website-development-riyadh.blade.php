...
@section('title', 'Website development in Riyadh, Saudi Arabia | Edion Web Technologies')
@section('description', 'Website development for businesses in Riyadh, Saudi Arabia. Marketing sites through to complex web applications, built to stay maintainable after we hand them over.')
@section('keywords', 'website development riyadh, website development saudi arabia, website development riyadh, website development company riyadh, best website development riyadh')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Website development</b> in Riyadh</li></ol></nav>
