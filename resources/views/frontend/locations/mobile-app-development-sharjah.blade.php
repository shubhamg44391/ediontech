...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Mobile app development in Sharjah, United Arab Emirates | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Mobile app development for businesses in Sharjah, United Arab Emirates. Native iOS and Android, or Flutter where cross-platform genuinely fits. We choose based on what your team')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'mobile app development sharjah, mobile app development united arab emirates, mobile app development sharjah, mobile app development company sharjah, best mobile app development sharjah')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'locations']) }}">Locations</a></li><li aria-current="page"><b class="kw">Mobile app development</b> in Sharjah</li></ol></nav>
 <p class="eyebrow">Build &middot; United Arab Emirates</p>
 <h1 style="margin-top:var(--sp-4)">Mobile app development in Sharjah</h1>
 <p class="lead">Native iOS and Android, or <span class="kw kw--tech">Flutter</span> where cross-platform genuinely fits. We choose based on what your team can hire for and maintain, not on what is fashionable this year. We work with businesses in <span class="kw kw--loc">Sharjah</span> and across <span class="kw kw--loc">United Arab Emirates</span>.</p>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Gulf</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'mobile-app-development-dubai']) }}">Dubai</a></li><li><a href="{{ route('industry.detail', ['slug'=>'mobile-app-development-abu-dhabi']) }}">Abu Dhabi</a></li><li><a href="{{ route('industry.detail', ['slug'=>'mobile-app-development-manama']) }}">Manama</a></li><li><a href="{{ route('industry.detail', ['slug'=>'mobile-app-development-riyadh']) }}">Riyadh</a></li><li><a href="{{ route('industry.detail', ['slug'=>'mobile-app-development-jeddah']) }}">Jeddah</a></li><li><a href="{{ route('industry.detail', ['slug'=>'mobile-app-development-doha']) }}">Doha</a></li><li><a href="{{ route('industry.detail', ['slug'=>'mobile-app-development-kuwait-city']) }}">Kuwait City</a></li></ul></div>
 <div><p class="lbl">Other services in Sharjah</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-software-development-sharjah']) }}">Car rental software development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'fleet-management-software-sharjah']) }}">Fleet management software</a></li><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-booking-engine-sharjah']) }}">Car rental booking engine</a></li><li><a href="{{ route('industry.detail', ['slug'=>'vehicle-rental-app-development-sharjah']) }}">Vehicle rental app development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'chauffeur-limousine-booking-software-sharjah']) }}">Chauffeur and limousine booking software</a></li><li><a href="{{ route('industry.detail', ['slug'=>'website-development-sharjah']) }}">Website development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'custom-software-development-sharjah']) }}">Custom software development</a></li></ul></div>
