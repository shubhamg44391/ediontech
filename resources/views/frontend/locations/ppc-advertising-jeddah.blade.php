...
@section('title', 'PPC advertising in Jeddah, Saudi Arabia | Edion Web Technologies')
@section('description', 'PPC advertising for businesses in Jeddah, Saudi Arabia. Google Ads, Shopping, Display, YouTube and Performance Max, with conversion tracking that reflects actual')
@section('keywords', 'ppc advertising jeddah, ppc advertising saudi arabia, ppc advertising jeddah, ppc advertising company jeddah, best ppc advertising jeddah')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">PPC advertising</b> in Jeddah</li></ol></nav>
