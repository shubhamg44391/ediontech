...
@section('title', 'Mobile app development in Delhi, India | Edion Web Technologies')
@section('description', 'Mobile app development for businesses in Delhi, India. Native iOS and Android, or Flutter where cross-platform genuinely fits. We choose based on what your team')
@section('keywords', 'mobile app development delhi, mobile app development india, mobile app development delhi, mobile app development company delhi, best mobile app development delhi')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Mobile app development</b> in Delhi</li></ol></nav>
