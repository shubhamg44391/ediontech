...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Vehicle rental app development in Toronto, Canada | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Vehicle rental app development for businesses in Toronto, Canada. iOS and Android apps for rental and mobility operators. Browse and book, upload a licence, sign the agree')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'vehicle rental app development toronto, vehicle rental app development canada, vehicle rental app development toronto, vehicle rental app development company toronto, best vehicle rental app development toronto')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'locations']) }}">Locations</a></li><li aria-current="page">Vehicle rental app development in Toronto</li></ol></nav>
 <p class="eyebrow">Mobile &middot; Canada</p>
 <h1 style="margin-top:var(--sp-4)">Vehicle rental app development in Toronto</h1>
 <p class="lead">iOS and Android apps for rental and mobility operators. Browse and book, upload a licence, sign the agreement, photograph condition at collection and return, extend a hire without calling the branch. We work with businesses in <span class="kw kw--loc">Toronto</span> and across Canada.</p>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">North America</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'vehicle-rental-app-development-new-york']) }}">New York</a></li></ul></div>
 <div><p class="lbl">Other services in Toronto</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-software-development-toronto']) }}">Car rental software development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'fleet-management-software-toronto']) }}">Fleet management software</a></li><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-booking-engine-toronto']) }}">Car rental booking engine</a></li><li><a href="{{ route('industry.detail', ['slug'=>'chauffeur-limousine-booking-software-toronto']) }}">Chauffeur and limousine booking software</a></li><li><a href="{{ route('industry.detail', ['slug'=>'website-development-toronto']) }}">Website development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'custom-software-development-toronto']) }}">Custom software development</a></li></ul></div>
