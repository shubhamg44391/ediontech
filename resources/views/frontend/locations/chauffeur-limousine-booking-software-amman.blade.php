...
@section('title', 'Chauffeur and limousine booking software in Amman, Jordan | Edion Web Technologies')
@section('description', 'Chauffeur and limousine booking software for businesses in Amman, Jordan. If you dispatch drivers as well as rent vehicles, that is genuinely a different product: driver rostering')
@section('keywords', 'chauffeur and limousine booking software amman, chauffeur and limousine booking software jordan, chauffeur limousine booking software amman, chauffeur and limousine booking software company amman, best chauffeur and limousine booking software amman')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw2">Chauffeur and limousine</b> booking software in Amman</li></ol></nav>
