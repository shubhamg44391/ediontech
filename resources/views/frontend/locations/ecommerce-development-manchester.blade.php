...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'E-commerce development in Manchester, United Kingdom | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'E-commerce development for businesses in Manchester, United Kingdom. Catalogues, checkout, order management and the integrations that keep stock accurate. Built on platforms')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'e-commerce development manchester, e-commerce development united kingdom, ecommerce development manchester, e-commerce development company manchester, best e-commerce development manchester')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'locations']) }}">Locations</a></li><li aria-current="page"><b class="kw">E-commerce development</b> in Manchester</li></ol></nav>
 <p class="eyebrow">Build &middot; United Kingdom</p>
 <h1 style="margin-top:var(--sp-4)">E-commerce development in Manchester</h1>
 <p class="lead">Catalogues, checkout, order management and the integrations that keep stock accurate. Built on platforms you can staff, or custom where your model needs it. We work with businesses in <span class="kw kw--loc">Manchester</span> and across <span class="kw kw--loc">United Kingdom</span>.</p>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Europe</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'ecommerce-development-london']) }}">London</a></li></ul></div>
