...
@section('title', 'Local SEO services in Riyadh, Saudi Arabia | Edion Web Technologies')
@section('description', 'Local SEO services for businesses in Riyadh, Saudi Arabia. Google Business Profile optimisation, citation consistency, review management and location-based content')
@section('keywords', 'local seo services riyadh, local seo services saudi arabia, local seo services riyadh, local seo services company riyadh, best local seo services riyadh')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Local <b class="kw">SEO services</b></b> in Riyadh</li></ol></nav>
