...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Website development in London, United Kingdom | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Website development for businesses in London, United Kingdom. Marketing sites through to complex web applications, built to stay maintainable after we hand them over.')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'website development london, website development united kingdom, website development london, website development company london, best website development london')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'locations']) }}">Locations</a></li><li aria-current="page"><b class="kw">Website development</b> in London</li></ol></nav>
 <p class="eyebrow">Build &middot; United Kingdom</p>
 <h1 style="margin-top:var(--sp-4)">Website development in London</h1>
 <p class="lead">Marketing sites through to complex web applications, built to stay maintainable after we hand them over. Clean markup, sensible dependencies, and code your next developer can read. We work with businesses in <span class="kw kw--loc">London</span> and across <span class="kw kw--loc">United Kingdom</span>.</p>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Europe</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'website-development-manchester']) }}">Manchester</a></li></ul></div>
 <div><p class="lbl">Other services in London</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-software-development-london']) }}">Car rental software development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'fleet-management-software-london']) }}">Fleet management software</a></li><li><a href="{{ route('industry.detail', ['slug'=>'car-rental-booking-engine-london']) }}">Car rental booking engine</a></li><li><a href="{{ route('industry.detail', ['slug'=>'vehicle-rental-app-development-london']) }}">Vehicle rental app development</a></li><li><a href="{{ route('industry.detail', ['slug'=>'chauffeur-limousine-booking-software-london']) }}">Chauffeur and limousine booking software</a></li><li><a href="{{ route('industry.detail', ['slug'=>'custom-software-development-london']) }}">Custom software development</a></li></ul></div>
