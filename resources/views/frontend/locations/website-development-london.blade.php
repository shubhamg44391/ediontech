...
@section('title', 'Website development in London, United Kingdom | Edion Web Technologies')
@section('description', 'Website development for businesses in London, United Kingdom. Marketing sites through to complex web applications, built to stay maintainable after we hand them over.')
@section('keywords', 'website development london, website development united kingdom, website development london, website development company london, best website development london')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Website development</b> in London</li></ol></nav>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Europe</p><ul><li><a href="{{ url('/website-development-manchester') }}">Manchester</a></li></ul></div>
