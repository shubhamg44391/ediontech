...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Local SEO services in London, United Kingdom | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Local SEO services for businesses in London, United Kingdom. Google Business Profile optimisation, citation consistency, review management and location-based content')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'local seo services london, local seo services united kingdom, local seo services london, local seo services company london, best local seo services london')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'locations']) }}">Locations</a></li><li aria-current="page"><b class="kw">Local <b class="kw">SEO services</b></b> in London</li></ol></nav>
 <p class="eyebrow">SEO &middot; United Kingdom</p>
 <h1 style="margin-top:var(--sp-4)">Local SEO services in London</h1>
 <p class="lead"><span class="kw kw--pri"><b class="kw2">Google Business Profile</b></span> optimisation, citation consistency, review management and location-based content for businesses competing in a specific place. We work with businesses in <span class="kw kw--loc">London</span> and across <span class="kw kw--loc">United Kingdom</span>.</p>
...
<section class="band band--ink">
 ...
 <div><p class="eyebrow">Questions</p><h2>Local SEO services in London: common questions</h2></div>
 </div>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Europe</p><ul><li><a href="{{ route('industry.detail', ['slug'=>'local-seo-services-manchester']) }}">Manchester</a></li></ul></div>
