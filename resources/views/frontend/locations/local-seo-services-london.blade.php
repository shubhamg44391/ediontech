...
@section('title', 'Local SEO services in London, United Kingdom | Edion Web Technologies')
@section('description', 'Local SEO services for businesses in London, United Kingdom. Google Business Profile optimisation, citation consistency, review management and location-based content')
@section('keywords', 'local seo services london, local seo services united kingdom, local seo services london, local seo services company london, best local seo services london')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Local <b class="kw">SEO services</b></b> in London</li></ol></nav>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Europe</p><ul><li><a href="{{ url('/local-seo-services-manchester') }}">Manchester</a></li></ul></div>
