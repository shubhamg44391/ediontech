...
@section('title', 'Local SEO services in Amman, Jordan | Edion Web Technologies')
@section('description', 'Local SEO services for businesses in Amman, Jordan. Google Business Profile optimisation, citation consistency, review management and location-based content')
@section('keywords', 'local seo services amman, local seo services jordan, local seo services amman, local seo services company amman, best local seo services amman')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ url('/locations') }}">Locations</a></li><li aria-current="page"><b class="kw">Local <b class="kw">SEO services</b></b> in Amman</li></ol></nav>
