...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Local SEO services in Amman, Jordan | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Local SEO services for businesses in Amman, Jordan. Google Business Profile optimisation, citation consistency, review management and location-based content')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'local seo services amman, local seo services jordan, local seo services amman, local seo services company amman, best local seo services amman')
...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li><a href="{{ route('industry.detail', ['slug'=>'locations']) }}">Locations</a></li><li aria-current="page"><b class="kw">Local <b class="kw">SEO services</b></b> in Amman</li></ol></nav>
 <p class="eyebrow">SEO &middot; Jordan</p>
 <h1 style="margin-top:var(--sp-4)">Local SEO services in Amman</h1>
 <p class="lead"><span class="kw kw--pri"><b class="kw2">Google Business Profile</b></span> optimisation, citation consistency, review management and location-based content for businesses competing in a specific place. We work with businesses in <span class="kw kw--loc">Amman</span> and across <span class="kw kw--loc">Jordan</span>.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>NAP audit</b><span>Across every listing</span></div><div class="lp-fact"><b>GBP managed</b><span>Posts, Q&A, categories</span></div><div class="lp-fact"><b>Review flow</b><span>Steady, not bursty</span></div><div class="lp-fact"><b>JOD</b><span>Quoting currency</span></div><div class="lp-fact"><b>EET</b><span>Hours overlap</span></div></div>
</section>
