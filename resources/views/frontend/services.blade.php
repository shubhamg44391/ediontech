                    ...
                    <div class="p-0 container-fluid">
                      <div class="row g-0">
                        <div class="col-12">
                          <!-- content -->
                                   {{-- page title --}}
                    <h1 class="px-5 py-5 text-center text-white">Global Software Development & Digital Technology Services</h1>
                              ...
                              <div class="row g-0">
                                <div class="col-12 col-xl-10 mxd-grid-item">
                                  ...
                                  <div class="inner-headline__title">
                                    <h2 class="medium permanent loading-split">New standards in <span>digital excellence</span></h2>
                                  </div>
                                </div>
