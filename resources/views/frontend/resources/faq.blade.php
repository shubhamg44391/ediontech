...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'FAQ | Website, App, Software & SEO Questions | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Straight answers on timelines, costs, code ownership, car rental software scope, post-launch support and SEO expectations, from Edion Web Technologies.')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'website development FAQ, software development questions, car rental software FAQ, SEO questions, web design cost, code ownership')
...
<section class="band band--tight shell">
 ...
 @if(isset($faqs) && count($faqs) > 0)
  ...
  <details>
   ...
   <div class="acc__body"><p>{!! $faq->description !!}</p></div>
  </details>
  @endforeach
 @else
