                ...
                <div class="col-12 col-xl-8 mxd-grid-item">
                  ...
                  <div class="mxd-section-title__manifest title-manifest-s no-padding-mobile">
                    <a class="manifest manifest-s mxd-split-lines active-cursor-accent" data-cursor-text="About us"
                      ...
                      <span>every aspect of our projects is crafted with care to ensure the highest standards of
                        quality.</span></a>
                  </div>
                  <!-- Manifest End -->
                  ...
                  <div class="row g-0">
                    ...
                    <div class="col-12 col-md-6 col-xl-4 mxd-cpb-list__data">
                      <div class="mxd-cpb-list__descr mxd-grid-item d-flex justify-content-between">
                        ...
                        <p class="t-large t-bold">Transforming concepts into seamless and <span>future-ready digital
                            products.</span></p>
                  ...
                  <div class="row g-0">
                    ...
                    <div class="col-12 col-md-6 col-xl-4 mxd-cpb-list__data">
                      <div class="mxd-cpb-list__descr mxd-grid-item d-flex justify-content-between">
                        ...
                        <p class="t-large t-bold">Elegant, high-speed web experiences that <span>feel effortless and
                            refined.</span></p>
                  ...
                  <div class="row g-0">
                    ...
                    <div class="col-12 col-md-6 col-xl-4 mxd-cpb-list__data">
                      <div class="mxd-cpb-list__descr mxd-grid-item d-flex justify-content-between">
                        ...
                        <p class="t-large t-bold">Designing fluid mobile experiences that <span>inspire creativity.</span>
                        </p>
                  ...
                  <div class="row g-0">
                    ...
                    <div class="col-12 col-md-6 col-xl-4 mxd-cpb-list__data">
                      <div class="mxd-cpb-list__descr mxd-grid-item d-flex justify-content-between">
                        ...
                        <p class="t-large t-bold">Blending clarity and emotion into <span> experiences that feel
                            beautifully simple. </span></p>
                  ...
                  <div class="row g-0">
                    ...
                    <div class="col-12 col-md-6 col-xl-4 mxd-cpb-list__data">
                      <div class="mxd-cpb-list__descr mxd-grid-item d-flex justify-content-between">
                        ...
                        <p class="t-large t-bold">Perfecting every detail to ensure precision, stability, <span> and
                            confidence in every click. </span></p>
                  ...
                  <div class="row g-0">
                    ...
                    <div class="col-12 col-md-6 col-xl-4 mxd-cpb-list__data">
                      <div class="mxd-cpb-list__descr mxd-grid-item d-flex justify-content-between">
                        ...
                        <p class="t-large t-bold">Merging creativity and intelligence to build <span> systems that imagine
                            and evolve. </span></p>
          ...
          <div class="container-fluid p-0">
            <div class="row g-0">
              ...
              <div class="col-12 col-xl-4 mxd-aside-descr mxd-grid-item">
                <p class="t-bold t-large t-aside mxd-split-lines">A powerhouse in <span>full-stack development
                    solutions</span></p>
              </div>
              <!-- tech stack columns -->
                      ...
                      <div class="mxd-tech-stack__column">
                        ...
                        <div class="mxd-tech-stack__item">
                          ...
                          <div class="mxd-tech-stack__logo">
                            <svg xmlns="http://www.w3.org/2000/svg" width="256" height="272" version="1.1"
                              viewBox="0 0 256 272">
                              <path
                        ...
                        <div class="mxd-tech-stack__item">
                          <div class="mxd-tech-stack__divider divider-top anim-uni-clip-in"></div>
                          <div class="mxd-tech-stack__logo">
                            <svg xmlns="http://www.w3.org/2000/svg" width="2500" height="1309" version="1.1"
                        ...
                        <div class="mxd-tech-stack__item">
                          <div class="mxd-tech-stack__divider divider-top anim-uni-clip-in"></div>
                          <div class="mxd-tech-stack__logo">
                            <svg xmlns="http://www.w3.org/2000/svg" width="351.8" height="198.8" version="1.1"
                    ...
                    <div class="col-12 col-md-4 mxd-grid-item">
                      ...
                      <div class="mxd-tech-stack__column">
                        ...
                        <div class="mxd-tech-stack__item">
                          <div class="mxd-tech-stack__divider divider-top anim-uni-clip-in"></div>
                          <div class="mxd-tech-stack__logo">
                            <svg xmlns="http://www.w3.org/2000/svg" width="225.8" height="201.2" version="1.1"
                        ...
                        <div class="mxd-tech-stack__item">
                          <div class="mxd-tech-stack__divider divider-top anim-uni-clip-in"></div>
                          <div class="mxd-tech-stack__logo">
                            <svg xmlns="http://www.w3.org/2000/svg" width="256" height="288" version="1.1"
                              viewBox="0 0 256 288">
                              <path
                        ...
                        <div class="mxd-tech-stack__item">
                          <div class="mxd-tech-stack__divider divider-top anim-uni-clip-in"></div>
                          <div class="mxd-tech-stack__logo">
                            <svg xmlns="http://www.w3.org/2000/svg" width="257" height="128" version="1.1"
                              viewBox="0 0 257 128">
                              <path
                    ...
                    <div class="col-12 col-md-4 mxd-grid-item">
                      ...
                      <div class="mxd-tech-stack__column">
                        ...
                        <div class="mxd-tech-stack__item">
                          <div class="mxd-tech-stack__divider divider-top anim-uni-clip-in"></div>
                          <div class="mxd-tech-stack__logo">
                            <svg xmlns="http://www.w3.org/2000/svg" width="512" height="416.2" version="1.1"
                        ...
                        <div class="mxd-tech-stack__item">
                          <div class="mxd-tech-stack__divider divider-top anim-uni-clip-in"></div>
                          <div class="mxd-tech-stack__logo">
                            <svg xmlns="http://www.w3.org/2000/svg" width="212.6" height="79.4" version="1.1"
