...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Edion Web Technologies Home')
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-12 col-xl-8 mxd-grid-item">
                                    ...
                                    <div class="mxd-section-title__manifest title-manifest-s no-padding-mobile">
                                        <a class="manifest manifest-s mxd-split-lines active-cursor-accent"
                                            data-cursor-text="About us" href="{{ route('frontend.about') }}">
                                            From pixel-perfect designs to clean, flawless code, we pay attension to every
                                            little detail.
                                            <span>Every project is carefully crafted to deliver
                                                quality, performance, and an experience that truly stands out. </span></a>
                                    </div>
                                    <!-- Manifest End -->
                        ...
                        <div class="p-0 container-fluid">
                          ...
                          <span class="tag tag-m tag-medium mxd-scramble">Backend</span>
                                            ...
                                            <div class="mxd-niche-cards__descr wide">
                                                <p class="t-bold t-medium">Innovative financial solutions, from digital
                                                    banking to
                                    ...
                                    <div class="p-0 container-fluid">
                                        <div class="row g-0">
                                            <div class="col-12 mxd-grid-item">
                                                <div class="mxd-niche-cards__item">
                                                    <div
                                                        class="mxd-niche-cards__inner fixed-height-desktop space-between-desktop">
                                                        <div class="mxd-niche-cards__title">
                                                            <div class="mxd-niche-cards__name">
                                ...
                                <span class="tag tag-m tag-medium mxd-scramble">3D Models</span>
                                                        ...
                                                        <div class="mxd-niche-cards__descr wide">
                                                            <p class="t-bold t-medium">Intelligent automation, predictive
                                                                analytics,
                                            ...
                                            <div class="col-12 col-xl-6 mxd-grid-item animate-card-2">
                                                <div class="mxd-niche-cards__item">
                                                    <div
                                                        class="mxd-niche-cards__inner permanent fixed-height-desktop space-between-desktop">
                                                        <div class="mxd-niche-cards__title">
                                                            <div class="mxd-niche-cards__name">
                                ...
                                <span class="tag tag-m tag-permanent mxd-scramble">Guidelines</span>
                                                        ...
                                                        <div class="mxd-niche-cards__descr wide">
                                                            <p class="t-bold t-medium t-permanent">Advanced threat
                                                                detection, encryption solutions,
                                                ...
                                                <div class="mxd-niche-cards__item">
                                                    <div
                                                        ...
                                                        <div class="mxd-niche-cards__descr short">
                                                            <p class="t-bold t-medium">Immersive experiences, multiplayer
                                                                platforms,
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-12 col-xl-8 mxd-grid-item">
                                    <div class="mxd-section-title__title">
                                        <a class="active-cursor-accent" data-cursor-text="All Services"
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-12 col-md-6 col-xl-4 mxd-cpb-list__data">
                                            <div class="mxd-cpb-list__descr mxd-grid-item d-flex justify-content-between">
                                                ...
                                                <p class="t-large t-bold">We transform concepts into smooth, scalable,
                                                    <span> and future-ready digital
                                                        experiences.</span>
                                                </p>
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-12 col-md-6 col-xl-4 mxd-cpb-list__data">
                                            <div class="mxd-cpb-list__descr mxd-grid-item d-flex justify-content-between">
                                                ...
                                                <p class="t-large t-bold">Elegant, fast-loading web experiences designed to
                                                    <span>feel smooth, effortless and
                                                        refined.</span>
                                                </p>
                                                ...
                                                <div class="p-0 container-fluid">
                                                    <div class="row g-0">
                                                        <div class="col-6 mxd-grid-item mxd-cpb-list__meta">
                                                            ...
                                                            <span
                                                                class="meta-tag mxd-scramble online text-nowrap">E-commerce&nbsp;Solution</span>
                                                            <span
                                                                class="meta-tag mxd-scramble">Custome&nbsp;Software</span>
                                                        </div>
                                                        <div class="col-6 mxd-grid-item mxd-cpb-list__meta">
                                                            <span
                                                                class="meta-tag mxd-scramble">Mobile&nbsp;App&nbsp;Development</span>
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-12 col-md-6 col-xl-4 mxd-cpb-list__data">
                                            <div class="mxd-cpb-list__descr mxd-grid-item d-flex justify-content-between">
                                                ...
                                                <p class="t-large t-bold">Designing smooth mobile experiences that spark
                                                    creativity <span> and feel effortless to use.</span>
                                                </p>
                                                ...
                                                <div class="p-0 container-fluid">
                                                    <div class="row g-0">
                                                        <div class="col-6 mxd-grid-item mxd-cpb-list__meta">
                                                            ...
                                                            <span
                                                                class="meta-tag mxd-scramble">Email&nbsp;Marketting</span>
                                                            <span
                                                                class="meta-tag mxd-scramble">Social&nbsp;Media&nbsp;Marketting</span>
                                                        </div>
                                                        <div class="col-6 mxd-grid-item mxd-cpb-list__meta">
                                                            <span class="meta-tag mxd-scramble">PPC&nbsp;Advertising</span>
                                                            <span
                                                                class="meta-tag mxd-scramble">Content&nbsp;Marketting</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-12 col-md-6 col-xl-4 mxd-cpb-list__data">
                                            <div class="mxd-cpb-list__descr mxd-grid-item d-flex justify-content-between">
                                                ...
                                                <p class="t-large t-bold">Blending clarity and emotion to create experience
                                                    that feel <span> simple meaningful, and beautifully intuitive.
                                                    </span></p>
                                            ...
                                            <div class="mxd-cpb-list__tags">
                                                <div class="p-0 container-fluid">
                                                    <div class="row g-0">
                                                        <div class="col-6 mxd-grid-item mxd-cpb-list__meta">
                                                            <span
                                                                class="meta-tag mxd-scramble">Startup&nbsp;Solutions</span>
                                                            <span
                                                                class="meta-tag mxd-scramble">Consulting&nbsp;Services</span>
                                                            <span
                                                                class="meta-tag mxd-scramble">It&nbsp;Infrastructure</span>
                                                        </div>
                                                        <div class="col-6 mxd-grid-item mxd-cpb-list__meta">
                                                            <span
                                                                class="meta-tag mxd-scramble">Enterprice&nbsp;Solutions</span>
                                                            <span
                                                                class="meta-tag mxd-scramble">Cloud&nbsp;Slutions&nbsp;</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-12 col-md-6 col-xl-4 mxd-cpb-list__data">
                                            <div class="mxd-cpb-list__descr mxd-grid-item d-flex justify-content-between">
                                                ...
                                                <p class="t-large t-bold"> Attention to every detail ensure a stable,
                                                    polished<span> experience
                                                        user can trust with every click. </span></p>
                                            ...
                                            <div class="mxd-cpb-list__tags">
                                                <div class="p-0 container-fluid">
                                                    <div class="row g-0">
                                                        <div class="col-6 mxd-grid-item mxd-cpb-list__meta">
                                                            <span
                                                                class="meta-tag mxd-scramble">AI&nbsp;&&nbsp;Machine&nbsp;Learning</span>
                                                            <span class="meta-tag mxd-scramble">IOT&nbsp;Solutions</span>
                                                            <span
                                                                class="meta-tag mxd-scramble">Big&nbsp;Data&nbsp;Analytics</span>
                                                        </div>
                                                        <div class="col-6 mxd-grid-item mxd-cpb-list__meta">
                                                            <span
                                                                class="meta-tag mxd-scramble">Blockchain&nbsp;Solutions</span>
                                                            <span
                                                                class="meta-tag mxd-scramble">AR/VR&nbsp;Solutions&nbsp;</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-12 col-md-6 col-xl-4 mxd-cpb-list__data">
                                            <div class="mxd-cpb-list__descr mxd-grid-item d-flex justify-content-between">
                                                ...
                                                <p class="t-large t-bold">Building intelligent system where creative meets
                                                    <span> innovation to create something future-ready.
                                                    </span>
                                                </p>
                                            ...
                                            <div class="mxd-cpb-list__tags">
                                                <div class="p-0 container-fluid">
                                                    <div class="row g-0">
                                                        <div class="col-6 mxd-grid-item mxd-cpb-list__meta">
                                                            <span
                                                                class="meta-tag mxd-scramble">Content&nbsp;Creation</span>
                                                            <span class="meta-tag mxd-scramble">Content&nbsp;Audit</span>
                                                            <span
                                                                class="meta-tag mxd-scramble">Content&nbsp;Localization</span>
                                                        </div>
                                                        <div class="col-6 mxd-grid-item mxd-cpb-list__meta">
                                                            <span
                                                                class="meta-tag mxd-scramble">CopyWriting&nbsp;Services</span>
                                                            <span
                                                                class="meta-tag mxd-scramble">Content&nbsp;Management</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="mxd-section-title pre-grid">
                            <div class="p-0 container-fluid">
                                <div class="row g-0">
                                    ...
                                    <div class="col-12 col-xl-8 mxd-grid-item">
                                        <div class="mxd-section-title__title"
                                            style="position: relative; display: block; text-align: start; transform: translate(0px, 0px)">
                                            <a class="active-cursor-accent" data-cursor-text="More Works"
                                ...
                                <div class="row g-0 mxd-projects-grid__gallery">
                                    ...
                                    <div class="col-12 col-md-6 col-xl-4 mxd-project-item animate-card-3">
                                        <a class="mxd-project-item__media mxd-img-anim active-cursor-permanent"
                                            data-cursor-text="View Work" href="{{ route('frontend.works') }}">
                                            <img class="mxd-img-anim__absolute"
                                                src="{{ asset('img/works/showcase-grid-x3/pr03-06.webp') }}"
                                                alt="Project Preview Image" loading="lazy">
                                            <img class="mxd-img-anim__absolute"
                                                src="{{ asset('img/works/showcase-grid-x3/pr03-02.webp') }}"
                                                alt="Project Preview Image" loading="lazy">
                                            <img class="mxd-img-anim__absolute"
                                                src="{{ asset('img/works/showcase-grid-x3/pr03-05.webp') }}"
                                                alt="Project Preview Image" loading="lazy">
                                            <img class="mxd-img-anim__absolute"
                                                src="{{ asset('img/works/showcase-grid-x3/pr03-04.webp') }}"
                                                alt="Project Preview Image" loading="lazy">
                                            <img class="mxd-img-anim__absolute"
                                                src="{{ asset('img/works/showcase-grid-x3/pr03-03.webp') }}"
                                                alt="Project Preview Image" loading="lazy">
                                            <img class="mxd-img-anim__main"
                                                src="{{ asset('img/works/showcase-grid-x3/pr03-01.webp') }}"
                                                alt="Project Preview Image" loading="lazy">
                                        </a>
                                        <div class="mxd-project-item__caption">
                                            <div class="mxd-project-item__name">
                                                <a class="project-name-s" href="{{ route('frontend.works') }}">Creative
                                                    studio Edion</a>
                                            </div>
                                            <div class="mxd-project-item__tags">
                                                <span class="tag tag-s tag-medium mxd-scramble">Brand</span>
                                    ...
                                    <div class="col-12 col-md-6 col-xl-4 mxd-project-item animate-card-3">
                                        <a class="mxd-project-item__media mxd-img-anim active-cursor-permanent"
                                            data-cursor-text="View Work" href="{{ route('frontend.works') }}">
                                            <img class="mxd-img-anim__absolute"
                                                src="{{ asset('img/works/showcase-grid-x3/pr04-02.webp') }}"
                                                alt="Project Preview Image" loading="lazy">
                                            <img class="mxd-img-anim__absolute"
                                                src="{{ asset('img/works/showcase-grid-x3/pr04-03.webp') }}"
                                                alt="Project Preview Image" loading="lazy">
                                            <img class="mxd-img-anim__absolute"
                                                src="{{ asset('img/works/showcase-grid-x3/pr04-04.webp') }}"
                                                alt="Project Preview Image" loading="lazy">
                                            <img class="mxd-img-anim__absolute"
                                                src="{{ asset('img/works/showcase-grid-x3/pr04-05.webp') }}"
                                                alt="Project Preview Image" loading="lazy">
                                            <img class="mxd-img-anim__absolute"
                                                src="{{ asset('img/works/showcase-grid-x3/pr04-06.webp') }}"
                                                alt="Project Preview Image" loading="lazy">
                                            <img class="mxd-img-anim__absolute"
                                                src="{{ asset('img/works/showcase-grid-x3/pr04-07.webp') }}"
                                                alt="Project Preview Image" loading="lazy">
                                            <img class="mxd-img-anim__main"
                                                src="{{ asset('img/works/showcase-grid-x3/pr04-01.webp') }}"
                                                alt="Project Preview Image" loading="lazy">
                                        </a>
                                        <div class="mxd-project-item__caption">
                                            <div class="mxd-project-item__name">
                                                <a class="project-name-s"
                                                    href="{{ route('frontend.works') }}">Interactive concept</a>
                                            </div>
                                            <div class="mxd-project-item__tags">
                                                <span class="tag tag-s tag-medium mxd-scramble">Brand</span>
                                                <span class="tag tag-s tag-medium mxd-scramble">Marketing</span>
                                    ...
                                    <div class="col-12 col-md-6 col-xl-4 mxd-project-item animate-card-3">
                                        <a class="mxd-project-item__media mxd-img-anim active-cursor-permanent"
                                            data-cursor-text="View Work" href="works">
                                            <img class="mxd-img-anim__absolute"
                                                src="{{ asset('img/works/showcase-grid-x3/pr05-04.webp') }}"
                                                alt="Project Preview Image" loading="lazy">
                                            <img class="mxd-img-anim__absolute"
                                                src="{{ asset('img/works/showcase-grid-x3/pr05-05.webp') }}"
                                                alt="Project Preview Image" loading="lazy">

                                            <img class="mxd-img-anim__absolute"
                                                src="{{ asset('img/works/showcase-grid-x3/pr05-06.webp') }}"
                                                alt="Project Preview Image" loading="lazy">
                                            <img class="mxd-img-anim__absolute"
                                                src="{{ asset('img/works/showcase-grid-x3/pr05-03.webp') }}"
                                                alt="Project Preview Image" loading="lazy">
                                            <img class="mxd-img-anim__absolute"
                                                src="{{ asset('img/works/showcase-grid-x3/pr05-02.webp') }}"
                                                alt="Project Preview Image" loading="lazy">
                                            <img class="mxd-img-anim__main"
                                                src="{{ asset('img/works/showcase-grid-x3/pr05-01.webp') }}"
                                                alt="Project Preview Image" loading="lazy">
                                        </a>
                                        <div class="mxd-project-item__caption">
                                            <div class="mxd-project-item__name">
                                    ...
                                    <div class="col-12 col-md-6 col-xl-4 mxd-project-item animate-card-3">
                                        <a class="mxd-project-item__media mxd-img-anim active-cursor-permanent"
                                            data-cursor-text="View Work" href="{{ route('frontend.works') }}">
                                            <img class="mxd-img-anim__absolute"
                                                src="{{ asset('img/works/showcase-grid-x3/pr06-07.webp') }}"
                                                alt="Project Preview Image" loading="lazy">
                                            <img class="mxd-img-anim__absolute"
                                                src="{{ asset('img/works/showcase-grid-x3/pr06-06.webp') }}"
                                                alt="Project Preview Image" loading="lazy">
                                            <img class="mxd-img-anim__absolute"
                                                src="{{ asset('img/works/showcase-grid-x3/pr06-05.webp') }}"
                                                alt="Project Preview Image" loading="lazy">
                                            <img class="mxd-img-anim__absolute"
                                                src="{{ asset('img/works/showcase-grid-x3/pr06-04.webp') }}"
                                                alt="Project Preview Image" loading="lazy">
                                            <img class="mxd-img-anim__absolute"
                                                src="{{ asset('img/works/showcase-grid-x3/pr06-03.webp') }}"
                                                alt="Project Preview Image" loading="lazy">
                                            <img class="mxd-img-anim__absolute"
                                                src="{{ asset('img/works/showcase-grid-x3/pr06-02.webp') }}"
                                                alt="Project Preview Image" loading="lazy">
                                            <img class="mxd-img-anim__main"
                                                src="{{ asset('img/works/showcase-grid-x3/pr06-01.webp') }}"
                                                alt="Project Preview Image" loading="lazy">
                                        </a>
                                        <div class="mxd-project-item__caption">
                                            <div class="mxd-project-item__name">
                                    ...
                                    <div class="mxd-object-link">
                                        <div class="p-0 container-fluid">
                                            <div class="row g-0 mxd-object-link__wrap">
                                                <div class="justify-start col-12 col-md-6 col-xl-4 mxd-object-link__item">
                                                    ...
                                                    <div class="mxd-object-link__content">
                                                        ...
                                                        <a class="mxd-object-link__media mxd-img-anim active-cursor-permanent anim-uni-in-up"
                                                            ...
                                                            <img class="mxd-img-anim__absolute centered-y"
                                                                src="{{ asset('img/works/800x450_all02.webp') }}"
                                                                alt="Project Preview Image" loading="lazy">
                                                            <img class="mxd-img-anim__absolute centered-y"
                                                                src="{{ asset('img/works/800x450_all01.webp') }}"
                                                                alt="Project Preview Image" loading="lazy">
                                                            <img class="mxd-img-anim__absolute centered-y"
                                                                src="{{ asset('img/works/800x450_all04.webp') }}"
                                                                alt="Project Preview Image" loading="lazy">
                                                            <img class="mxd-img-anim__absolute centered-y"
                                                                src="{{ asset('img/works/800x450_all05.webp') }}"
                                                                alt="Project Preview Image" loading="lazy">
                                                            <img class="mxd-img-anim__absolute centered-y"
                                                                src="{{ asset('img/works/800x450_all06.webp') }}"
                                                                alt="Project Preview Image" loading="lazy">
                                                            <img class="mxd-img-anim__main"
                                                                src="{{ asset('img/works/800x450_all03.webp') }}"
                                                                alt="Project Preview Image" loading="lazy">
                                                        </a>
                                                    </div>
                                                </div>
                    ...
                    <div class="p-0 container-fluid">
                        <div class="row g-0">
                            ...
                            <div class="col-12 col-xl-4 mxd-aside-descr mxd-grid-item">
                                <p class="t-bold t-large t-aside mxd-split-lines">A powerhouse in <span>full-stack
                                        development
                                        solutions</span></p>
                            </div>
                            <!-- tech stack columns -->
                                        ...
                                        <div class="col-12 col-md-4 mxd-grid-item">
                                            ...
                                            <div class="mxd-tech-stack__column">
                                                ...
                                                <div class="mxd-tech-stack__item">
                                                    <div class="mxd-tech-stack__divider divider-top anim-uni-clip-in">
                                                    </div>
                                                    <div class="mxd-tech-stack__logo">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="256"
                                                            height="272" version="1.1" viewBox="0 0 256 272">
                                                            <path
                                                                d="M103,143.6l23.3-55.4,26.5,55.4h-49.8ZM255.1,44.7l-20.9,166.4-108.3,60-106.6-59.2L0,45.5,125.9.7l129.2,44ZM208.2,207.2L126.1,32.3,47.7,206.7l29.3-.5,15.7-39.3h70.3l17.2,39.8,28,.5Z" />
                                                        </svg>
                                                    </div>
                                                    <div class="mxd-tech-stack__name anim-uni-slide-down">
                                                        <p>Angular</p>
                                                    </div>
                                                    <div class="mxd-tech-stack__divider divider-bottom anim-uni-clip-in">
                                                    </div>
                                                </div>
                                                <!-- tech stack item -->
                                                <div class="mxd-tech-stack__item">
                                                ...
                                                <div class="mxd-tech-stack__item">
                                                    ...
                                                    <div class="mxd-tech-stack__logo">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="351.8"
                                                            height="198.8" version="1.1" viewBox="0 0 351.8 198.8">
                                                            <path
                                                ...
                                                <div class="mxd-tech-stack__item">
                                                    ...
                                                    <div class="mxd-tech-stack__logo">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="512"
                                                            height="416.2" version="1.1" viewBox="0 0 512 416.2">
                                                            <path
                                                                d="M256,96.1L200.5,0h-79.4l134.9,233.7L390.9,0h-79.4l-55.5,96.1ZM409.4,0l-153.4,265.7L102.6,0H15.7l240.3,416.2L496.3,0h-86.9Z" />
                                                        </svg>
                                                    </div>
                                                    <div class="mxd-tech-stack__name anim-uni-slide-down">
                                                        <p>Vue.js</p>
                                                ...
                                                <div class="mxd-tech-stack__item">
                                                    ...
                                                    <div class="mxd-tech-stack__logo">
                                                        <svg width="16" height="20" viewBox="0 0 16 20"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                                                d="M16 9.23077L10.6503 14.6402L16 20.0496H9.91411L7.60736 17.7171L4.56442 14.6402L9.91411 9.23077H16ZM9.91411 0L0 10.0248L3.04294 13.1017L16 0H9.91411Z" />
                                                        </svg>
                                                    </div>
                                                    <div class="mxd-tech-stack__name anim-uni-slide-down">
                                                        <p>Flutter</p>
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-12 col-xl-6 mxd-grid-item">
                                        <div class="mxd-section-title__title pre-controls-mobile">
                                            <a class="active-cursor-accent" data-cursor-text="More Posts"
                                    ...
                                    <div class="col-12 col-xl-2 mxd-grid-item">
                                        <div class="mxd-section-title__data top-controls">
                                            <div class="justify-end mxd-section-title__controls anim-uni-in-up">
                                                <a class="btn btn-line btn-line-default"
                                                    href="{{ route('frontend.home') }}">
                        ...
                        <div class="mxd-promo__wrap">
                            ...
                            <div class="mxd-promo__content">
                                ...
                                <div class="mxd-promo__caption">
                                    <a class="active-cursor-permanent" data-cursor-text="Contact Us"
