        ...
        <div class="mxd-container grid-l-container d-flex flex-column gap-5">
         <div class="d-flex flex-row justify-content-center gap-5">  
          <button id="btnYearly" onclick="toggleBill('yearwise')" class="p-4 px-4">Billed Yearly</button>
           <button id="btnMonthly" onclick="toggleBill('monthwise')" class="p-4 px-4 bg-dark text-white">Billed Monthly</button>
       </div>
                     ...
                     <div class="mxd-pricing-table__inner">
                      ...
                      <div class="mxd-pricing-table__data">
                        <div class="pricing-data__header">
                          ...
                          <p class="pricing-header__descr t-bold anim-uni-in-up">Local Businesses<span class="d-inline-block">20+ Keywords Targeted</span></p>
                        </div>
                        <div class="pricing-data__info">
                          <div class="pricing-data__price">
                            
                             <div class="pricing-data__header" id="first-card-price">
                                 <p class="pricing-header__title anim-uni-in-up" style="font-size:43px;">₹48424.26<span class="pricing-data__period"id="spanbill1" >/ Monthly + 18% tax</span></p>
                     
                             </div>
                                                         <p class="pricing-data__caption t-small t-muted t-140 anim-uni-in-up">2 Location Served</p>

                            <p class="pricing-data__caption t-small t-muted t-140 anim-uni-in-up">Expected Results: 3-6 Months</p>
                            <p class="pricing-data__caption t-small t-muted t-140 anim-uni-in-up">SEO Strategy: Technical SEO, On-Page & Backlinks</p>
                          </div>
                          <div class="pricing-data__btnholder anim-uni-in-up">
                            <a class="btn btn-default-icon btn-default-outline btn-default-fullwidth slide-right" href="/contact">
                         ...
                         <div class="pricing-plan__list extra-content d-none price-card">
                            <ul class="mxd-check-list">
                             ...
                             <li class="anim-uni-in-up">
                              <!-- <i class="ph ph-check"></i> -->
                               ...
                               <span class="online text-wrap">Complete meta tag optimization for all selected pages: Up to 20 Pages</span>
                              </li>
                             <li class="anim-uni-in-up">
                              <!-- <i class="ph ph-check"></i> -->
                               <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" version="1.1" viewBox="0 0 18 18">
                             ...
                             <li class="anim-uni-in-up">
                              <!-- <i class="ph ph-check"></i> -->
                               ...
                               <span class="online text-wrap">Category Pages Content Optimization: Up to 5 Pages per Month</span>
                              </li>
                              <li class="anim-uni-in-up">
                              <!-- <i class="ph ph-check"></i> -->
                               <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" version="1.1" viewBox="0 0 18 18">
                            ...
                            <li class="anim-uni-in-up">
                              <!-- <i class="ph ph-check"></i> -->
                               ...
                               <span class="online text-wrap">PR on Authoritative News Sites (DR 40 - DR 80): 0 per Month</span>
                              </li>
                            <li class="anim-uni-in-up">
                              <!-- <i class="ph ph-check"></i> -->
                               <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" version="1.1" viewBox="0 0 18 18">
                            ...
                            <li class="anim-uni-in-up">
                              <!-- <i class="ph ph-check"></i> -->
                               ...
                               <span class="online text-wrap">Google Pagespeed Test & Optimization: Recommendations for site speed improvement.</span>
                              </li>
                            <li class="anim-uni-in-up">
                              <!-- <i class="ph ph-check"></i> -->
                               <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" version="1.1" viewBox="0 0 18 18">
                               ...
                               <span class="online text-wrap">Speed Optimization (Desktop/Mobile): Recommendations + One-time Fixation.</span>
                              </li>
                            <li class="anim-uni-in-up">
                              <!-- <i class="ph ph-check"></i> -->
                               <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" version="1.1" viewBox="0 0 18 18">
                            ...
                            <li class="anim-uni-in-up">
                              <!-- <i class="ph ph-check"></i> -->
                                <img 
                                   src="img/icons/remove.webp" 
                                   alt="remove icon"
                                   class="bg-danger rounded-circle p-1"
                                   style="height:20px; width:20px; object-fit:contain;"
                                    >
                               <span class="online text-wrap">Structured Data Implementation (If Required): for CMS, for WordPress</span>
                              </li>
                            <li class="anim-uni-in-up">
                              <!-- <i class="ph ph-check"></i> -->
                               <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" version="1.1" viewBox="0 0 18 18">
                            ...
                            <li class="anim-uni-in-up">
                              ...
                              <!-- <i class="ph ph-check"></i> -->
                               ...
                               <span class="online text-wrap">Link Detox (Spam Link Removal): Ensure 80-90% location-based links</span>
                              </li>
                      ...
                      <div class="mxd-pricing-table__data">
                        <div class="pricing-data__header">
                          ...
                          <p class="pricing-header__descr t-bold anim-uni-in-up">Growing Enterprises
                            <span>40+ Keywords Targeted</span></p>
                        </div>
                        <div class="pricing-data__info">
                          <div class="pricing-data__price">
                            
                            <div class="pricing-data__header" id="second-card-price">
                                 <p class="pricing-header__title anim-uni-in-up" style="font-size:43px;">₹62951.54<span class="pricing-data__period" >/Monthly + 18% tax</span></p>
              
                             </div>

                            <p class="pricing-data__caption t-small t-muted t-140 anim-uni-in-up">3 Locations Served Expected Results: 3-6 Months</p>
                            <p class="pricing-data__caption t-small t-muted t-140 anim-uni-in-up">SEO Strategy: Advanced SEO & Content Strategy</p>
                          </div>
                          <div class="pricing-data__btnholder anim-uni-in-up">
                            <a class="btn btn-default-icon btn-default-outline btn-default-fullwidth slide-right" href="/contact">
                              <span class="btn-caption mxd-scramble">Buy Now</span>
                     ...
                     <div class="mxd-pricing-table__inner">
                      ...
                      <div class="mxd-pricing-table__data">
                        <div class="pricing-data__header">
                          ...
                          <p class="pricing-header__descr t-bold anim-uni-in-up">Established Brands<span class="d-inline-block"> 80+ Keywords Targeted</span></p>
                        </div>
{{-- 
                        <div class="pricing-data__header">
                          <p class="pricing-header__title anim-uni-in-up">STANDARD <span>SEO Package</span></p>
                        ...
                        <div class="pricing-data__info">
                          <div class="pricing-data__price">
                             ...
                             <div class="pricing-data__header" id="third-card-price">
                                 <p class="pricing-header__title anim-uni-in-up" style="font-size:43px;">₹87163.67<span class="pricing-data__period" >/Monthly +18% tax</span></p>
              
                             </div>
                            <p class="pricing-data__caption t-small t-muted t-140 anim-uni-in-up">All Locations Served</p>
                            <p class="pricing-data__caption t-small t-muted t-140 anim-uni-in-up">Expected Results: 3-6 Months</p>
                            <p class="pricing-data__caption t-small t-muted t-140 anim-uni-in-up">SEO Strategy: Full-Scale SEO & Branding</p>
                          </div>
                          <div class="pricing-data__btnholder anim-uni-in-up">
                            <a class="btn btn-default-icon btn-default-outline btn-default-fullwidth slide-right" href="/contact">
                              <span class="btn-caption mxd-scramble" >Buy Now</span>
                      ...
                      <div class="mxd-pricing-table__data">
                        <div class="pricing-data__header">
                          ...
                          <p class="pricing-header__descr t-bold anim-uni-in-up">Large Enterprises 
                            <span class="d-inline-block">200+ Keywords Targeted</span></p>
                        </div>
                        <div class="pricing-data__info">
                          <div class="pricing-data__price">
                            
                            <div class="pricing-data__header" id="fourth-card-price">
                                 <p class="pricing-header__title anim-uni-in-up" style="font-size:43px;"> ₹154957.63 <span class="pricing-data__period" >/Monthly + 18% tax</span></p>
                        ...
                        <div class="row g-0">
                          <div class="col-12 col-lg-4 mxd-clients__item mxd-grid-item animate-card-3">
                            ...
                            <div class="mxd-clients__descr">
                              <p class="t-medium">Aliquam suscipit eros sed turpis tristique sagittis. Integer iaculis risus urna.</p>
                            </div>
                          </div>
                          <div class="col-12 col-lg-4 mxd-clients__item mxd-grid-item animate-card-3">
                            <div class="mxd-clients__logo">
        ...
        <div class="mxd-container fullwidth-container">
          <div class="mxd-divider">
            <div class="mxd-divider__video">
              <video class="video parallax-video" preload="auto" autoplay muted loop playsinline poster="video/1280x720_video-05.webp">
                    ...
                    <div class="col-12 col-xl-4 mxd-grid-item">
                      <div class="mxd-section-title__data top-controls">
                        <div class="mxd-section-title__controls anim-uni-in-up">
                          <a class="btn btn-line btn-line-default" href="blog-creative.html">
