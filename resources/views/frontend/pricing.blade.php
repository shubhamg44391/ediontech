                  ...
                  <div class="mxd-pricing-table__inner">
                    ...
                    <div class="pricing-plan__list extra-content d-none price-card">
                      <ul class="mxd-check-list">
                        ...
                        <li class="anim-uni-in-up">
                          <!-- <i class="ph ph-check"></i> -->
                          <img src="{{ asset('img/icons/remove.webp') }}" alt="remove icon" class="bg-danger rounded-circle p-1"
                      ...
                      <div class="row g-0">
                        <div class="col-12 col-lg-4 mxd-clients__item mxd-grid-item animate-card-3">
                          <div class="mxd-clients__logo">
                            ...
                            <!-- <img src="{{ asset('img/brands/dribbble.svg') }}" alt="Azurio Template Image Example"> -->
                          </div>
                        ...
                        <div class="col-12 col-lg-4 mxd-clients__item mxd-grid-item animate-card-3">
                          <div class="mxd-clients__logo">
                            ...
                            <!-- <img src="{{ asset('img/brands/logitech.svg') }}" alt="Azurio Template Image Example"> -->
                          </div>
                          <div class="mxd-clients__descr">
                            <p class="t-medium">Aliquam suscipit eros sed turpis tristique sagittis. Integer iaculis risus
                              urna.</p>
                        ...
                        <div class="col-12 col-lg-4 mxd-clients__item mxd-grid-item animate-card-3">
                          <div class="mxd-clients__logo">
                            ...
                            <!-- <img src="{{ asset('img/brands/envato.svg') }}" alt="Azurio Template Image Example"> -->
                          </div>
                          <div class="mxd-clients__descr">
                            <p class="t-medium">Aliquam suscipit eros sed turpis tristique sagittis. Integer iaculis risus
                              urna.</p>
                      ...
                      <div class="row g-0">
                        <div class="col-12 col-lg-4 mxd-clients__item mxd-grid-item animate-card-3">
                          <div class="mxd-clients__logo">
                            ...
                            <!-- <img src="{{ asset('img/brands/crewai.svg') }}" alt="Azurio Template Image Example"> -->
                          </div>
                          <div class="mxd-clients__descr">
                            <p class="t-medium">Aliquam suscipit eros sed turpis tristique sagittis. Integer iaculis risus
                              urna.</p>
                        ...
                        <div class="col-12 col-lg-4 mxd-clients__item mxd-grid-item animate-card-3">
                          <div class="mxd-clients__logo">
                            ...
                            <!-- <img src="{{ asset('img/brands/deepseek.svg') }}" alt="Azurio Template Image Example"> -->
                          </div>
                          <div class="mxd-clients__descr">
                            <p class="t-medium">Aliquam suscipit eros sed turpis tristique sagittis. Integer iaculis risus
                              urna.</p>
                        ...
                        <div class="col-12 col-lg-4 mxd-clients__item mxd-grid-item animate-card-3">
                          <div class="mxd-clients__logo">
                            ...
                            <!-- <img src="{{ asset('img/brands/mozilla.svg') }}" alt="Azurio Template Image Example"> -->
                          </div>
                          <div class="mxd-clients__descr">
                            <p class="t-medium">Aliquam suscipit eros sed turpis tristique sagittis. Integer iaculis risus
                              urna.</p>
                      ...
                      <div class="row g-0">
                        <div class="col-12 col-lg-4 mxd-clients__item mxd-grid-item animate-card-3">
                          <div class="mxd-clients__logo">
                            ...
                            <!-- <img src="{{ asset('img/brands/udemy.svg') }}" alt="Azurio Template Image Example"> -->
                          </div>
                          <div class="mxd-clients__descr">
                            <p class="t-medium">Aliquam suscipit eros sed turpis tristique sagittis. Integer iaculis risus
                              urna.</p>
                        ...
                        <div class="col-12 col-lg-4 mxd-clients__item mxd-grid-item animate-card-3">
                          <div class="mxd-clients__logo">
                            ...
                            <!-- <img src="{{ asset('img/brands/angular.svg') }}" alt="Azurio Template Image Example"> -->
                          </div>
                          <div class="mxd-clients__descr">
                            <p class="t-medium">Aliquam suscipit eros sed turpis tristique sagittis. Integer iaculis risus
                              urna.</p>
                        ...
                        <div class="col-12 col-lg-4 mxd-clients__item mxd-grid-item animate-card-3">
                          <div class="mxd-clients__logo">
                            ...
                            <!-- <img src="{{ asset('img/brands/ghostgaming.svg') }}" alt="Azurio Template Image Example"> -->
                          </div>
                          <div class="mxd-clients__descr">
                            <p class="t-medium">Aliquam suscipit eros sed turpis tristique sagittis. Integer iaculis risus
                              urna.</p>
