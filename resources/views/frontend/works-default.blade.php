...
@section('main-container')
    ...
    <main id="mxd-page-content" class="mxd-page-content">
                              ...
                              <div class="row g-0">
                                <div class="col-12 col-xl-10 mxd-grid-item">
                                  <div class="inner-headline__link loading-fade">
                                    <a class="btn btn-line btn-line-permanent" href="#portfolio">
                                      <span class="btn-caption mxd-scramble">Portfolio</span>
                                    </a>
                                  </div>
                                  <div class="inner-headline__title">
                                    <h1 class="medium permanent loading-split">Where bold ideas <span>take shape</span></h1>
                                  </div>
                                </div>
                                <div class="col-12 col-xl-2 mxd-grid-item">
                                  <div class="inner-headline__btngroup align-end-desktop tags-medium-title loading-fade">
                                    <a class="btn btn-line-icon btn-line-icon-small btn-line-permanent slide-down" href="#portfolio">
      ...
      <!-- Section - Projects Stack Start -->
      <div id="portfolio" class="mxd-section">
        <div class="mxd-container fullwidth-container">

          <!-- Block - Progects Stack Start -->
          <div class="mxd-block">
            <div class="mxd-stack-cards">
              <!-- single card -->
              <div class="mxd-stack-cards__card">
                <div class="card__marquees">
                  <!-- Marquee Divider Start -->
                  <div class="marquee marquee-stack marquee--gsap muted-extra">
                    <div class="marquee__top">
                      <!-- single item -->
                      <div class="marquee__item item-regular text">
                        <p class="marquee__text text-with-gliph">Projects/</p>
                      </div>
                      <!-- single item -->
                      <div class="marquee__item item-regular text">
                        <p class="marquee__text text-with-gliph">Cases/</p>
                      </div>
                      <!-- single item -->
                      <div class="marquee__item item-regular text">
                        <p class="marquee__text text-with-gliph">Works/</p>
                      </div>
                      <!-- single item -->
                      <div class="marquee__item item-regular text">
                        <p class="marquee__text text-with-gliph">Editorial/</p>
                      </div>
                      <!-- single item -->
                      <div class="marquee__item item-regular text">
                        <p class="marquee__text text-with-gliph">Experiments/</p>
                      </div>
                    </div>
                  ...
                  <div class="card__content">
                    <div class="card__descr">
                      <div class="card__tags">
                        <span class="tag tag-m tag-permanent mxd-scramble">Design</span>
                        <span class="tag tag-m tag-permanent mxd-scramble">Illustrations</span>
                        <span class="tag tag-m tag-permanent mxd-scramble">Packaging</span>
      ...
      <!-- Section - Projects Stack End -->

      <!-- Section - Projects List Start -->
                  ...
                  <div class="row g-0 d-flex flex-column-reverse flex-xl-row">
                    <div class="col-12 col-xl-8 mxd-grid-item">
                      <div class="mxd-section-title__title">
                        <h2 class="reveal-type">Projects archive</h2>
                      </div>
                    </div>
                    ...
                    <div class="row gx-0">
                      <div class="col-12 col-xl-2 mxd-grid-padding">
                        <div class="mxd-projects-list__niche">
                          <span class="meta-niche mxd-scramble">Tech</span>
                        </div>
                      </div>
                      <div class="col-12 col-xl-6 mxd-grid-padding">
                        <div class="mxd-projects-list__title">
                          <h3>Creative <span>studio<br>template</span></h3>
                        </div>
                      </div>
                      <div class="col-6 col-md-6 col-xl-2 mxd-grid-padding">
                        <div class="mxd-projects-list__meta">
                          <span class="meta-tag mxd-scramble">Brand</span>
                          <span class="meta-tag mxd-scramble">Marketing</span>
                          <span class="meta-tag mxd-scramble">Website</span>
                        </div>
                      </div>
                      <div class="col-6 col-md-6 col-xl-2 mxd-grid-padding">
                        <div class="mxd-projects-list__date">
                          <span class="meta-date mxd-scramble">January</span>
                          <span class="meta-date mxd-scramble">2026</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <a class="mxd-projects-list__item active-cursor-image active-cursor-permanent" data-cursor-image="img/works/showcase-stack/pr03.webp" data-cursor-text="View Work" href="project-details.html">
                  ...
                  <div class="container-fluid px-0 mxd-projects-list__inner">
                    <div class="row gx-0">
                      <div class="col-12 col-xl-2 mxd-grid-padding">
                        <div class="mxd-projects-list__niche">
                          <span class="meta-niche mxd-scramble">Fashion</span>
                        </div>
                      </div>
                      <div class="col-12 col-xl-6 mxd-grid-padding">
                        <div class="mxd-projects-list__title">
                          <h3>Editorial<br><span>illustrations set</span></h3>
                        </div>
                      </div>
                      <div class="col-6 col-md-6 col-xl-2 mxd-grid-padding">
                        <div class="mxd-projects-list__meta">
                          <span class="meta-tag mxd-scramble">Midjourney</span>
                          <span class="meta-tag mxd-scramble">Illustrations</span>
                          <span class="meta-tag mxd-scramble">Design</span>
                        </div>
                      </div>
                      <div class="col-6 col-md-6 col-xl-2 mxd-grid-padding">
                        <div class="mxd-projects-list__date">
                          <span class="meta-date mxd-scramble">November</span>
                          <span class="meta-date mxd-scramble">2025</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <a class="mxd-projects-list__item active-cursor-image active-cursor-permanent" data-cursor-image="img/works/showcase-stack/pr02.webp" data-cursor-text="View Work" href="project-details.html">
                  ...
                  <div class="container-fluid px-0 mxd-projects-list__inner">
                    <div class="row gx-0">
                      <div class="col-12 col-xl-2 mxd-grid-padding">
                        <div class="mxd-projects-list__niche">
                          <span class="meta-niche mxd-scramble">Pets</span>
                        </div>
                      </div>
                      <div class="col-12 col-xl-6 mxd-grid-padding">
                        <div class="mxd-projects-list__title">
                          <h3>Interactive <span>media<br>concept</span></h3>
                        </div>
                      </div>
                      <div class="col-6 col-md-6 col-xl-2 mxd-grid-padding">
                        <div class="mxd-projects-list__meta">
                          <span class="meta-tag mxd-scramble">Brand</span>
                          <span class="meta-tag mxd-scramble">Social Media</span>
                          <span class="meta-tag mxd-scramble">Packaging</span>
                        </div>
                      </div>
                      <div class="col-6 col-md-6 col-xl-2 mxd-grid-padding">
                        <div class="mxd-projects-list__date">
                          <span class="meta-date mxd-scramble">October</span>
                          <span class="meta-date mxd-scramble">2025</span>
                        </div>
                      </div>
                    </div>
                ...
                <a class="mxd-projects-list__item active-cursor-image active-cursor-permanent" data-cursor-image="img/services/services-stack/pr02.webp" data-cursor-text="View Work" href="{{ route('frontend.works') }}">
                  ...
                  <div class="container-fluid px-0 mxd-projects-list__inner">
                    <div class="row gx-0">
                      <div class="col-12 col-xl-2 mxd-grid-padding">
                        <div class="mxd-projects-list__niche">
                          <span class="meta-niche mxd-scramble">Mobile</span>
                        </div>
                      </div>
                      <div class="col-12 col-xl-6 mxd-grid-padding">
                        <div class="mxd-projects-list__title">
                          <h3>Mobile <span>app<br>design</span></h3>
                        </div>
                      </div>
                      <div class="col-6 col-md-6 col-xl-2 mxd-grid-padding">
                        <div class="mxd-projects-list__meta">
                          <span class="meta-tag mxd-scramble">UI/UX</span>
                          <span class="meta-tag mxd-scramble">Design</span>
                          <span class="meta-tag mxd-scramble">Android</span>
                        </div>
                      </div>
                      <div class="col-6 col-md-6 col-xl-2 mxd-grid-padding">
                        <div class="mxd-projects-list__date">
                          <span class="meta-date mxd-scramble">September</span>
                          <span class="meta-date mxd-scramble">2025</span>
                        </div>
                      </div>
                    </div>
                ...
                <a class="mxd-projects-list__item active-cursor-image active-cursor-permanent" data-cursor-image="img/cta/mar_09.webp" data-cursor-text="View Work" href="project-details.html">
                  ...
                  <div class="container-fluid px-0 mxd-projects-list__inner">
                    <div class="row gx-0">
                      ...
                      <div class="col-12 col-xl-6 mxd-grid-padding">
                        <div class="mxd-projects-list__title">
                          <h3>Illustrations <span>set<br>for print</span></h3>
                        </div>
                      </div>
                      <div class="col-6 col-md-6 col-xl-2 mxd-grid-padding">
                        <div class="mxd-projects-list__meta">
                          <span class="meta-tag mxd-scramble">Illustration</span>
                          <span class="meta-tag mxd-scramble">Design</span>
                          <span class="meta-tag mxd-scramble">Packaging</span>
                        </div>
                      </div>
                      <div class="col-6 col-md-6 col-xl-2 mxd-grid-padding">
                        <div class="mxd-projects-list__date">
                          <span class="meta-date mxd-scramble">August</span>
                          <span class="meta-date mxd-scramble">2025</span>
                        </div>
                      </div>
                    </div>
      ...
      <div id="testimonials" class="mxd-section blur-section padding-top-title padding-bottom-default">
        <div class="mxd-container grid-l-container">
                        ...
                        <div class="col-12 col-xl-7 mxd-grid-item mxd-testimonials-sticky__column margin-bottom-mobile">
                          ...
                          <div class="mxd-testimonials-card">
                            ...
                            <div class="mxd-testimonials-card__content">
                              <p class="mxd-testimonials-card__descr">Working with Edion team was <span>an absolute pleasure!</span></p>
                            </div>
                      ...
                      <div class="row g-0">
                        ...
                        <div class="col-12 col-xl-6 mxd-grid-item mxd-testimonials-sticky__column">
                          ...
                          <div class="mxd-testimonials-card">
                            ...
                            <div class="mxd-testimonials-card__content">
                              <p class="mxd-testimonials-card__descr">The Edion team nailed it! They understood our vision <span>and delivered a sleek, intuitive site that our clients love.</span></p>
                            </div>
                            <div class="mxd-testimonials-card__author">
                              <div class="mxd-testimonials-card__photo">
