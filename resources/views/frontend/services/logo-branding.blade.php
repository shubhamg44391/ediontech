...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li aria-current="page">Logo and branding</li></ol></nav>
 <p class="eyebrow">Design</p>
 <h1 style="margin-top:var(--sp-4)">Identity systems with the rules to apply them</h1>
 <p class="lead">Marks, type systems, colour and the usage guidance that keeps them consistent once twelve different people start using them.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>Full system</b><span>Not just a mark</span></div><div class="lp-fact"><b>All formats</b><span>Print, screen, social</span></div><div class="lp-fact"><b>Guidelines</b><span>So others get it right</span></div></div>
</section>
...
<section class="band shell">
 <div class="article">
 <div class="article__body"><h2>A logo is not an identity</h2><p>What you need is the mark plus the system: type scale, colour roles, spacing rules and asset files in every format your team will actually reach for.</p><h2>Built to survive delegation</h2><p>Guidelines exist so the person making a social post in eighteen months gets it right without asking you.</p></div>
 <aside class="aside">
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Design</p><ul><li><a href="{{ url('/website-design') }}">Website design</a></li><li><a href="{{ url('/mobile-app-design') }}">Mobile app design</a></li><li><a href="{{ url('/ui-ux-design') }}">UI/UX design</a></li></ul></div>
