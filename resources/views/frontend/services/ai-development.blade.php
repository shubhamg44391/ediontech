...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'AI and machine learning development | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Document processing, forecasting, classification, retrieval and practical automation. We start by asking whether a model is actually the right tool.')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'ai and machine learning development, ai development, Edion Web Technologies')

@section('main-container')
<main id="main"><a id="top"></a>

<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li aria-current="page">AI and <b class="kw2">machine learning</b> development</li></ol></nav>
 <p class="eyebrow">Technology</p>
 <h1 style="margin-top:var(--sp-4)">AI where it does a job, not where it makes a headline</h1>
 <p class="lead">Document processing, forecasting, classification, retrieval and practical automation. We start by asking whether a model is actually the right tool.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>Scoped narrow</b><span>One task, done reliably</span></div><div class="lp-fact"><b>Evaluated</b><span>Measurement before deployment</span></div><div class="lp-fact"><b>Your data</b><span>Stays yours</span></div></div>
</section>
...
<section class="band shell">
 <div class="article">
 <div class="article__body"><h2>Most AI projects should be smaller</h2><p>The version that works is usually narrower than the version proposed. One task done reliably beats a general assistant that is right most of the time.</p><h2>Evaluation before deployment</h2><p>We build the measurement harness first. Without it you cannot tell whether a change made the system better or just different.</p></div>
 <aside class="aside">
...
<section class="band band--ink">
 <div class="shell">
 <div class="sec-head" data-reveal>
 <div><p class="eyebrow">Related</p><h2>Other technology work</h2></div>
 </div>
 <div class="linkmatrix" data-reveal>
 <div><p class="lbl">Technology</p><ul><li><a href="{{ url('/cloud-solutions') }}">Cloud solutions</a></li><li><a href="{{ url('/iot-solutions') }}">IoT solutions</a></li><li><a href="{{ url('/big-data-analytics') }}">Big data analytics</a></li></ul></div>
