...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Cloud solutions | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Migration, cost control and reliability engineering. Mostly this means removing things you are paying for and not using.')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'cloud solutions, cloud solutions, Edion Web Technologies')

@section('main-container')
<main id="main"><a id="top"></a>

<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li aria-current="page"><b class="kw">Cloud solutions</b></li></ol></nav>
 <p class="eyebrow">Technology</p>
 <h1 style="margin-top:var(--sp-4)">Cloud work aimed at reliability and cost, not certificates</h1>
 <p class="lead">Migration, cost control and reliability engineering. Mostly this means removing things you are paying for and not using.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>Cost audit</b><span>Usually pays for itself</span></div><div class="lp-fact"><b>Runbooks</b><span>Documented incident response</span></div><div class="lp-fact"><b>Monitored</b><span>Alerting on what matters</span></div></div>
</section>
...
<section class="band shell">
 <div class="article">
 <div class="article__body"><h2>Cost control is engineering</h2><p>Right-sizing, reserved capacity, storage lifecycle rules and killing idle resources. We have cut client bills by meaningful percentages without touching functionality.</p><h2>Reliability you can evidence</h2><p>Monitoring, alerting and a runbook, so an incident at 2am has a documented response rather than an improvised one.</p></div>
 <aside class="aside">
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Technology</p><ul><li><a href="{{ url('/ai-development') }}">AI and machine learning development</a></li><li><a href="{{ url('/iot-solutions') }}">IoT solutions</a></li><li><a href="{{ url('/big-data-analytics') }}">Big data analytics</a></li></ul></div>
