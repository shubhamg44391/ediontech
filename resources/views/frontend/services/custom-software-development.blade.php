...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li aria-current="page"><b class="kw">Custom software development</b></li></ol></nav>
 <p class="eyebrow">Build</p>
 <h1 style="margin-top:var(--sp-4)">Line-of-business software that gets cheaper to run as you grow</h1>
 <p class="lead">Bookings, inventory, dispatch, billing and internal tools. The systems that are specific enough to your operation that no off-the-shelf product fits, and important enough that they cannot go down.</p>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Build</p><ul><li><a href="{{ url('/website-development') }}">Website development</a></li><li><a href="{{ url('/mobile-app-development') }}">Mobile app development</a></li><li><a href="{{ url('/ecommerce-development') }}">E-commerce development</a></li><li><a href="{{ url('/cms-development') }}">CMS development</a></li></ul></div>
 <div><p class="lbl">By market</p><ul><li><a href="{{ url('/custom-software-development-dubai') }}">Custom software development in Dubai</a></li><li><a href="{{ url('/custom-software-development-abu-dhabi') }}">Custom software development in Abu Dhabi</a></li><li><a href="{{ url('/custom-software-development-sharjah') }}">Custom software development in Sharjah</a></li><li><a href="{{ url('/custom-software-development-amman') }}">Custom software development in Amman</a></li><li><a href="{{ url('/custom-software-development-manama') }}">Custom software development in Manama</a></li><li><a href="{{ url('/custom-software-development-riyadh') }}">Custom software development in Riyadh</a></li></ul></div>
 <div><p class="lbl">By industry</p><ul><li><a href="{{ url('/custom-software-development-for-travel-tourism') }}">For travel and tourism</a></li><li><a href="{{ url('/custom-software-development-for-hospitality') }}">For hospitality</a></li><li><a href="{{ url('/custom-software-development-for-logistics') }}">For logistics and transport</a></li><li><a href="{{ url('/custom-software-development-for-healthcare') }}">For healthcare</a></li><li><a href="{{ url('/custom-software-development-for-real-estate') }}">For real estate</a></li></ul></div>
 </div>
 </div>
</section>
