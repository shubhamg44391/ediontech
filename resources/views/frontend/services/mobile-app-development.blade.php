...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Mobile app development | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Native iOS and Android, or Flutter where cross-platform genuinely fits. We choose based on what your team can hire for and maintain, not on what is fashionab')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'mobile app development, mobile app development, Edion Web Technologies')

@section('main-container')
<main id="main"><a id="top"></a>

<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li aria-current="page"><b class="kw">Mobile app development</b></li></ol></nav>
 <p class="eyebrow">Build</p>
 <h1 style="margin-top:var(--sp-4)">Apps shipped to both stores, and maintained after</h1>
 <p class="lead">Native iOS and Android, or <span class="kw kw--tech">Flutter</span> where cross-platform genuinely fits. We choose based on what your team can hire for and maintain, not on what is fashionable this year.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>Both stores</b><span>Submission handled</span></div><div class="lp-fact"><b>Flutter or native</b><span>Chosen on your constraints</span></div><div class="lp-fact"><b>6-9 wks</b><span>Typical build</span></div></div>
</section>
