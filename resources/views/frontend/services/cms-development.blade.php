...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'CMS development | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Content models that match how your team actually works, with editing interfaces that do not require a developer to publish a page.')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'cms development, cms development, Edion Web Technologies')

@section('main-container')
<main id="main"><a id="top"></a>

<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li aria-current="page">CMS development</li></ol></nav>
 <p class="eyebrow">Build</p>
 <h1 style="margin-top:var(--sp-4)">An editor your marketing team can use without a ticket</h1>
 <p class="lead">Content models that match how your team actually works, with editing interfaces that do not require a developer to publish a page.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>No tickets</b><span>Marketing publishes independently</span></div><div class="lp-fact"><b>Structured</b><span>Content models, not blobs</span></div><div class="lp-fact"><b>Preview</b><span>See it before it goes live</span></div></div>
</section>
...
<section class="band shell">
 <div class="article">
 <div class="article__body"><h2>Model the content, not the page</h2><p>Pages built as freeform blobs become unmaintainable within a year. We model content types properly so a redesign does not mean re-entering everything.</p><h2>Publishing without fear</h2><p>Preview, scheduled publishing and revision history, so your team can move quickly without worrying about breaking the live site.</p></div>
 <aside class="aside">
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Build</p><ul><li><a href="{{ url('/website-development') }}">Website development</a></li><li><a href="{{ url('/custom-software-development') }}">Custom software development</a></li><li><a href="{{ url('/mobile-app-development') }}">Mobile app development</a></li><li><a href="{{ url('/ecommerce-development') }}">E-commerce development</a></li></ul></div>
