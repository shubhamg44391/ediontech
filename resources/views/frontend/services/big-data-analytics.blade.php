...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li aria-current="page">Big data analytics</li></ol></nav>
 <p class="eyebrow">Technology</p>
 <h1 style="margin-top:var(--sp-4)">Reporting people actually trust</h1>
 <p class="lead">Warehousing, pipelines and reporting built so that two people asking the same question get the same answer.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>Defined metrics</b><span>Agreed before build</span></div><div class="lp-fact"><b>Alerting</b><span>Failures surface immediately</span></div><div class="lp-fact"><b>Self-serve</b><span>Without asking engineering</span></div></div>
</section>
...
<section class="band shell">
 <div class="article">
 <div class="article__body"><h2>Definitions before dashboards</h2><p>Most reporting distrust comes from undefined metrics. We agree what 'active customer' means before building anything that counts them.</p><h2>Pipelines that fail loudly</h2><p>A silent pipeline failure produces confidently wrong numbers. Ours alert rather than degrading quietly.</p></div>
 <aside class="aside">
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Technology</p><ul><li><a href="{{ url('/ai-development') }}">AI and machine learning development</a></li><li><a href="{{ url('/cloud-solutions') }}">Cloud solutions</a></li><li><a href="{{ url('/iot-solutions') }}">IoT solutions</a></li></ul></div>
