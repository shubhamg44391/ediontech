...
<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li aria-current="page"><b class="kw">Website development</b></li></ol></nav>
 <p class="eyebrow">Build</p>
 <h1 style="margin-top:var(--sp-4)">Websites that load fast and survive real content</h1>
 <p class="lead">Marketing sites through to complex web applications, built to stay maintainable after we hand them over. Clean markup, sensible dependencies, and code your next developer can read.</p>
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Build</p><ul><li><a href="{{ url('/custom-software-development') }}">Custom software development</a></li><li><a href="{{ url('/mobile-app-development') }}">Mobile app development</a></li><li><a href="{{ url('/ecommerce-development') }}">E-commerce development</a></li><li><a href="{{ url('/cms-development') }}">CMS development</a></li></ul></div>
 <div><p class="lbl">By market</p><ul><li><a href="{{ url('/website-development-dubai') }}">Website development in Dubai</a></li><li><a href="{{ url('/website-development-abu-dhabi') }}">Website development in Abu Dhabi</a></li><li><a href="{{ url('/website-development-sharjah') }}">Website development in Sharjah</a></li><li><a href="{{ url('/website-development-amman') }}">Website development in Amman</a></li><li><a href="{{ url('/website-development-manama') }}">Website development in Manama</a></li><li><a href="{{ url('/website-development-riyadh') }}">Website development in Riyadh</a></li></ul></div>
 <div><p class="lbl">By industry</p><ul><li><a href="{{ url('/website-development-for-travel-tourism') }}">For travel and tourism</a></li><li><a href="{{ url('/website-development-for-hospitality') }}">For hospitality</a></li><li><a href="{{ url('/website-development-for-logistics') }}">For logistics and transport</a></li><li><a href="{{ url('/website-development-for-healthcare') }}">For healthcare</a></li><li><a href="{{ url('/website-development-for-real-estate') }}">For real estate</a></li></ul></div>
 </div>
 </div>
</section>
