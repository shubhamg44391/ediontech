...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'UI/UX design | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Research, flows, prototypes and interface design for products where usability has a direct operational cost.')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'ui/ux design, ui ux design, Edion Web Technologies')

@section('main-container')
<main id="main"><a id="top"></a>

<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li aria-current="page">UI/UX design</li></ol></nav>
 <p class="eyebrow">Design</p>
 <h1 style="margin-top:var(--sp-4)">Interfaces people use without a manual</h1>
 <p class="lead">Research, flows, prototypes and interface design for products where usability has a direct operational cost.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>Task-measured</b><span>Completion, not aesthetics</span></div><div class="lp-fact"><b>Accessible</b><span>Keyboard and contrast tested</span></div><div class="lp-fact"><b>Documented</b><span>Design system handover</span></div></div>
</section>
...
<section class="band shell">
 <div class="article">
 <div class="article__body"><h2>Count the clicks</h2><p>For internal tools used forty times a day, every removed step is real money. We measure task completion, not visual appeal.</p><h2>Accessibility is not optional</h2><p>Keyboard navigation, visible focus, sufficient contrast and reduced-motion support are built in, not retrofitted after an audit.</p></div>
 <aside class="aside">
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Design</p><ul><li><a href="{{ url('/website-design') }}">Website design</a></li><li><a href="{{ url('/logo-branding') }}">Logo and branding</a></li><li><a href="{{ url('/mobile-app-design') }}">Mobile app design</a></li></ul></div>
