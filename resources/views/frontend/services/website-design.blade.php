...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'Website design | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Structure and page design that survives contact with real content, real photography and real word counts. Clickable prototypes you review before anything get')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'website design, website design, Edion Web Technologies')

@section('main-container')
<main id="main"><a id="top"></a>

<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li aria-current="page">Website design</li></ol></nav>
 <p class="eyebrow">Design</p>
 <h1 style="margin-top:var(--sp-4)">Design that starts with the flow, not the homepage</h1>
 <p class="lead">Structure and page design that survives contact with real content, real photography and real word counts. Clickable prototypes you review before anything gets built.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>Clickable</b><span>Prototypes, not flat images</span></div><div class="lp-fact"><b>Real content</b><span>No lorem ipsum</span></div><div class="lp-fact"><b>~2 wks</b><span>Typical design phase</span></div></div>
</section>
...
<section class="band shell">
 <div class="article">
 <div class="article__body"><h2>Prototypes, not mockups</h2><p>You review something you can click. Problems surface while they are still cheap to fix, rather than during development when they are not.</p><h2>Designed against your content</h2><p>We design with your actual copy at its actual length. Lorem ipsum hides every problem you will have on launch day.</p></div>
 <aside class="aside">
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Design</p><ul><li><a href="{{ url('/logo-branding') }}">Logo and branding</a></li><li><a href="{{ url('/mobile-app-design') }}">Mobile app design</a></li><li><a href="{{ url('/ui-ux-design') }}">UI/UX design</a></li></ul></div>
