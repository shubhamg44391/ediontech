...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'IoT solutions | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Provisioning, telemetry pipelines, firmware update paths and dashboards for connected device estates.')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'iot solutions, iot solutions, Edion Web Technologies')

@section('main-container')
<main id="main"><a id="top"></a>

<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li aria-current="page">IoT solutions</li></ol></nav>
 <p class="eyebrow">Technology</p>
 <h1 style="margin-top:var(--sp-4)">Device fleets, telemetry and the interfaces to control them</h1>
 <p class="lead">Provisioning, telemetry pipelines, firmware update paths and dashboards for connected device estates.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>OTA updates</b><span>With rollback</span></div><div class="lp-fact"><b>Buffered</b><span>Survives connectivity loss</span></div><div class="lp-fact"><b>Dashboards</b><span>Fleet-wide visibility</span></div></div>
</section>
...
<section class="band shell">
 <div class="article">
 <div class="article__body"><h2>Firmware updates are the hard part</h2><p>Getting a device online is straightforward. Updating ten thousand of them safely, with rollback, is the engineering that matters.</p><h2>Design for intermittent connectivity</h2><p>Devices lose signal. Data buffers locally and reconciles later, or you lose readings.</p></div>
 <aside class="aside">
...
<section class="band band--ink">
 ...
 <div><p class="lbl">Technology</p><ul><li><a href="{{ url('/ai-development') }}">AI and machine learning development</a></li><li><a href="{{ url('/cloud-solutions') }}">Cloud solutions</a></li><li><a href="{{ url('/big-data-analytics') }}">Big data analytics</a></li></ul></div>
