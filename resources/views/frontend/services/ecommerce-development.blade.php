...
@section('title', !empty($headerdata->meta_title) ? $headerdata->meta_title : 'E-commerce development | Edion Web Technologies')
@section('description', !empty($headerdata->meta_description) ? $headerdata->meta_description : 'Catalogues, checkout, order management and the integrations that keep stock accurate. Built on platforms you can staff, or custom where your model needs it.')
@section('keywords', !empty($headerdata->meta_keywords) ? $headerdata->meta_keywords : 'e-commerce development, ecommerce development, Edion Web Technologies')

@section('main-container')
<main id="main"><a id="top"></a>

<section class="phero shell">
 <nav aria-label="Breadcrumb"><ol class="crumbs"><li><a href="{{ url('/') }}">Home</a></li><li aria-current="page"><b class="kw">E-commerce development</b></li></ol></nav>
 <p class="eyebrow">Build</p>
 <h1 style="margin-top:var(--sp-4)">Storefronts built for conversion, not just launch day</h1>
 <p class="lead">Catalogues, checkout, order management and the integrations that keep stock accurate. Built on platforms you can staff, or custom where your model needs it.</p>
...
<section class="band band--tight shell">
 <div class="lp-facts" data-reveal><div class="lp-fact"><b>Instrumented</b><span>Funnel visibility from day one</span></div><div class="lp-fact"><b>Stock-accurate</b><span>Real inventory integration</span></div><div class="lp-fact"><b>Headless option</b><span>Where it earns its complexity</span></div></div>
</section>
